...
internal class Class5370 : Class5368
{
	private static string[] string_0 = new string[1] { "application/X-fop-aps" };

	public override Interface177 vmethod_0(Class5738 userAgent)
	{
		return new Class5362(userAgent, userAgent.object_0 as ArrayList, userAgent.SplitPages);
	}
