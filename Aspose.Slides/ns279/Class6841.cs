...
internal class Class6841 : Class6839, IDisposable
{
	private readonly SizeF sizeF_0;

	private bool bool_0;

	public Class6841(float width, float height)
		: this(new SizeF(width, height))
	{
	}

	public Class6841(SizeF pageSize)
		: base(new Class6762(new Size((int)pageSize.Width, (int)pageSize.Height)), new Class6945())
	{
		sizeF_0 = pageSize;
	}
	...
	protected void Dispose(bool disposing)
	{
		if (!bool_0)
		{
			if (disposing)
			{
				(class6759_0 as Class6762).Dispose();
			}
			bool_0 = true;
		}
	}
