...
internal class Class3322 : Class3290
{
	private const string string_0 = "adj1";

	private const string string_1 = "adj2";

	public override Enum496 ShapeType => Enum496.const_22;

	public override Class3280 vmethod_1()
	{
		Class3322 @class = new Class3322();
	...
	internal override Class3340 vmethod_3()
	{
		...
		@class.method_3(new Struct159(x2, y4), new Struct159(x3, y3), new Struct159(num8, num));
		@class.method_4();
		@class.method_7(x4, num3);
		@class.method_3(new Struct159(x5, y6), new Struct159(x6, y5), new Struct159(num9, num3));
		return @class;
	}
