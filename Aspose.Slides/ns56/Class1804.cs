...
internal class Class1804 : Class1351
{
	public delegate Class1804 Delegate1291();

	public delegate void Delegate1292(Class1804 elementData);

	public delegate void Delegate1293(Class1804 elementData);
	...
	public Class1804(XmlReader reader)
		: base(reader)
	{
	}
