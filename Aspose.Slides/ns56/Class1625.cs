...
internal class Class1625 : Class1351
{
	public delegate Class1625 Delegate754();

	public delegate void Delegate755(Class1625 elementData);

	public delegate void Delegate756(Class1625 elementData);
	...
	public Class1726 TupleCache2 => class1726_0;
	...
	public Class1625(XmlReader reader)
		: base(reader)
	{
	}
	...
	private Class1726 method_7()
	{
		if (class1726_0 != null)
		{
			throw new Exception("Only one <tupleCache2> element can be added.");
		}
		class1726_0 = new Class1726();
		return class1726_0;
	}

	private void method_8(Class1726 _tupleCache2)
	{
		class1726_0 = _tupleCache2;
	}
