...
internal class Class305 : Class160
{
	internal Class305(Interface42 interface42_1, float float_5, float float_6, Class913 class913_1)
	...
	internal override GraphicsPath vmethod_0(RectangleF rectangleF_0)
	{
		...
		for (int i = 0; i < 8; i++)
		{
			...
			reference = new PointF((int)((double)(x + width / 2f) + Math.Cos(Struct70.smethod_0(i * 45)) * (double)width / 2.0), (int)((double)(y + height / 2f) - Math.Sin(Struct70.smethod_0(i * 45)) * (double)height / 2.0));
			ref PointF reference2 = ref array[2];
			reference2 = new PointF((int)((double)(x + width / 2f) + Math.Cos(Struct70.smethod_0((i + 1) * 45)) * (double)width / 2.0), (int)((double)(y + height / 2f) - Math.Sin(Struct70.smethod_0((i + 1) * 45)) * (double)height / 2.0));
			ref PointF reference3 = ref array[1];
			reference3 = new PointF((int)((double)(x + width / 2f) + Math.Cos(Struct70.smethod_0(22.5 + (double)(i * 45))) * (double)num10 / 2.0), (int)((double)(y + height / 2f) - Math.Sin(Struct70.smethod_0(22.5 + (double)(i * 45))) * (double)num9 / 2.0));
