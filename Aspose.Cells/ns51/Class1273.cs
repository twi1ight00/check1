...
internal class Class1273
{
	private WorksheetCollection worksheetCollection_0;

	internal bool bool_0;

	internal Class1273(WorksheetCollection worksheetCollection_1)
	{
	...
	internal Class1661 method_0(Cell cell_0, byte[] byte_0, int int_0)
	{
		...
		if (byte_0 == null)
		{
			...
			int num3 = BitConverter.ToInt32(byte_0, 0);
			int_0 = 4;
			num = 4 + num3;
			num2 = num + 4;
		}
		...
		while (int_0 < num)
		{
			...
			{
				@class = new Class1661(worksheetCollection_0);
				int num6 = BitConverter.ToUInt16(byte_0, int_0 + 1) * 2 + 3;
				@class.method_10(new byte[num6]);
				Array.Copy(byte_0, int_0, @class.method_9(), 0, num6);
				int_0 += num6;
				if (int_0 < byte_0.Length)
				{
					arrayList.Add(@class);
			...
			case 107:
				@class = new Class1661(worksheetCollection_0);
				@class.method_10(new byte[13]);
				Array.Copy(byte_0, int_0, @class.method_9(), 0, 13);
				int_0 += 13;
				arrayList.Add(@class);
				break;
			case 36:
			...
			case 123:
				@class = new Class1661(worksheetCollection_0);
				@class.method_10(new byte[15]);
				Array.Copy(byte_0, int_0, @class.method_9(), 0, 15);
				int_0 += 15;
				if (int_0 < byte_0.Length)
				{
					arrayList.Add(@class);
			...
			case 1:
			{
				int num4 = BitConverter.ToInt32(byte_0, int_0 + 1);
				int num5 = Class1268.smethod_1(byte_0, int_0 + 5);
				Cell cell = cell_0;
				cell = ((cell_0.Row != num4 || cell_0.Column != num5) ? cell_0.method_4().GetCell(num4, num5, bool_2: false) : cell_0);
	...
	private void method_7(Class1661 class1661_0, byte[] byte_0, int int_0, ref int int_1)
	{
		...
		int num2 = BitConverter.ToInt32(byte_0, int_1 + 4);
