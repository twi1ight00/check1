...
internal class Class3275 : Class3091
{
	private const string string_0 = "adj1";

	private const string string_1 = "adj2";

	public override Enum493 Kind => Enum493.const_128;

	public Class3275(Class3448 xfrm)
		: base(xfrm)
	{
	}
	...
	public override Class3279 vmethod_1()
	{
		...
		@class.method_6(new Struct159(x, y3), new Struct159(x2, y4), new Struct159(num9, num));
		@class.method_4(num11, num3);
		@class.method_6(new Struct159(x4, y6), new Struct159(x3, y5), new Struct159(num10, num3));
		@class.method_8();
