...
internal class Class4371 : IEnumerable, Interface107, Interface108
{
	protected sealed class Class4372 : IEnumerator
	{
		private Class4371 class4371_0;
		...
		internal Class4372(Class4371 nodeStream)
		{
			class4371_0 = nodeStream;
			Reset();
		}
		...
		{
			if (int_0 >= class4371_0.ilist_0.Count)
			{
				int num = int_0;
				int_0++;
				if (num < class4371_0.ilist_0.Count)
				{
					object_0 = class4371_0.ilist_0[num];
				}
				object_0 = class4371_0.object_2;
				return true;
			}
			object_0 = null;
			return false;
	...
	protected Class4361 class4361_0;
	...
	public Interface106 TreeAdaptor
	{
		get
		{
			return interface106_0;
		}
		set
		{
			interface106_0 = value;
		}
	}
	...
	public IEnumerator GetEnumerator()
	{
		...
		return new Class4372(this);
	}

	public Class4371(object tree)
		: this(new Class4369(), tree)
	{
	}

	public Class4371(Interface106 adaptor, object tree)
		: this(adaptor, tree, 100)
	{
	}

	public Class4371(Interface106 adaptor, object tree, int initialBufferSize)
	{
		object_3 = tree;
		...
		object_2 = adaptor.imethod_13(Class4398.int_7, "EOF");
	}
	...
	{
		bool flag;
		if (!(flag = interface106_0.imethod_5(t)))
		{
			ilist_0.Add(t);
		}
	...
	{
		object obj = null;
		obj = ((ttype == 2) ? ((!HasUniqueNavigationNodes) ? object_0 : interface106_0.imethod_13(2, "DOWN")) : ((!HasUniqueNavigationNodes) ? object_1 : interface106_0.imethod_13(3, "UP")));
		ilist_0.Add(obj);
	}
	...
	public void method_7(int index)
	{
		if (class4361_0 == null)
		{
			class4361_0 = new Class4361();
		}
		class4361_0.method_0(int_2);
		Seek(index);
	}

	public int method_8()
	{
		int num = (int)class4361_0.method_1();
		Seek(num);
		return num;
	}
	...
	public void imethod_10(object parent, int startChildIndex, int stopChildIndex, object t)
	{
		if (parent != null)
		{
			interface106_0.imethod_30(parent, startChildIndex, stopChildIndex, t);
		}
	}
	...
	{
		return interface106_0.imethod_14(imethod_9(i));
	}
	...
	public override string ToString()
	{
		...
		for (int i = 0; i < ilist_0.Count; i++)
		{
			...
			stringBuilder.Append(interface106_0.imethod_14(t));
		}
	...
	public string method_9(int start, int stop)
	{
		...
		for (int i = start; i < ilist_0.Count && i <= stop; i++)
		{
			...
			stringBuilder.Append(" ");
			stringBuilder.Append(interface106_0.imethod_18(treeNode));
		}
		return stringBuilder.ToString();
	}
	...
	public virtual string ToString(object start, object stop)
	{
		if (start != null && stop != null)
		{
			...
			if (interface111_0 != null)
			{
				...
				if (interface106_0.imethod_14(stop) == 3)
				{
					num2 = interface106_0.imethod_21(start);
				}
				else if (interface106_0.imethod_14(stop) == Class4398.int_7)
				{
					num2 = imethod_7() - 2;
				}
			...
			{
				text = interface106_0.imethod_16(obj);
				if (text == null)
				{
					text = " " + interface106_0.imethod_14(obj);
				}
				stringBuilder.Append(text);
				i++;
			}
			text = interface106_0.imethod_16(stop);
			if (text == null)
			{
				text = " " + interface106_0.imethod_14(stop);
			}
			stringBuilder.Append(text);
			return stringBuilder.ToString();
		}
