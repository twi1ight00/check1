...
internal class Class3740 : Class3739
{
	private float float_0;

	private float float_1;

	public Class3740(string feature, Class3679 argument)
	...
	{
		return float_0 / float_1 == (float)device.WindowSize.Width / (float)device.WindowSize.Height;
	}
}
