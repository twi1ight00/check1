...
internal class Class3971 : Class3969
{
	public override string PropertyName => "border-bottom";

	public override Enum600 PropertyType => Enum600.const_32;
	...
	public override void vmethod_3(Class3726 engine, Interface100 propertyHandler, Interface99 lu, bool important)
	{
		...
		method_8(propertyHandler, "border-bottom-color", list, important);
		method_8(propertyHandler, "border-bottom-style", list2, important);
		method_8(propertyHandler, "border-bottom-width", list3, important);
	}
}
