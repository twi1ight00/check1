...
internal class Class3201 : Class3091
{
	...
	public override Enum493 Kind => Enum493.const_55;

	public Class3201(Class3448 xfrm)
		: base(xfrm)
	{
	}
	...
	public override Class3279 vmethod_1()
	{
		...
		double z3 = Class3089.smethod_1(100000.0, base.Transform2D.Extents.Cx, Math.Min(base.Transform2D.Extents.Cy, base.Transform2D.Extents.Cx));
		double num2 = Class3089.smethod_0(0.0, base.AdjustValues["adj3"], z3);
		double z4 = Class3089.smethod_1(num2, Math.Min(base.Transform2D.Extents.Cy, base.Transform2D.Extents.Cx), base.Transform2D.Extents.Cx);
		...
		double x = Class3089.smethod_1(Math.Min(base.Transform2D.Extents.Cy, base.Transform2D.Extents.Cx), num2, 100000.0);
		double z6 = Class3089.smethod_1(base.Transform2D.Extents.Cx, y2, 100000.0);
		double num5 = Class3089.smethod_2(base.Transform2D.Extents.Cx, 0.0, z6);
		Class3089.smethod_3(num5, base.Transform2D.Extents.Cx, 2.0);
		...
		@class.method_4(x, y6);
		@class.method_8();
		@class.TextRectangle = new Class3457(num5, 0.0, base.Transform2D.Extents.Cx, base.Transform2D.Extents.Cy);
		return @class;
	}
