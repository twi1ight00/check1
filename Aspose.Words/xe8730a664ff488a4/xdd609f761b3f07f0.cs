...
internal class xdd609f761b3f07f0 : Stream, IDisposable
{
	...
	public x07366e3d6c48f6c6 xce7d657046e9409a
	{
		get
		{
			return _x0e1a954073ecb077.xce7d657046e9409a;
		}
		set
		{
			if (_x0e75cd3866dbb930)
			...
			_x0e1a954073ecb077.xce7d657046e9409a = value;
		}
	}
	...
	public xdd609f761b3f07f0(Stream stream, x1f770018e5e12789 mode)
		: this(stream, mode, x0bf508c6214e694f.xb9715d2f06b63cf0, leaveOpen: false)
	{
	}

	public xdd609f761b3f07f0(Stream stream, x1f770018e5e12789 mode, x0bf508c6214e694f level)
		: this(stream, mode, level, leaveOpen: false)
	{
	}

	public xdd609f761b3f07f0(Stream stream, x1f770018e5e12789 mode, bool leaveOpen)
		: this(stream, mode, x0bf508c6214e694f.xb9715d2f06b63cf0, leaveOpen)
	{
	}

	public xdd609f761b3f07f0(Stream stream, x1f770018e5e12789 mode, x0bf508c6214e694f level, bool leaveOpen)
	{
		_x0e1a954073ecb077 = new xd9b65f15958fe264(stream, mode, level, x48d9147101a26c84.x5056d69688e87464, leaveOpen);
	}
	...
	{
		return xd9b65f15958fe264.x0e394068a594d384(xe4115acdf4fbfccc, typeof(xdd609f761b3f07f0));
	}

	public static byte[] xe760fb5661ebe89a(byte[] xe7ebe10fa44d8d49)
	{
		return xd9b65f15958fe264.xe760fb5661ebe89a(xe7ebe10fa44d8d49, typeof(xdd609f761b3f07f0));
	}

	public static string x3389f8cbd9a4a6e2(byte[] x933b2a3444ec3bba)
	{
		return xd9b65f15958fe264.x3389f8cbd9a4a6e2(x933b2a3444ec3bba, typeof(xdd609f761b3f07f0));
	}

	public static byte[] xea29da571ea64fa4(byte[] x933b2a3444ec3bba)
	{
		return xd9b65f15958fe264.xea29da571ea64fa4(x933b2a3444ec3bba, typeof(xdd609f761b3f07f0));
	}
