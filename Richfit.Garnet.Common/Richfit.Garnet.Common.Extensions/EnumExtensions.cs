...
public static class EnumExtensions
{
	...
	public static E ClearFlag<E>(this E variable, E flag) where E : struct
	{
		typeof(E).GuardType(typeof(Enum), "variable");
	...
	/// <exception cref="T:System.ArgumentException">当前枚举变量不是 <see cref="T:System.Enum" /> 类型。</exception>
	public static E ClearFlags<E>(this E variable) where E : struct
	{
		typeof(E).GuardType(typeof(Enum), "variable");
		long value = Convert.ToInt64(variable);
		value = 0L;
	...
	public static E ClearFlags<E>(this E variable, params E[] flags) where E : struct
	{
		typeof(E).GuardType(typeof(Enum), "variable");
		flags.GuardNotNull("flags");
		long value = Convert.ToInt64(variable);
	...
	/// <exception cref="T:System.ArgumentException">当前枚举变量不是 <see cref="T:System.Enum" /> 类型。</exception>
	public static bool HasAllFlag<E>(this E variable, E flag) where E : struct
	{
		typeof(E).GuardType(typeof(Enum), "variable");
		long value = Convert.ToInt64(variable);
	...
	/// <exception cref="T:System.ArgumentException">当前枚举变量不是 <see cref="T:System.Enum" /> 类型。</exception>
	/// <exception cref="T:System.ArgumentNullException"><paramref name="flags" /> 为空。</exception>
	public static bool HasAllFlags<E>(this E variable, params E[] flags) where E : struct
	{
		typeof(E).GuardType(typeof(Enum), "variable");
		flags.GuardNotNull("flags");
		long value = Convert.ToInt64(variable);
	...
	/// <exception cref="T:System.ArgumentException">当前枚举变量不是 <see cref="T:System.Enum" /> 类型。</exception>
	public static bool HasAnyFlag<E>(this E variable, E flag) where E : struct
	{
		typeof(E).GuardType(typeof(Enum), "variable");
		long value = Convert.ToInt64(variable);
		long flagValue = Convert.ToInt64(flag);
	...
	/// <exception cref="T:System.ArgumentException">当前枚举变量不是 <see cref="T:System.Enum" /> 类型。</exception>
	/// <exception cref="T:System.ArgumentNullException"><paramref name="flags" /> 为空。</exception>
	public static bool HasAnyFlags<E>(this E variable, params E[] flags) where E : struct
	{
		typeof(E).GuardType(typeof(Enum), "variable");
		flags.GuardNotNull("flags");
		long value = Convert.ToInt64(variable);
	...
	/// <returns>处理后的枚举值</returns>
	/// <exception cref="T:System.ArgumentException">当前枚举变量不是 <see cref="T:System.Enum" /> 类型。</exception>
	public static E SetFlag<E>(this E variable, E flag) where E : struct
	{
		typeof(E).GuardType(typeof(Enum), "variable");
		long value = Convert.ToInt64(variable);
		value |= Convert.ToInt64(flag);
	...
	/// <exception cref="T:System.ArgumentException">当前枚举变量不是 <see cref="T:System.Enum" /> 类型。</exception>
	/// <exception cref="T:System.ArgumentNullException"><paramref name="flags" /> 为空。</exception>
	public static E SetFlag<E>(this E variable, params E[] flags) where E : struct
	{
		typeof(E).GuardType(typeof(Enum), "variable");
		flags.GuardNotNull("flags");
		long value = Convert.ToInt64(variable);
	...
	/// <returns>处理后的枚举值</returns>
	/// <exception cref="T:System.ArgumentException">当前枚举变量不是 <see cref="T:System.Enum" /> 类型。</exception>
	public static E KeepFlag<E>(this E variable, E flag) where E : struct
	{
		typeof(E).GuardType(typeof(Enum), "variable");
	...
	/// <exception cref="T:System.ArgumentException">当前枚举变量不是 <see cref="T:System.Enum" /> 类型。</exception>
	/// <exception cref="T:System.ArgumentNullException"><paramref name="flags" /> 为空。</exception>
	public static E KeepFlags<E>(this E variable, params E[] flags) where E : struct
	{
		typeof(E).GuardType(typeof(Enum), "variable");
		flags.GuardNotNull("flags");
		long value = 0L;
	...
	public static AccessLevels Combine(this AccessLevels levels, bool Public = false, bool FamilyOrAssembly = false, bool Assembly = false, bool Family = false, bool FamilyAndAssembly = false, bool Private = false, bool NonPublic = false, bool Instance = false, bool Static = false, bool Both = false)
	{
		if (Public)
		{
	...
	public static BindingFlags ToBindingFlags(this AccessLevels level)
	{
	...
	public static bool HasLevel(this AccessLevels level, AccessLevels checkLevel)
	{
	...
	/// <returns>组合后的枚举值</returns>
	public static BindingFlags Combine(this BindingFlags flags, bool IgnoreCase = false, bool DeclaredOnly = false, bool Instance = false, bool Static = false, bool Public = false, bool NonPublic = false, bool FlattenHierarchy = false, bool InvokeMethod = false, bool CreateInstance = false, bool GetField = false, bool SetField = false, bool GetProperty = false, bool SetProperty = false, bool PutDispProperty = false, bool PutRefDispProperty = false, bool ExactBinding = false, bool SuppressChangeType = false, bool OptionalParamBinding = false, bool IgnoreReturn = false)
	{
		if (IgnoreCase)
		{
	...
	public static RegexOptions EnsureLeftToRightOption(this RegexOptions options)
	{
	...
	/// <param name="options">当前选项枚举</param>
	/// <returns>处理后的选项枚举</returns>
	public static RegexOptions EnsureRightToLeftOption(this RegexOptions options)
	{
		return options | RegexOptions.RightToLeft;
	}
	...
	public static IEqualityComparer<string> ToComparer(this StringComparison option)
	{
	...
	public static long GetTicks(this DateTimeParts parts)
	{
		long ticks = 0L;
