...
internal class Class4394 : Interface107, Interface111
{
	protected Interface85 interface85_0;

	protected IList ilist_0;

	protected IDictionary idictionary_0;

	protected Class4357 class4357_0;
	...
	public virtual Interface85 TokenSource
	{
		get
		{
			return interface85_0;
		}
		set
		{
			interface85_0 = value;
	...
	public Class4394(Interface85 tokenSource)
		: this()
	{
		interface85_0 = tokenSource;
	}

	public Class4394(Interface85 tokenSource, int channel)
		: this(tokenSource)
	{
		int_0 = channel;
	}

	public virtual Interface86 imethod_8(int k)
	{
		if (int_2 == -1)
		{
			vmethod_0();
		...
		return (Interface86)ilist_0[num];
	}

	public virtual Interface86 imethod_9(int i)
	{
		return (Interface86)ilist_0[i];
	}
	...
	public virtual string ToString(int start, int stop)
	{
		if (start >= 0 && stop >= 0)
		{
			...
			{
				Interface86 @interface = (Interface86)ilist_0[i];
	...
	public virtual string ToString(Interface86 start, Interface86 stop)
	{
	...
	{
		int num = 0;
		Interface86 @interface = interface85_0.imethod_0();
		while (@interface != null && @interface.Type != -1)
		{
			...
			if (class4357_0 != null && class4357_0.Contains(@interface.Type.ToString()))
			{
				flag = true;
			}
			...
			@interface = interface85_0.imethod_0();
		}
		int_2 = 0;
		int_2 = vmethod_1(int_2);
	}
	...
	protected virtual int vmethod_1(int i)
	{
		...
		while (i < count && ((Interface86)ilist_0[i]).Channel != int_0)
		{
			i++;
		}
		return i;
	...
	{
		while (i >= 0 && ((Interface86)ilist_0[i]).Channel != int_0)
		{
			i--;
		}
		return i;
	...
	public virtual void vmethod_4(int ttype)
	{
		if (class4357_0 == null)
		{
			class4357_0 = new Class4357();
		}
		class4357_0.Add(ttype.ToString(), ttype);
	}
	...
	public virtual IList vmethod_8(int start, int stop, Class4391 types)
	{
		if (int_2 == -1)
		{
			vmethod_0();
	...
	{
		return vmethod_8(start, stop, new Class4391(types));
	}

	public virtual IList vmethod_10(int start, int stop, int ttype)
	{
		return vmethod_8(start, stop, Class4391.smethod_0(ttype));
	}

	protected virtual Interface86 vmethod_11(int k)
	{
		if (int_2 == -1)
		{
			vmethod_0();
