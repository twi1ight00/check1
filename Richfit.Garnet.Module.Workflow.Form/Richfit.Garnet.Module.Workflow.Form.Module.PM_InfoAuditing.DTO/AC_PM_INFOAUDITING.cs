...
[Serializable]
public class AC_PM_INFOAUDITING : DTOExt, IDTO
{
	...
	[Col]
	public virtual decimal? IS_AUDIT
	{
		get
		{
			return _is_audit;
	...
	public AC_PM_INFOAUDITING()
	{
		_addsql = "insert into AC_PM_INFOAUDITING (\r\nPM_INFOAUDITING_ID ,\r\nAPPLYTIME ,\r\nWEBSITE_TYPE ,\r\nWEBSITE_OTHER_NAME ,\r\nPLATFORM_TYPE ,\r\nPLATFORM_OTHER_NAME ,\r\nTITLE ,\r\nCONTENT ,\r\nIS_AUDIT ,\r\nUSER_TYPE ,\r\nOPERATE_TYPE ,\r\nUSER_INFO ,\r\nCHANGE_TYPE ,\r\nCHANGE_CONTENT ,\r\nREMARK ,\r\nISDEL ,\r\nCREATOR ,\r\nCREATETIME ,\r\nMODIFIER ,\r\nMODIFYTIME ,\r\nUSER_ID ,\r\nUSER_NAME ,\r\nORG_ID ,\r\nORG_NAME ,\r\nINSTANCE_ID ) values (\r\n:PM_INFOAUDITING_ID ,\r\n:APPLYTIME ,\r\n:WEBSITE_TYPE ,\r\n:WEBSITE_OTHER_NAME ,\r\n:PLATFORM_TYPE ,\r\n:PLATFORM_OTHER_NAME ,\r\n:TITLE ,\r\n:CONTENT ,\r\n:IS_AUDIT ,\r\n:USER_TYPE ,\r\n:OPERATE_TYPE ,\r\n:USER_INFO ,\r\n:CHANGE_TYPE ,\r\n:CHANGE_CONTENT ,\r\n:REMARK ,\r\n:ISDEL ,\r\n:CREATOR ,\r\n:CREATETIME ,\r\n:MODIFIER ,\r\n:MODIFYTIME ,\r\n:USER_ID ,\r\n:USER_NAME ,\r\n:ORG_ID ,\r\n:ORG_NAME ,\r\n:INSTANCE_ID )";
		_findbyinstance = "SELECT * FROM AC_PM_INFOAUDITING WHERE INSTANCE_ID=:INSTANCE_ID";
		_findpage = "SELECT T1.*,T2.TEMPLATE_ID,T2.INSTANCE_NAME FROM AC_PM_INFOAUDITING T1 LEFT JOIN WF_INSTANCE T2 ON T1.INSTANCE_ID=T2.INSTANCE_ID ";
		_updatesql = "update AC_PM_INFOAUDITING set PM_INFOAUDITING_ID=:PM_INFOAUDITING_ID \r\n,APPLYTIME=:APPLYTIME \r\n,WEBSITE_TYPE=:WEBSITE_TYPE \r\n,WEBSITE_OTHER_NAME=:WEBSITE_OTHER_NAME \r\n,PLATFORM_TYPE=:PLATFORM_TYPE \r\n,PLATFORM_OTHER_NAME=:PLATFORM_OTHER_NAME \r\n,TITLE=:TITLE \r\n,CONTENT=:CONTENT \r\n,IS_AUDIT=:IS_AUDIT \r\n,USER_TYPE=:USER_TYPE \r\n,OPERATE_TYPE=:OPERATE_TYPE \r\n,USER_INFO=:USER_INFO \r\n,CHANGE_TYPE=:CHANGE_TYPE \r\n,CHANGE_CONTENT=:CHANGE_CONTENT \r\n,REMARK=:REMARK \r\n,ISDEL=:ISDEL \r\n,CREATOR=:CREATOR \r\n,CREATETIME=:CREATETIME \r\n,MODIFIER=:MODIFIER \r\n,MODIFYTIME=:MODIFYTIME \r\n,USER_ID=:USER_ID \r\n,USER_NAME=:USER_NAME \r\n,ORG_ID=:ORG_ID \r\n,ORG_NAME=:ORG_NAME \r\n WHERE INSTANCE_ID=:INSTANCE_ID";
	}

	public override string FindList(string parm)
	{
		AC_PM_INFOAUDITING dto = parm.JsonDeserialize<AC_PM_INFOAUDITING>(new JsonConverter[0]);
		return FindList<AC_PM_INFOAUDITING>(dto);
	}
