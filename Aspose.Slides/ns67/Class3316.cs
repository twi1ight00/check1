...
internal class Class3316 : Class3290
{
	private const string string_0 = "adj";

	public override Enum496 ShapeType => Enum496.const_38;

	public override Class3280 vmethod_1()
	{
		Class3316 @class = new Class3316();
	...
	{
		double x = Class3089.smethod_0(28569.0, base.AdjustValues["adj"], 100000.0);
