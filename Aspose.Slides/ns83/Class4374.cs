...
internal abstract class Class4374<T>
{
	protected int int_0;
	...
	public Class4374(Interface106 adaptor, string elementDescription)
	{
		string_0 = elementDescription;
		interface106_0 = adaptor;
	}

	public Class4374(Interface106 adaptor, string elementDescription, T oneElement)
		: this(adaptor, elementDescription)
	{
		Add(oneElement);
	}

	public Class4374(Interface106 adaptor, string elementDescription, IList<T> elements)
		: this(adaptor, elementDescription)
	{
		gparam_0 = default(T);
		ilist_0 = elements;
	...
	public Class4374(Interface106 adaptor, string elementDescription, IList elements)
		: this(adaptor, elementDescription)
	{
		gparam_0 = default(T);
		ilist_0 = new List<T>();
	...
	protected object method_1()
	{
		...
		if (num == 0)
		{
			throw new Exception16(string_0);
		}
		if (int_0 >= num)
		{
			if (num == 1)
			...
			throw new Exception14(string_0);
		}
		if (gparam_0 != null)
		{
			int_0++;
