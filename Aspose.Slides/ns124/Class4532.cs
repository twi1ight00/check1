...
internal class Class4532 : Class4521
{
	...
	public Class4532(Class4700 context, Class4521 parent)
		: base(context, parent)
	{
		byte_1 = new byte[1][] { Encoding.ASCII.GetBytes("StartComposites") };
		byte_0 = new byte[3][]
		{
			Encoding.ASCII.GetBytes("EndComposites\r\n"),
			Encoding.ASCII.GetBytes("EndComposites\r"),
			Encoding.ASCII.GetBytes("EndComposites\n")
		};
		base.ChildScanners = new Class4520[1]
		{
			new Class4526(context, this)
		};
	}
