...
internal class Class893
{
	...
	public Class893(RectangleF rectangleF_1, Class891 class891_1, ArrayList arrayList_1, Font font_1)
		: this(rectangleF_1, class891_1, arrayList_1, font_1, 1f, 1f)
	{
	}

	public Class893(RectangleF rectangleF_1, Class891 class891_1, ArrayList arrayList_1, Font font_1, float float_3, float float_4)
	{
		rectangleF_0 = rectangleF_1;
		class891_0 = class891_1;
	...
	public void method_0(Interface42 interface42_1)
	{
		...
		if (class891_0.TextVerticalAlignment == StringAlignment.Near)
		{
			if (class891_0.TextHorizontalAlignment == StringAlignment.Near)
			{
				method_5(arrayList_0);
				method_8(arrayList_0);
			}
			else if (class891_0.TextHorizontalAlignment == StringAlignment.Center)
			{
				method_5(arrayList_0);
				method_7(arrayList_0, bool_0: true);
				method_8(arrayList_0);
			}
			else
			{
				method_5(arrayList_0);
				method_7(arrayList_0, bool_0: false);
				method_8(arrayList_0);
			}
		}
		else if (class891_0.TextVerticalAlignment == StringAlignment.Far)
		{
			if (class891_0.TextHorizontalAlignment == StringAlignment.Near)
			{
				method_5(arrayList_0);
				method_9(arrayList_0, bool_0: false);
				method_8(arrayList_0);
			}
			else if (class891_0.TextHorizontalAlignment == StringAlignment.Center)
			{
		...
		else if (class891_0.TextHorizontalAlignment == StringAlignment.Near)
		{
			method_5(arrayList_0);
			method_9(arrayList_0, bool_0: true);
			method_8(arrayList_0);
		}
		else if (class891_0.TextHorizontalAlignment == StringAlignment.Center)
		{
		...
		foreach (Class892 item in arrayList_0)
		{
			if (item.enum111_0 == Enum111.const_2)
			{
				Font font = item.Font;
				_ = item.FontColor;
				_ = item.Text;
	...
	private void method_2(ArrayList arrayList_1)
	{
		...
		{
			Class892 @class = (Class892)arrayList_1[i];
			...
			for (int j = 0; j < array.Length; j++)
			{
				if (array[j] != "")
				{
					Class892 value = new Class892(array[j], @class.Font, @class.FontColor, Enum111.const_2);
				...
				if (j != array.Length - 1)
				{
					Class892 value = new Class892("", @class.Font, @class.FontColor, Enum111.const_0);
					arrayList_1.Insert(i, value);
					i++;
				}
			}
		...
		{
			Class892 class2 = (Class892)arrayList_1[k];
			...
			for (int l = 0; l < matchCollection.Count; l++)
			{
				...
				if (matchCollection[l].Index > num)
				{
					...
					value2 = new Class892(string_, class2.Font, class2.FontColor, Enum111.const_2);
					arrayList_1.Insert(k, value2);
					k++;
				}
				value2 = new Class892(matchCollection[l].Value, class2.Font, class2.FontColor, Enum111.const_1);
				arrayList_1.Insert(k, value2);
				k++;
				...
				if (l == matchCollection.Count - 1 && num <= class2.Text.Length - 1)
				{
					...
					value2 = new Class892(string_2, class2.Font, class2.FontColor, Enum111.const_2);
					arrayList_1.Insert(k, value2);
					k++;
				}
			}
		...
		{
			Class892 class3 = (Class892)arrayList_1[m];
			if (class3.enum111_0 != 0)
			{
	...
	{
		return Struct69.smethod_11(interface42_0, string_0, font_1, new SizeF(2.1474836E+09f, 2.1474836E+09f));
	}
	...
	private void method_5(ArrayList arrayList_1)
	{
		...
		for (int i = 0; i < arrayList_1.Count; i++)
		{
			...
			if (@class.enum111_0 == Enum111.const_0)
			{
			...
			else if (@class.enum111_0 == Enum111.const_1)
			{
			...
			{
				if (@class.enum111_0 != Enum111.const_2)
				{
					continue;
				}
				Class892 class2 = null;
				Class892 class3 = null;
				if (i > 0)
				{
					class2 = (Class892)arrayList_1[i - 1];
				}
				if (i + 1 < arrayList_1.Count)
				{
					class3 = (Class892)arrayList_1[i + 1];
				}
				if (class2 != null && class2.enum111_0 == Enum111.const_1)
				{
					if (@class.sizeF_0.Width <= num2)
					{
						...
						{
							if (class3.enum111_0 != Enum111.const_2)
							{
								break;
							}
							class3 = (Class892)arrayList_1[j];
							if (class3.enum111_0 != Enum111.const_2 || method_6(class3.Text))
							{
								break;
							}
						...
						else if (location.X == rectangleF_0.X)
						{
							for (; i < j; i++)
							{
								...
								if (num2 < 0f)
								{
									...
									Class892 class4 = new Class892(array[0], class3.Font, class3.FontColor, Enum111.const_2);
				...
				else
				{
					...
					Class892 class5 = new Class892(array2[0], @class.Font, @class.FontColor, Enum111.const_2);
	...
	private void method_7(ArrayList arrayList_1, bool bool_0)
	{
		int num = 0;
		...
		for (int i = 0; i < arrayList_1.Count; i++)
		{
			...
			if (@class.rectangleF_0.Y > num2)
			{
				...
				{
					Class892 class2 = (Class892)arrayList_1[num4];
					if (class2.enum111_0 == Enum111.const_2)
					{
						break;
					}
					if (class2.enum111_0 == Enum111.const_1)
					{
				...
				for (int j = num; j < i; j++)
				{
					Class892 class3 = (Class892)arrayList_1[j];
					if (class3.enum111_0 == Enum111.const_2)
					{
		...
		{
			Class892 class4 = (Class892)arrayList_1[num6];
			if (class4.enum111_0 == Enum111.const_2)
			{
				break;
			}
			if (class4.enum111_0 == Enum111.const_1)
			{
		...
		{
			Class892 class5 = (Class892)arrayList_1[k];
			if (class5.enum111_0 == Enum111.const_2)
			{
	...
	private void method_8(ArrayList arrayList_1)
	{
		...
		for (int i = 0; i < arrayList_1.Count; i++)
		{
			Class892 class2 = (Class892)arrayList_1[i];
			if (class2.enum111_0 != Enum111.const_2)
			{
				continue;
			}
			if (class2.rectangleF_0.Y > num4)
			{
				if (num2 != num3)
				{
					...
					{
						Class892 class3 = (Class892)arrayList_1[j];
						if (class3.enum111_0 == Enum111.const_2 && class3 != @class)
						{
		...
		for (int k = num; k < arrayList_1.Count; k++)
		{
			Class892 class4 = (Class892)arrayList_1[k];
			if (class4.enum111_0 == Enum111.const_2 && class4 != @class)
			{
	...
	private void method_9(ArrayList arrayList_1, bool bool_0)
	{
		float num = float.MinValue;
		...
		{
			Class892 @class = (Class892)arrayList_1[num4];
			if (@class.enum111_0 == Enum111.const_0)
			{
				if (num4 < arrayList_1.Count - 1)
				{
					num3 = ((((Class892)arrayList_1[num4 + 1]).enum111_0 != Enum111.const_2) ? (num3 + float_0) : (num3 + num));
				}
				num = float.MinValue;
				num2 = float.MinValue;
			}
			else if (@class.enum111_0 == Enum111.const_2)
			{
				if (@class.rectangleF_0.Y < num2)
				{
					num3 += num;
		...
		if (bool_0)
		{
			_ = (Class892)arrayList_1[0];
			_ = (Class892)arrayList_1[arrayList_1.Count - 1];
		...
		{
			Class892 class2 = (Class892)arrayList_1[num6];
			if (class2.enum111_0 == Enum111.const_2)
			{
	...
	{
		return Struct69.smethod_10(interface42_0.imethod_0().imethod_2(font_1));
	}
}
