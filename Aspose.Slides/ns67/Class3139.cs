...
internal class Class3139 : Class3091
{
	private const string string_0 = "adj";

	public override Enum493 Kind => Enum493.const_72;

	public Class3139(Class3448 xfrm)
		: base(xfrm)
	{
	}
	...
	public override Class3279 vmethod_1()
	{
		...
		double num3 = Class3089.smethod_2(base.Transform2D.Extents.Cx, 0.0, num);
		Class3089.smethod_1(num3, 1.0, 2.0);
		Class3089.smethod_3(num, base.Transform2D.Extents.Cx, 2.0);
		...
		@class.method_3(num3, num);
		@class.method_4(base.Transform2D.Extents.Cx, 0.0);
		@class.method_4(base.Transform2D.Extents.Cx, num2);
		@class.method_4(num3, base.Transform2D.Extents.Cy);
		@class.method_8();
		@class.method_2(base.Transform2D.Extents.Cx, base.Transform2D.Extents.Cy, Enum492.const_4, extrusionOk: false, stroke: false);
		@class.method_3(0.0, num);
		...
		@class.method_3(num3, num);
		@class.method_4(num3, base.Transform2D.Extents.Cy);
		@class.TextRectangle = new Class3457(0.0, num, num3, base.Transform2D.Extents.Cy);
		return @class;
	}
