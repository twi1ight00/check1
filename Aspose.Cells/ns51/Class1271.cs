...
internal class Class1271
{
	private Class1277 class1277_0;

	private Workbook workbook_0;

	internal Class1271(Class1277 class1277_1, Workbook workbook_1)
	{
		class1277_0 = class1277_1;
	...
	internal object method_0(Class1661 class1661_0, Cell cell_0)
	{
		...
		{
			object obj2 = Class1660.smethod_26(class1277_0.method_5((Class1661)class1661_0.method_7()[2], cell_0), workbook_0.Settings.Date1904);
			if (!(obj2 is double))
			{
				return obj2;
			}
		...
		object obj3 = class1277_0.method_5((Class1661)class1661_0.method_7()[1], cell_0);
		object[][] array = null;
		if (obj3 is Struct87 @struct)
		{
			...
			int num6 = worksheet.Cells.MaxRow;
			if (num6 == -1)
			{
				return ErrorType.NA;
			}
			if (num == 0 && num4 == num5)
			{
				num6 = class1277_0.method_2(worksheet.Index, num4);
				if (num6 == -1)
				{
					return ErrorType.NA;
				}
			...
			array = (object[][])class1277_0.method_4(index, num2, num4, num3, num5, bool_3: true, bool_4: true, bool_5: false).object_0;
		}
		else
		{
			if (!(obj3 is object[][]))
				...
				if (int_0 <= int_1)
				{
					...
					if (bool_0)
					{
						if (object_0[num6] != null && object_0[num6][int_2] != null)
						{
							...
							if (obj4 is Cell)
							{
								obj4 = class1277_0.method_211((Cell)obj4);
				...
				if (num5 <= int_1)
				{
					...
					if (bool_0)
					{
						if (object_0[num5] != null && object_0[num5][int_2] != null)
						{
							...
							if (obj3 is Cell)
							{
								obj3 = class1277_0.method_211((Cell)obj3);
