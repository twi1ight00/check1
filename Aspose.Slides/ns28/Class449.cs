...
internal class Class449 : Class369
{
	internal static readonly string string_0 = "odd-rows";
	...
	public Class449(string prefix, string localName, string namespaceURI, XmlDocument doc)
