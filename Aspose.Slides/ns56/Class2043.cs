...
internal class Class2043 : Class2038
{
	public delegate void Delegate2039(Class2043 elementData);
	...
	public override Class2135 Explosion => class2135_2;
		...
		while (((flag && !reader.EOF) || reader.Read()) && (reader.NodeType != XmlNodeType.EndElement || !(reader.LocalName == localName)))
		{
			...
			if (reader.NodeType == XmlNodeType.Element)
			{
				...
				case "spPr":
					...
					break;
				case "explosion":
					class2135_2 = new Class2135(reader);
					break;
				case "dPt":
				{
	...
	public Class2043(XmlReader reader)
		: base(reader)
	{
	}
	...
	protected override void vmethod_2()
	{
		...
		delegate2136_0 = method_7;
		delegate2138_0 = method_8;
	...
	public override void vmethod_4(string prefix, XmlWriter writer, string elementName)
	{
		...
		if (class2135_2 != null)
		{
			class2135_2.vmethod_4("c", writer, "explosion");
		}
	...
	private Class2135 method_7()
	{
		if (class2135_2 != null)
		{
			throw new Exception("Only one <explosion> element can be added.");
		}
		class2135_2 = new Class2135();
		return class2135_2;
	}

	private void method_8(Class2135 _explosion)
	{
		class2135_2 = _explosion;
	}
