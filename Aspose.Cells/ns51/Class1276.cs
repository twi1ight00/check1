...
internal class Class1276
{
	...
	internal Class1276(WorksheetCollection worksheetCollection_1)
	{
	...
	internal string method_1(Cell cell_0)
	{
		...
		if (array[4] == 1)
		{
			...
			Cell cell = cell_0.method_4().GetCell(num2, num3, bool_2: false);
	...
	internal string method_3(int int_2, int int_3, byte[] byte_0, int int_4, int int_5, bool bool_0)
	{
		...
		while (int_2 < num)
		{
			...
			{
				int_2++;
				int num7 = BitConverter.ToUInt16(byte_0, int_2);
				if (num7 != 0)
				{
					value = Encoding.Unicode.GetString(byte_0, int_2 + 2, 2 * num7);
					value = value.Replace("\"", "\"\"");
				}
				int_2 += 2 * num7 + 2;
				arrayList.Add(stringBuilder_0.Length);
			...
			case 30:
			{
				ushort num6 = BitConverter.ToUInt16(byte_0, int_2 + 1);
				arrayList.Add(stringBuilder_0.Length);
				stringBuilder_0.Append(num6.ToString(CultureInfo.InvariantCulture));
				int_2 += 3;
				break;
			}
			case 31:
			{
				double num2 = BitConverter.ToDouble(byte_0, int_2 + 1);
				arrayList.Add(stringBuilder_0.Length);
				if (!(num2 >= 1E+21) && Math.Abs(num2) > 1E-21)
				{
					stringBuilder_0.Append(num2.ToString("0.##################################", CultureInfo.InvariantCulture));
				}
				else
				{
					stringBuilder_0.Append(num2.ToString());
				}
				int_2 += 9;
				break;
			}
			...
			case 97:
				int_2++;
				method_11(byte_0, int_2, arrayList);
				int_2 += 2;
				break;
			case 34:
			case 66:
			...
			case 108:
				arrayList.Add(stringBuilder_0.Length);
				int_2++;
				stringBuilder_0.Append(method_7(byte_0, int_2, int_2 + 4, int_4, int_5));
				int_2 += 6;
				break;
			case 45:
			case 77:
			case 109:
				arrayList.Add(stringBuilder_0.Length);
				int_2++;
				stringBuilder_0.Append(method_8(byte_0, int_2, int_4, int_5));
				int_2 += 12;
				break;
			case 57:
			case 89:
			case 121:
			{
				...
				if (@class == null)
				{
					...
					{
						if (worksheetCollection_0.Workbook.FileName != null)
						{
			...
			case 122:
			{
				arrayList.Add(stringBuilder_0.Length);
				int_2++;
				string text = method_6(byte_0, int_2);
	...
	private string method_6(byte[] byte_0, int int_2)
	{
		int num = BitConverter.ToUInt16(byte_0, int_2);
	...
	private string method_7(byte[] byte_0, int int_2, int int_3, int int_4, int int_5)
	{
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.Append('R');
		if ((byte_0[int_3 + 1] & 0x80) == 0)
		{
			stringBuilder.Append(BitConverter.ToInt32(byte_0, int_2) + 1);
		}
		else
		{
			stringBuilder.Append('[');
			int num = BitConverter.ToInt32(byte_0, int_2);
			if (num + int_4 > 1048575)
			{
				stringBuilder.Append(num - 1048575 - 1);
			}
			else
			{
				stringBuilder.Append(num);
		...
		{
			stringBuilder.Append(Class1268.smethod_1(byte_0, int_3) + 1);
		}
		else
		{
			int num2 = Class1268.smethod_1(byte_0, int_3);
			if (num2 + int_5 > 16383)
			{
				num2 = num2 - 16383 - 1;
			}
	...
	private string method_8(byte[] byte_0, int int_2, int int_3, int int_4)
	{
		int num = BitConverter.ToInt32(byte_0, int_2);
		int num2 = BitConverter.ToInt32(byte_0, int_2 + 4);
		int num3 = Class1268.smethod_1(byte_0, int_2 + 8);
		...
		if (num == 0 && num2 == 1048575)
		{
			...
			{
				int num5 = Class1268.smethod_1(byte_0, int_2 + 8);
				if (num5 + int_4 > 16383)
				{
					num5 = num5 - 16383 - 1;
				}
			...
			if (flag4 != flag2 || num3 != num4)
			{
				...
				{
					int num6 = Class1268.smethod_1(byte_0, int_2 + 10);
					if (num6 + int_4 > 16383)
					{
						num6 = num6 - 16383 - 1;
					}
		...
		stringBuilder.Append(method_7(byte_0, int_2, int_2 + 8, int_3, int_4));
		stringBuilder.Append(':');
		stringBuilder.Append(method_7(byte_0, int_2 + 4, int_2 + 10, int_3, int_4));
		return stringBuilder.ToString();
	}
	...
	{
		int num = BitConverter.ToInt32(byte_0, int_2);
		int num2 = Class1268.smethod_1(byte_0, int_2 + 4);
		bool flag = true;
		bool flag2 = true;
		...
		else if (num2 - int_4 != 0)
		{
			stringBuilder.Append('[');
			stringBuilder.Append(num2 - int_4);
			stringBuilder.Append(']');
		}
		return stringBuilder.ToString();
	}
	...
	private void method_10(byte[] byte_0, int int_2, ArrayList arrayList_0)
	{
		...
		if (num == 255)
		{
			method_9(byte_0, int_2, arrayList_0);
			return;
		}
		int index;
	...
	private void method_11(byte[] byte_0, int int_2, ArrayList arrayList_0)
	{
