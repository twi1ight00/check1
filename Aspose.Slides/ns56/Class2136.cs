...
internal class Class2136 : Class1351
{
	public delegate Class2136 Delegate2139();

	public delegate void Delegate2140(Class2136 elementData);

	public delegate void Delegate2141(Class2136 elementData);
	...
	public Class2136(XmlReader reader)
		: base(reader)
	{
	}
