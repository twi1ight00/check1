...
internal class Class4389 : Class4387
{
	...
	public Class4389(TextReader reader)
		: this(reader, int_7, int_6)
	{
	}

	public Class4389(TextReader reader, int size)
		: this(reader, size, int_6)
	{
	}

	public Class4389(TextReader reader, int size, int readChunkSize)
	{
