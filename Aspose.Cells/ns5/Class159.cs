...
internal class Class159
{
	...
	[SpecialName]
	public void method_2(Enum9 enum9_1)
	{
		enum9_0 = enum9_1;
	}
	...
	internal Brush method_9(Image image_0, RectangleF rectangleF_0)
	{
		if (!bool_0)
		{
			return new TextureBrush(image_0, WrapMode.Tile);
		}
		if (enum9_0 == Enum9.const_0)
		{
			Bitmap bitmap = new Bitmap((int)rectangleF_0.Width, (int)rectangleF_0.Height);
		...
		{
			Bitmap bitmap2 = new Bitmap((int)rectangleF_0.Width, (int)((float)image_0.Height * rectangleF_0.Width / (float)image_0.Width));
			...
			int num = (int)rectangleF_0.Height % bitmap2.Height;
			TextureBrush textureBrush = new TextureBrush(bitmap2);
			Matrix matrix = new Matrix();
			matrix.Translate(rectangleF_0.X, rectangleF_0.Y - (float)(bitmap2.Height - num));
			textureBrush.Transform = matrix;
			return textureBrush;
		}
		Bitmap bitmap3 = new Bitmap((int)rectangleF_0.Width, (int)((double)((float)image_0.Height * rectangleF_0.Width / (float)image_0.Width) / double_8));
		...
		int num2 = (int)rectangleF_0.Height % bitmap3.Height;
		TextureBrush textureBrush2 = new TextureBrush(bitmap3);
		Matrix matrix2 = new Matrix();
		matrix2.Translate(rectangleF_0.X, rectangleF_0.Y - (float)(bitmap3.Height - num2));
