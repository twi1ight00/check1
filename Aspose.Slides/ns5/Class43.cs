...
internal class Class43 : EffectEffectiveDataPVITemp, IReflectionEffectiveData
{
	...
	internal Class43(RectangleAlignment algn, double blurRad, float dir, double dist, float stPos, float endPos, float fadeDir, float stA, float endA, double kx, double ky, bool rotWithShape, double sx, double sy)
	{
	...
	private Bitmap method_1(Bitmap bmp, Class43 reflection)
	{
