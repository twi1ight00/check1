...
internal class Class64 : Class18
{
	internal Class64(Interface42 interface42_1, float float_5, float float_6, Class898 class898_1)
	...
	internal override void vmethod_3()
	{
		...
		Brush brush_ = Struct69.smethod_2(rectangleF_0: new RectangleF(float_0, float_1, width, height), class884_0: class898_0.Fill);
		...
		case 2:
			if (!class898_0.Fill.method_0())
			{
				...
				graphicsPath2.AddArc(num - width / 2f, num2 + num4 - 2f * num3, width, 2f * num3, 0f, 90f);
				...
				graphicsPath2.AddArc(num + width / 2f, num2 + height - 2f * num3, width, 2f * num3, 180f, -90f);
		...
		case 4:
			if (!class898_0.Fill.method_0())
			{
				...
				graphicsPath.AddArc(num + width / 2f, num2 + num4 - 2f * num3, width, 2f * num3, 180f, -90f);
				...
				graphicsPath.AddArc(num - width / 2f, num2 + height - 2f * num3, width, 2f * num3, 0f, 90f);
