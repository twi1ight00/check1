...
[Serializable]
public class PM_BENEFIT : DTOExt, IDTO
{
	...
	[Col]
	public virtual decimal? ACTUAL_MONEY
	{
		get
		{
			return _actual_money;
		}
		set
		{
			_actual_money = value;
	...
	public PM_BENEFIT()
	{
		_addsql = "insert into PM_BENEFIT (\r\nPM_BENEFIT_ID ,\r\nCONTENT ,\r\nAPPLYDATE ,\r\nAPPLY_MONEY ,\r\nACTUAL_MONEY,\r\nBENEFIT_TYPE ,\r\nREMARK ,\r\nISDEL ,\r\nCREATOR ,\r\nCREATETIME ,\r\nMODIFIER ,\r\nMODIFYTIME ,\r\nUSER_ID ,\r\nUSER_NAME ,\r\nORG_ID ,\r\nORG_NAME ,\r\nINSTANCE_ID ) values (\r\n:PM_BENEFIT_ID ,\r\n:CONTENT ,\r\n:APPLYDATE ,\r\n:APPLY_MONEY ,\r\n:ACTUAL_MONEY,\r\n:BENEFIT_TYPE ,\r\n:REMARK ,\r\n:ISDEL ,\r\n:CREATOR ,\r\n:CREATETIME ,\r\n:MODIFIER ,\r\n:MODIFYTIME ,\r\n:USER_ID ,\r\n:USER_NAME ,\r\n:ORG_ID ,\r\n:ORG_NAME ,\r\n:INSTANCE_ID )";
		_findbyinstance = "SELECT * FROM PM_BENEFIT WHERE INSTANCE_ID=:INSTANCE_ID";
		_findpage = "SELECT T1.*,T2.TEMPLATE_ID,T2.INSTANCE_NAME,T2.RUN_STATE FROM PM_BENEFIT T1 LEFT JOIN WF_INSTANCE T2 \r\nON T1.INSTANCE_ID=T2.INSTANCE_ID ";
		...
		_updatesql = "update PM_BENEFIT set CONTENT=:CONTENT \r\n,APPLYDATE=:APPLYDATE \r\n,APPLY_MONEY=:APPLY_MONEY \r\n,ACTUAL_MONEY=:ACTUAL_MONEY\r\n,BENEFIT_TYPE=:BENEFIT_TYPE \r\n,REMARK=:REMARK \r\n,ISDEL=:ISDEL \r\n,CREATOR=:CREATOR \r\n,CREATETIME=:CREATETIME \r\n,MODIFIER=:MODIFIER \r\n,MODIFYTIME=:MODIFYTIME \r\n,USER_ID=:USER_ID \r\n,USER_NAME=:USER_NAME \r\n,ORG_ID=:ORG_ID \r\n,ORG_NAME=:ORG_NAME \r\n WHERE INSTANCE_ID=:INSTANCE_ID";
	}

	public override string FindList(string parm)
	{
		PM_BENEFIT dto = parm.JsonDeserialize<PM_BENEFIT>(new JsonConverter[0]);
		return FindList<PM_BENEFIT>(dto);
	}
