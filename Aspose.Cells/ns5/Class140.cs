...
internal class Class140 : Class18
{
	private float float_5;

	private float float_6;

	internal Class140(Interface42 interface42_1, float float_7, float float_8, Class898 class898_1)
	...
	internal override void vmethod_3()
	{
		...
		Struct69.smethod_0(class898_0.Fill, graphicsPath);
	...
	internal GraphicsPath method_3(float float_7, float float_8, float float_9, float float_10, int int_0)
	{
		...
		if (class898_0.class885_0.arrayList_0.Count == 2)
		{
			...
			float_5 = class898_0.Width / 3f * Convert.ToSingle(21600f - (float)((Class882)class898_0.class885_0.arrayList_0[1]).Value) / 21600f;
		}
		else if (class898_0.class885_0.arrayList_0.Count == 1)
		{
			...
			{
				float_5 = class898_0.Width / 3f * Convert.ToSingle(21600f - (float)((Class882)class898_0.class885_0.arrayList_0[0]).Value) / 21600f;
			}
			else
			{
