...
internal class Class230 : Class160
{
	internal Class230(Interface42 interface42_1, float float_5, float float_6, Class913 class913_1)
	...
	internal override GraphicsPath vmethod_0(RectangleF rectangleF_0)
	{
		...
		if (class913_0.class901_0 != null)
		{
			if (class913_0.class901_0.arrayList_0.Count > 0)
			{
				...
				num6 = height * Convert.ToSingle(class913_0.class901_0.arrayList_0[3]) / 100000f;
			}
			else
			{
				num3 = num11 * 0.25f;
