...
internal class Class1971 : Class1351
{
	public delegate Class1971 Delegate1780();

	public delegate void Delegate1781(Class1971 elementData);

	public delegate void Delegate1782(Class1971 elementData);
	...
	public Class1971(XmlReader reader)
		: base(reader)
	{
	}
