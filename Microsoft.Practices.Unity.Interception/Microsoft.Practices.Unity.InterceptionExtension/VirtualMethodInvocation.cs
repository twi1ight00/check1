...
public class VirtualMethodInvocation : IMethodInvocation
{
	...
	/// </summary>
	public IParameterCollection Inputs => inputs;

	/// <summary>
	/// Collection of all parameters to the call: in, out and byref.
	/// </summary>
	public IParameterCollection Arguments => arguments;
	...
	/// </summary>
	public IDictionary<string, object> InvocationContext => context;
	...
	/// </summary>
	public MethodBase MethodBase => targetMethod;
	...
	public VirtualMethodInvocation(object target, MethodBase targetMethod, params object[] parameterValues)
	{
		...
		arguments = new ParameterCollection(parameterValues, parameters, (ParameterInfo param) => true);
		inputs = new ParameterCollection(parameterValues, parameters, (ParameterInfo param) => !param.IsOut);
	}
