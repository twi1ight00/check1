...
internal class Class1863 : Class1351
{
	public delegate Class1863 Delegate1468();

	public delegate void Delegate1469(Class1863 elementData);

	public delegate void Delegate1470(Class1863 elementData);
	...
	public Class1863(XmlReader reader)
		: base(reader)
	{
	}
	...
	public override void vmethod_4(string prefix, XmlWriter writer, string elementName)
	{
		...
		writer.WriteAttributeString("hue", XmlConvert.ToString((int)Math.Round(float_0 * 60000f)));
		writer.WriteAttributeString("sat", XmlConvert.ToString((int)Math.Round(float_1 * 1000f)));
		writer.WriteAttributeString("lum", XmlConvert.ToString((int)Math.Round(float_2 * 1000f)));
		if (list_0 != null)
		{
