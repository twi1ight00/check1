...
public class CommentRangeStart : Node, x8ad0c0863d1cd403
{
	...
	public override NodeType NodeType => NodeType.CommentRangeStart;
	...
	{
		return Node.x9708eba393e07242(visitor.VisitCommentRangeStart(this));
	}
}
