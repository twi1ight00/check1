...
internal class Class3240 : Class3091
{
	private const string string_0 = "adj1";

	private const string string_1 = "adj2";

	public override Enum493 Kind => Enum493.const_92;

	public Class3240(Class3448 xfrm)
		: base(xfrm)
	{
	}
	...
	public override Class3279 vmethod_1()
	{
		...
		double y2 = Class3089.smethod_2(x3, 0.0, num2);
		double y3 = Class3089.smethod_2(base.Transform2D.Extents.Cy, 0.0, num2);
		double y4 = Class3089.smethod_7(base.Transform2D.Extents.Cx / 2.0, 2700000.0);
		double num3 = Class3089.smethod_10(num2, 2700000.0);
		double right = Class3089.smethod_2(0.0, y4, 0.0);
		...
		@class.method_5(num2, base.Transform2D.Extents.Cx / 2.0, 16200000.0, 5400000.0);
		...
		@class.method_5(num2, base.Transform2D.Extents.Cx / 2.0, 16200000.0, -5400000.0);
		@class.method_4(base.Transform2D.Extents.Cx / 2.0, y3);
