...
public class InjectionFactory : InjectionMember
{
	...
	public InjectionFactory(Func<IUnityContainer, object> factoryFunc)
		: this((IUnityContainer c, Type t, string s) => factoryFunc(c))
	{
	}
	...
	public override void AddPolicies(Type serviceType, Type implementationType, string name, IPolicyList policies)
	{
		...
		FactoryDelegateBuildPlanPolicy policy = new FactoryDelegateBuildPlanPolicy(factoryFunc);
		policies.Set((IBuildPlanPolicy)policy, (object)new NamedTypeBuildKey(implementationType, name));
	}
}
