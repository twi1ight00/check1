...
internal class Class3977 : Class3969
{
	public override string PropertyName => "border-right";

	public override Enum600 PropertyType => Enum600.const_51;
	...
	public override void vmethod_3(Class3726 engine, Interface100 propertyHandler, Interface99 lu, bool important)
	{
		...
		method_8(propertyHandler, "border-right-color", list, important);
		method_8(propertyHandler, "border-right-style", list2, important);
		method_8(propertyHandler, "border-right-width", list3, important);
	}
}
