...
internal class Class190 : Class160
{
	internal Class190(Interface42 interface42_1, float float_5, float float_6, Class913 class913_1)
	...
	internal override void vmethod_3()
	{
		...
		RectangleF rect = new RectangleF(float_0, float_1, width, height);
		...
		case 2:
			if (!class913_0.Fill.method_0())
			{
				...
				graphicsPath3.AddArc(num + width / 2f, num2, width, 2f * num3, 270f, -90f);
				graphicsPath3.AddLine(num + width / 2f, num2 + num3, num + width / 2f, num2 + num4 - num3);
				graphicsPath3.AddArc(num - width / 2f, num2 + num4 - 2f * num3, width, 2f * num3, 0f, 90f);
				graphicsPath3.AddArc(num - width / 2f, num2 + num4, width, 2f * num3, 270f, 90f);
				graphicsPath3.AddLine(num + width / 2f, num2 + num4 + num3, num + width / 2f, num2 + height - num3);
				graphicsPath3.AddArc(num + width / 2f, num2 + height - 2f * num3, width, 2f * num3, 180f, -90f);
