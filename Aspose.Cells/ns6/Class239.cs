...
internal class Class239 : Class160
{
	internal Class239(Interface42 interface42_1, float float_5, float float_6, Class913 class913_1)
	...
	internal override void vmethod_3()
	{
		...
		interface42_0.imethod_16(pen_, x + num + num13, y + num2 + num15, x + num3 + num13, y + num4 + num15);
		interface42_0.imethod_16(pen_, x + num3 + num13, y + num4 + num15, x + num5 + num13, y + num6 + num15);
		interface42_0.imethod_16(pen_, x + num5 + num13, y + num6 + num15, x + num7 + num13, y + num8 + num15);
		interface42_0.imethod_16(pen_, x + num + num13, y + y + num15, x + num + num13, y + height + num15);
		vmethod_4();
	}
