...
/// 基于命名值的配置源
/// </summary>
public interface ISettingsGroupConfigurationSource : IConfigurationSource, ISyncableObject, IDisposableObject, IDisposable, IEnumerable<KeyValuePair<string, object>>, IEnumerable
{
	/// <summary>
	/// 获取或者设置指定名称的命名值
	/// </summary>
