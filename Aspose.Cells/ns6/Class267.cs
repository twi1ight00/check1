...
internal class Class267 : Class160
{
	internal Class267(Interface42 interface42_1, float float_5, float float_6, Class913 class913_1)
	...
	internal override GraphicsPath vmethod_0(RectangleF rectangleF_0)
	{
		...
		case 1:
		{
			double num = (double)(x + width / 2f) + (double)(width / 2f) * Math.Cos(Struct70.smethod_0(315.0));
			double num2 = (double)(y + height / 2f) - (double)(height / 2f) * Math.Sin(Struct70.smethod_0(315.0));
