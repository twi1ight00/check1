...
[Serializable]
public class AC_LM_VEHICLE_SCHEDULING : DTOExt, IDTO
{
	...
	public AC_LM_VEHICLE_SCHEDULING()
	{
		WhereAdvance = " ((@USE_VEHICLE_ORG IS NULL OR T1.USE_VEHICLE_ORG=@USE_VEHICLE_ORG) AND (@USE_VEHICLE_USER IS NULL OR T1.USE_VEHICLE_USER=@USE_VEHICLE_USER) AND (@VEHICLE_NO IS NULL OR T1.VEHICLE_NO LIKE ('%'||(@VEHICLE_NO)||'%')) AND (@DRIVER IS NULL OR T1.DRIVER LIKE ('%'||(@DRIVER)||'%')) AND (@APPLY_TIME_FROM IS NULL OR T1.DEPARTURE_DATE >= TO_DATE(@APPLY_TIME_FROM,'YYYY-MM-DD'))  AND (@APPLY_TIME_TO IS NULL OR T1.DEPARTURE_DATE <= TO_DATE(@APPLY_TIME_TO,'YYYY-MM-DD')))";
		WhereSimple = " ((@VEHICLE_NO IS NULL OR T1.VEHICLE_NO LIKE ('%'||(@VEHICLE_NO)||'%')) OR (@USE_VEHICLE_ORGNAME IS NULL OR T1.USE_VEHICLE_ORGNAME LIKE ('%'||(@USE_VEHICLE_ORGNAME)||'%'))  OR (@USE_VEHICLE_USERNAME IS NULL OR T1.USE_VEHICLE_USERNAME LIKE ('%'||(@USE_VEHICLE_USERNAME)||'%'))  OR (@DRIVER IS NULL OR T1.DRIVER LIKE ('%'||(@DRIVER)||'%')))";
		_addsql = "insert into AC_LM_VEHICLE_SCHEDULING (\r\nVEHICLE_SCHEDULING_ID ,\r\nTITLE ,\r\nVEHICLE_ID ,\r\nVEHICLE_NO ,\r\nUSE_VEHICLE_ORG ,\r\nUSE_VEHICLE_ORGNAME ,\r\nUSE_VEHICLE_USER ,\r\nUSE_VEHICLE_USERNAME ,\r\nTASK_TYPE_DESC ,\r\nPOINT_DEPARTURE ,\r\nDESTINATION ,\r\nDEPARTURE_DATE ,\r\nDEPARTURE_TIME ,\r\nAPPLY_DATE ,\r\nRETURN_DATE ,\r\nRETURN_TIME ,\r\nDRIVER ,\r\nDEPARTURE_ODOMETER ,\r\nRETURN_ODOMETER ,\r\nMILEAGE ,\r\nROAD_COSTS ,\r\nDISTRIBUTOR_ID ,\r\nDISTRIBUTOR_NAME ,\r\nDISTRIBUTOR_ORGID ,\r\nDISTRIBUTOR_ORGNAME ,\r\nISOUT ,\r\nEVALUATE ,\r\nDRIVER_ID ,\r\nREMARK ,\r\nAPPLY_MOBILE ,\r\nDRIVER_MOBILE ,\r\nCREATOR ,\r\nISDEL ,\r\nCREATETIME ,\r\nMODIFIER ,\r\nMODIFYTIME ,\r\nUSER_ID ,\r\nUSER_NAME ,\r\nORG_ID ,\r\nORG_NAME ,\r\nINSTANCE_ID ) values (\r\n:VEHICLE_SCHEDULING_ID ,\r\n:TITLE ,\r\n:VEHICLE_ID ,\r\n:VEHICLE_NO ,\r\n:USE_VEHICLE_ORG ,\r\n:USE_VEHICLE_ORGNAME ,\r\n:USE_VEHICLE_USER ,\r\n:USE_VEHICLE_USERNAME ,\r\n:TASK_TYPE_DESC ,\r\n:POINT_DEPARTURE ,\r\n:DESTINATION ,\r\n:DEPARTURE_DATE ,\r\n:DEPARTURE_TIME ,\r\n:APPLY_DATE ,\r\n:RETURN_DATE ,\r\n:RETURN_TIME ,\r\n:DRIVER ,\r\n:DEPARTURE_ODOMETER ,\r\n:RETURN_ODOMETER ,\r\n:MILEAGE ,\r\n:ROAD_COSTS ,\r\n:DISTRIBUTOR_ID ,\r\n:DISTRIBUTOR_NAME ,\r\n:DISTRIBUTOR_ORGID ,\r\n:DISTRIBUTOR_ORGNAME ,\r\n:ISOUT ,\r\n:EVALUATE ,\r\n:DRIVER_ID ,\r\n:REMARK ,\r\n:APPLY_MOBILE ,\r\n:DRIVER_MOBILE ,\r\n:CREATOR ,\r\n:ISDEL ,\r\n:CREATETIME ,\r\n:MODIFIER ,\r\n:MODIFYTIME ,\r\n:USER_ID ,\r\n:USER_NAME ,\r\n:ORG_ID ,\r\n:ORG_NAME ,\r\n:INSTANCE_ID )";
		_findbyinstance = "SELECT * FROM AC_LM_VEHICLE_SCHEDULING WHERE INSTANCE_ID=:INSTANCE_ID";
		_findpage = "SELECT T1.*,T2.TEMPLATE_ID,T2.INSTANCE_NAME FROM AC_LM_VEHICLE_SCHEDULING T1 LEFT JOIN WF_INSTANCE T2 ON T1.INSTANCE_ID=T2.INSTANCE_ID ";
		_updatesql = "update AC_LM_VEHICLE_SCHEDULING set VEHICLE_SCHEDULING_ID=:VEHICLE_SCHEDULING_ID \r\n,TITLE=:TITLE \r\n,VEHICLE_ID=:VEHICLE_ID \r\n,VEHICLE_NO=:VEHICLE_NO \r\n,USE_VEHICLE_ORG=:USE_VEHICLE_ORG \r\n,USE_VEHICLE_ORGNAME=:USE_VEHICLE_ORGNAME \r\n,USE_VEHICLE_USER=:USE_VEHICLE_USER \r\n,USE_VEHICLE_USERNAME=:USE_VEHICLE_USERNAME \r\n,TASK_TYPE_DESC=:TASK_TYPE_DESC \r\n,POINT_DEPARTURE=:POINT_DEPARTURE \r\n,DESTINATION=:DESTINATION \r\n,DEPARTURE_DATE=:DEPARTURE_DATE \r\n,DEPARTURE_TIME=:DEPARTURE_TIME \r\n,APPLY_DATE=:APPLY_DATE \r\n,RETURN_DATE=:RETURN_DATE \r\n,RETURN_TIME=:RETURN_TIME \r\n,DRIVER=:DRIVER \r\n,DEPARTURE_ODOMETER=:DEPARTURE_ODOMETER \r\n,RETURN_ODOMETER=:RETURN_ODOMETER \r\n,MILEAGE=:MILEAGE \r\n,ROAD_COSTS=:ROAD_COSTS \r\n,DISTRIBUTOR_ID=:DISTRIBUTOR_ID \r\n,DISTRIBUTOR_NAME=:DISTRIBUTOR_NAME \r\n,DISTRIBUTOR_ORGID=:DISTRIBUTOR_ORGID \r\n,DISTRIBUTOR_ORGNAME=:DISTRIBUTOR_ORGNAME \r\n,ISOUT=:ISOUT \r\n,EVALUATE=:EVALUATE \r\n,DRIVER_ID=:DRIVER_ID \r\n,REMARK=:REMARK \r\n,APPLY_MOBILE=:APPLY_MOBILE \r\n,DRIVER_MOBILE=:DRIVER_MOBILE \r\n,CREATOR=:CREATOR \r\n,ISDEL=:ISDEL \r\n,CREATETIME=:CREATETIME \r\n,MODIFIER=:MODIFIER \r\n,MODIFYTIME=:MODIFYTIME \r\n,USER_ID=:USER_ID \r\n,USER_NAME=:USER_NAME \r\n,ORG_ID=:ORG_ID \r\n,ORG_NAME=:ORG_NAME \r\n WHERE INSTANCE_ID=:INSTANCE_ID";
	}

	public override string FindList(string parm)
	{
		AC_LM_VEHICLE_SCHEDULING dto = parm.JsonDeserialize<AC_LM_VEHICLE_SCHEDULING>(new JsonConverter[0]);
		return FindList<AC_LM_VEHICLE_SCHEDULING>(dto);
	}
