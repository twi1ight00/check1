...
internal class Class445 : Class369
{
	internal static readonly string string_0 = "first-row";
	...
	public Class445(string prefix, string localName, string namespaceURI, XmlDocument doc)
