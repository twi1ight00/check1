...
internal class Class1484 : Class1351
{
	public delegate Class1484 Delegate329();

	public delegate void Delegate330(Class1484 elementData);

	public delegate void Delegate331(Class1484 elementData);
	...
	public Class1484(XmlReader reader)
		: base(reader)
	{
	}
	...
	public override void vmethod_4(string prefix, XmlWriter writer, string elementName)
	{
		...
		writer.WriteAttributeString("v", XmlConvert.ToString(dateTime_0, "yyyy-MM-ddTHH:mm:ss.fff"));
