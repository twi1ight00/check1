...
internal class Class197 : Class160
{
	internal Class197(Interface42 interface42_1, float float_5, float float_6, Class913 class913_1)
	...
	internal override GraphicsPath vmethod_0(RectangleF rectangleF_0)
	{
		...
		if (num2 > num)
		{
			graphicsPath.AddPie(x, y, width, height, num, num2 - num);
		}
		else
		{
			graphicsPath.AddPie(x, y, width, height, num, 360f + num2 - num);
		}
