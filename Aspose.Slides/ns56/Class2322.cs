...
internal class Class2322 : Class1351
{
	public delegate Class2322 Delegate2713();

	public delegate void Delegate2714(Class2322 elementData);

	public delegate void Delegate2715(Class2322 elementData);
	...
	public Class1474 O_Gfxdata => class1474_0;
	...
	public Class2605[] VMLShapeList => list_1.ToArray();
	...
	protected override void vmethod_0(XmlReader reader)
	{
		...
		while (((flag && !reader.EOF) || reader.Read()) && (reader.NodeType != XmlNodeType.EndElement || !(reader.LocalName == localName)))
		{
			...
			if (reader.NodeType == XmlNodeType.Element)
			{
				...
				case "path":
				{
					Class2331 obj26 = new Class2331(reader);
					list_0.Add(new Class2605("path", obj26));
					break;
				}
				case "formulas":
				{
					Class2327 obj25 = new Class2327(reader);
					list_0.Add(new Class2605("formulas", obj25));
					break;
				}
				case "handles":
				{
					Class2328 obj24 = new Class2328(reader);
					list_0.Add(new Class2605("handles", obj24));
					break;
				}
				case "fill":
				{
					Class2326 obj23 = new Class2326(reader);
					list_0.Add(new Class2605("fill", obj23));
					break;
				}
				case "stroke":
				{
					Class2333 obj22 = new Class2333(reader);
					list_0.Add(new Class2605("stroke", obj22));
					break;
				}
				case "shadow":
				{
					Class2332 obj21 = new Class2332(reader);
					list_0.Add(new Class2605("shadow", obj21));
					break;
				}
				case "textbox":
				{
					Class1473 obj20 = new Class1473(reader);
					list_0.Add(new Class2605("textbox", obj20));
					flag = true;
					break;
				}
				case "textpath":
				{
					Class2334 obj19 = new Class2334(reader);
					list_0.Add(new Class2605("textpath", obj19));
					break;
				}
				case "imagedata":
				{
					Class2330 obj18 = new Class2330(reader);
					list_0.Add(new Class2605("imagedata", obj18));
					break;
				}
				case "skew":
				{
					Class2212 obj17 = new Class2212(reader);
					list_0.Add(new Class2605("skew", obj17));
					break;
				}
				case "extrusion":
				{
					Class2202 obj16 = new Class2202(reader);
					list_0.Add(new Class2605("extrusion", obj16));
					break;
				}
				case "callout":
				{
					Class2198 obj15 = new Class2198(reader);
					list_0.Add(new Class2605("callout", obj15));
					break;
				}
				case "lock":
				{
					Class2206 obj14 = new Class2206(reader);
					list_0.Add(new Class2605("lock", obj14));
					break;
				}
				case "clippath":
				{
					Class2199 obj13 = new Class2199(reader);
					list_0.Add(new Class2605("clippath", obj13));
					break;
				}
				case "signatureline":
				{
					Class2211 obj12 = new Class2211(reader);
					list_0.Add(new Class2605("signatureline", obj12));
					break;
				}
				case "wrap":
				{
					Class2337 obj11 = new Class2337(reader);
					list_0.Add(new Class2605("wrap", obj11));
					break;
				}
				case "anchorlock":
				{
					Class2335 obj10 = new Class2335(reader);
					list_0.Add(new Class2605("anchorlock", obj10));
					break;
				}
				case "bordertop":
				{
					Class2336 obj9 = new Class2336(reader);
					list_0.Add(new Class2605("bordertop", obj9));
					break;
				}
				case "borderbottom":
				{
					Class2336 obj8 = new Class2336(reader);
					list_0.Add(new Class2605("borderbottom", obj8));
					break;
				}
				case "borderleft":
				{
					Class2336 obj7 = new Class2336(reader);
					list_0.Add(new Class2605("borderleft", obj7));
					break;
				}
				case "borderright":
				{
					Class2336 obj6 = new Class2336(reader);
					list_0.Add(new Class2605("borderright", obj6));
					break;
				}
				case "ClientData":
				{
					Class1475 obj5 = new Class1475(reader);
					list_0.Add(new Class2605("ClientData", obj5));
					flag = true;
					break;
				}
				case "textdata":
				{
					Class2219 obj4 = new Class2219(reader);
					list_0.Add(new Class2605("textdata", obj4));
					break;
				}
				case "recolorinfo":
				{
					Class2217 obj3 = new Class2217(reader);
					list_0.Add(new Class2605("recolorinfo", obj3));
					break;
				}
				case "ink":
				{
					Class2205 obj2 = new Class2205(reader);
					list_1.Add(new Class2605("ink", obj2));
					break;
				}
				case "iscomment":
				{
					Class2216 obj = new Class2216(reader);
					list_1.Add(new Class2605("iscomment", obj));
					break;
				}
				default:
					reader.Skip();
	...
	public Class2322(XmlReader reader)
		: base(reader)
	{
	}
	...
	public override void vmethod_4(string prefix, XmlWriter writer, string elementName)
	{
		...
		if (writer.LookupPrefix("http://www.w3.org/2001/XMLSchema") == null)
		{
		...
		if (string_20 != null)
		{
			writer.WriteAttributeString("type", string_20);
		}
		if (string_21 != null)
		{
			writer.WriteAttributeString("adj", string_21);
		}
		if (string_22 != null)
		{
			writer.WriteAttributeString("path", string_22);
		}
		if (class1474_0 != null)
		{
			writer.WriteAttributeString("o:gfxdata", class1474_0.OuterXml);
		}
		if (string_23 != null)
		{
			writer.WriteAttributeString("equationxml", string_23);
		}
		foreach (Class2605 item in list_1)
		{
			switch (item.Name)
			{
			case "iscomment":
				((Class2216)item.Object).vmethod_4("ppt", writer, item.Name);
				break;
			case "ink":
				((Class2205)item.Object).vmethod_4("o", writer, item.Name);
				break;
			}
		}
		if (list_0 != null)
		{
			foreach (Class2605 item2 in list_0)
			{
				switch (item2.Name)
				{
				case "path":
					((Class2331)item2.Object).vmethod_4("v", writer, item2.Name);
					break;
				case "formulas":
					((Class2327)item2.Object).vmethod_4("v", writer, item2.Name);
					break;
				case "handles":
					((Class2328)item2.Object).vmethod_4("v", writer, item2.Name);
					break;
				case "fill":
					((Class2326)item2.Object).vmethod_4("v", writer, item2.Name);
					break;
				case "stroke":
					((Class2333)item2.Object).vmethod_4("v", writer, item2.Name);
					break;
				case "shadow":
					((Class2332)item2.Object).vmethod_4("v", writer, item2.Name);
					break;
				case "textbox":
					((Class1473)item2.Object).vmethod_4("v", writer, item2.Name);
					break;
				case "textpath":
					((Class2334)item2.Object).vmethod_4("v", writer, item2.Name);
					break;
				case "imagedata":
					((Class2330)item2.Object).vmethod_4("v", writer, item2.Name);
					break;
				case "skew":
					((Class2212)item2.Object).vmethod_4("o", writer, item2.Name);
					break;
				case "extrusion":
					((Class2202)item2.Object).vmethod_4("o", writer, item2.Name);
					break;
				case "callout":
					((Class2198)item2.Object).vmethod_4("o", writer, item2.Name);
					break;
				case "lock":
					((Class2206)item2.Object).vmethod_4("o", writer, item2.Name);
					break;
				case "clippath":
					((Class2199)item2.Object).vmethod_4("o", writer, item2.Name);
					break;
				case "signatureline":
					((Class2211)item2.Object).vmethod_4("o", writer, item2.Name);
					break;
				case "wrap":
					((Class2337)item2.Object).vmethod_4("wvml", writer, item2.Name);
					break;
				case "anchorlock":
					((Class2335)item2.Object).vmethod_4("wvml", writer, item2.Name);
					break;
				case "bordertop":
					((Class2336)item2.Object).vmethod_4("wvml", writer, item2.Name);
					break;
				case "borderbottom":
					((Class2336)item2.Object).vmethod_4("wvml", writer, item2.Name);
					break;
				...
				case "borderright":
					...
					break;
				case "ClientData":
					((Class1475)item2.Object).vmethod_4("x", writer, item2.Name);
					break;
				case "textdata":
					((Class2219)item2.Object).vmethod_4("ppt", writer, item2.Name);
					break;
				case "recolorinfo":
					((Class2217)item2.Object).vmethod_4("ppt", writer, item2.Name);
					break;
				}
			}
		}
	...
	private Class2605 method_5(string elementName)
	{
		Class2605 @class = elementName switch
		{
			"iscomment" => new Class2605("iscomment", new Class2216()), 
			"ink" => new Class2605("ink", new Class2205()), 
			_ => throw new Exception("Wrong element: " + elementName), 
		};
		list_1.Add(@class);
		return @class;
