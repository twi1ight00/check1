...
internal class Class3237 : Class3091
{
	private const string string_0 = "adj1";

	private const string string_1 = "adj2";

	public override Enum493 Kind => Enum493.const_121;

	public Class3237(Class3448 xfrm)
		: base(xfrm)
	{
	}
	...
	public override Class3279 vmethod_1()
	{
		...
		double y3 = Class3089.smethod_1(base.Transform2D.Extents.Cy, y, 200000.0);
		double num4 = Class3089.smethod_1(base.Transform2D.Extents.Cy, y, 100000.0);
		double num5 = Class3089.smethod_2(base.Transform2D.Extents.Cy, 0.0, num4);
		double y4 = Class3089.smethod_1(num5, 1.0, 2.0);
		double num6 = Class3089.smethod_1(base.Transform2D.Extents.Cy, y, 400000.0);
		double y5 = Class3089.smethod_2(base.Transform2D.Extents.Cy, 0.0, num6);
		double y6 = Class3089.smethod_2(num4, 0.0, num6);
		...
		@class.method_4(x6, 0.0);
		@class.method_5(num6, base.Transform2D.Extents.Cx / 32.0, 16200000.0, 10800000.0);
		@class.method_4(x2, y3);
		@class.method_5(num6, base.Transform2D.Extents.Cx / 32.0, 16200000.0, -10800000.0);
		@class.method_4(x3, num4);
		@class.method_5(num6, base.Transform2D.Extents.Cx / 32.0, 5400000.0, -10800000.0);
		@class.method_4(x7, y3);
		@class.method_5(num6, base.Transform2D.Extents.Cx / 32.0, 5400000.0, 10800000.0);
		@class.method_4(base.Transform2D.Extents.Cx, 0.0);
		@class.method_4(x, y4);
		@class.method_4(base.Transform2D.Extents.Cx, num5);
		@class.method_4(num3, num5);
		@class.method_4(num3, y5);
		@class.method_5(num6, base.Transform2D.Extents.Cx / 32.0, 0.0, 5400000.0);
		@class.method_4(x2, base.Transform2D.Extents.Cy);
		@class.method_5(num6, base.Transform2D.Extents.Cx / 32.0, 5400000.0, 5400000.0);
		@class.method_4(num2, num5);
		@class.method_4(0.0, num5);
		@class.method_4(base.Transform2D.Extents.Cx / 8.0, y4);
		@class.method_8();
		...
		@class.method_4(x2, y3);
		@class.method_5(num6, base.Transform2D.Extents.Cx / 32.0, 16200000.0, -10800000.0);
		@class.method_4(x4, num4);
		@class.method_8();
		@class.method_3(x5, num6);
		@class.method_5(num6, base.Transform2D.Extents.Cx / 32.0, 10800000.0, -5400000.0);
		@class.method_4(x3, y3);
		@class.method_5(num6, base.Transform2D.Extents.Cx / 32.0, 16200000.0, 10800000.0);
		@class.method_4(x5, num4);
		@class.method_8();
		...
		@class.method_3(x4, num6);
		@class.method_4(x4, num4);
		@class.method_3(x5, num4);
		@class.method_4(x5, num6);
		@class.method_3(num2, num5);
		@class.method_4(num2, y6);
		@class.method_3(num3, y6);
		@class.method_4(num3, num5);
		@class.TextRectangle = new Class3457(num2, num4, num3, base.Transform2D.Extents.Cy);
		return @class;
	}
