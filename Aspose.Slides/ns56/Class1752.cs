...
internal class Class1752 : Class1351
{
	public delegate Class1752 Delegate1135();

	public delegate void Delegate1137(Class1752 elementData);

	public delegate void Delegate1136(Class1752 elementData);
	...
	public Class1752(XmlReader reader)
		: base(reader)
	{
	}
	...
	public override void vmethod_4(string prefix, XmlWriter writer, string elementName)
	{
		...
		if (bool_1)
		{
			writer.WriteAttributeString("denormalized", bool_1 ? "1" : "0");
		}
