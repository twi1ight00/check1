...
internal class Class186 : Class160
{
	internal Class186(Interface42 interface42_1, float float_5, float float_6, Class913 class913_1)
	...
	internal override GraphicsPath vmethod_0(RectangleF rectangleF_0)
	{
		...
		if (class913_0.class901_0 != null)
		{
			if (class913_0.class901_0.arrayList_0.Count > 0)
			{
				...
				num3 = Convert.ToSingle(class913_0.class901_0.arrayList_0[0]) + Convert.ToSingle(class913_0.class901_0.arrayList_0[1]);
			}
			else
			{
				num = Math.Min(rectangleF_0.Width, rectangleF_0.Height) * 0.33333f;
				num2 = Math.Min(rectangleF_0.Width, rectangleF_0.Height) * 0.33333f;
			}
		}
		else
		{
		...
		{
			float num4 = (rectangleF_0.Height - num) * rectangleF_0.Width / rectangleF_0.Height;
			float num5 = (rectangleF_0.Width - num2) * rectangleF_0.Height / rectangleF_0.Width;
			...
			case 1:
			{
				...
				reference23 = new PointF(rectangleF_0.Width + float_3, float_4);
				ref PointF reference24 = ref array[2];
				reference24 = new PointF(num4 + float_3, num + float_4);
				ref PointF reference25 = ref array[3];
				reference25 = new PointF(num2 + float_3, num + float_4);
				ref PointF reference26 = ref array[4];
				reference26 = new PointF(num2 + float_3, num5 + float_4);
			...
			case 2:
			{
				...
				reference17 = new PointF(num2 + float_3, rectangleF_0.Height - num5 + float_4);
				ref PointF reference18 = ref array[2];
				reference18 = new PointF(num2 + float_3, rectangleF_0.Height - num + float_4);
				ref PointF reference19 = ref array[3];
				reference19 = new PointF(num4 + float_3, rectangleF_0.Height - num + float_4);
				ref PointF reference20 = ref array[4];
				reference20 = new PointF(rectangleF_0.Width + float_3, rectangleF_0.Height + float_4);
			...
			case 3:
			{
				...
				reference10 = new PointF(float_3 + rectangleF_0.Width, float_4);
				ref PointF reference11 = ref array[1];
				reference11 = new PointF(rectangleF_0.Width + float_3, float_4 + rectangleF_0.Height);
				...
				reference13 = new PointF(rectangleF_0.Width - num4 + float_3, rectangleF_0.Height - num + float_4);
				ref PointF reference14 = ref array[4];
				reference14 = new PointF(rectangleF_0.Width - num2 + float_3, rectangleF_0.Height - num + float_4);
				ref PointF reference15 = ref array[5];
				reference15 = new PointF(float_3 + rectangleF_0.Width - num2, rectangleF_0.Height - num5 + float_4);
				break;
			}
			case 4:
			{
				...
				reference7 = new PointF(rectangleF_0.Width - num2 + float_3, num5 + float_4);
				ref PointF reference8 = ref array[4];
				reference8 = new PointF(rectangleF_0.Width - num2 + float_3, num + float_4);
				ref PointF reference9 = ref array[5];
				reference9 = new PointF(rectangleF_0.Width - num4 + float_3, num + float_4);
				break;
			}
			}
			graphicsPath.AddLine(array[0], array[1]);
