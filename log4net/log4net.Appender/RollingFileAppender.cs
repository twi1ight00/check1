...
public class RollingFileAppender : FileAppender
{
	...
	private void RollOverIfDateBoundaryCrossing()
	{
		if (m_staticLogFileName && m_rollDate && FileExists(m_baseFileName))
		{
			...
			{
				m_scheduledFilename = m_baseFileName + dateTime.ToString(m_datePattern, DateTimeFormatInfo.InvariantInfo);
	...
	private void InitializeFromOneFile(string baseFile, string curFileName)
	{
		...
		if (m_rollDate && !m_staticLogFileName && !curFileName.StartsWith(CombinePath(baseFile, m_dateTime.Now.ToString(m_datePattern, DateTimeFormatInfo.InvariantInfo))))
		{
