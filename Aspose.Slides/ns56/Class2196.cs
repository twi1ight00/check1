...
internal class Class2196 : Class1351
{
	public delegate Class2196 Delegate2324();

	public delegate void Delegate2325(Class2196 elementData);

	public delegate void Delegate2326(Class2196 elementData);
	...
	public Class1958 NotesStyle => class1958_0;
	...
	public Class2196(XmlReader reader)
		: base(reader)
	{
	}
	...
	protected override void vmethod_2()
	{
		...
		delegate1741_0 = method_5;
		delegate1743_0 = method_6;
	...
	public override void vmethod_4(string prefix, XmlWriter writer, string elementName)
	{
		...
		if (class1958_0 != null)
		{
			class1958_0.vmethod_4("p", writer, "notesStyle");
		}
		if (class1889_0 != null)
		{
	...
	private Class1958 method_5()
	{
		if (class1958_0 != null)
		{
			throw new Exception("Only one <notesStyle> element can be added.");
		}
		class1958_0 = new Class1958();
		return class1958_0;
	}

	private void method_6(Class1958 _notesStyle)
	{
		class1958_0 = _notesStyle;
	}
