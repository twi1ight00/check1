...
internal class Class2155 : Class1351
{
	public delegate Class2155 Delegate2197();

	public delegate void Delegate2198(Class2155 elementData);

	public delegate void Delegate2199(Class2155 elementData);

	public Class2605.Delegate2773 delegate2773_0;

	private Enum328 enum328_0;

	private Enum336 enum336_0;

	private List<Class2605> list_0;

	public static readonly Enum328 enum328_1 = Class2458.smethod_0("span");

	public static readonly Enum336 enum336_1 = Class2467.smethod_0("cw");
	...
	private void method_2(XmlReader reader)
	{
		while (reader.MoveToNextAttribute())
		{
			if (!(reader.Prefix == "xmlns"))
			{
				...
				{
				case "hueDir":
					enum336_0 = Class2467.smethod_0(reader.Value);
					break;
				case "meth":
					enum328_0 = Class2458.smethod_0(reader.Value);
					break;
				}
			}
		}
	...
	public Class2155(XmlReader reader)
		: base(reader)
	{
	}
	...
	public override void vmethod_4(string prefix, XmlWriter writer, string elementName)
	{
		...
		if (enum328_0 != enum328_1)
		{
			writer.WriteAttributeString("meth", Class2458.smethod_1(enum328_0));
		}
		if (enum336_0 != enum336_1)
		{
			writer.WriteAttributeString("hueDir", Class2467.smethod_1(enum336_0));
		}
		if (list_0 != null)
		{
