...
internal class Class3207 : Class3091
{
	private const string string_0 = "adj1";

	private const string string_1 = "adj2";

	public override Enum493 Kind => Enum493.const_50;

	public Class3207(Class3448 xfrm)
		: base(xfrm)
	{
	}
	...
	public override Class3279 vmethod_1()
	{
		...
		double num5 = Class3089.smethod_1(num3, num, base.Transform2D.Extents.Cy / 2.0);
		double left = Class3089.smethod_2(num, 0.0, num5);
		double right = Class3089.smethod_2(x, num5, 0.0);
		...
		@class.method_8();
		@class.TextRectangle = new Class3457(left, num3, right, num4);
		return @class;
	}
