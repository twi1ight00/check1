...
internal class Class5013 : Class5003
{
	...
	public override Class5024 imethod_2(Class5024[] args, Class5750 pInfo)
	{
		...
		if (text == null)
		{
			throw new Exception55("Incorrect parameter to from-nearest-specified-value function");
		}
		...
		return pInfo.method_3().method_7(num);
	}
}
