...
internal class Class3224 : Class3091
{
	private const string string_0 = "adj1";

	private const string string_1 = "adj2";

	public override Enum493 Kind => Enum493.const_48;

	public Class3224(Class3448 xfrm)
		: base(xfrm)
	{
	}
	...
	public override Class3279 vmethod_1()
	{
		...
		double num2 = Class3089.smethod_1(base.Transform2D.Extents.Cy, y, 200000.0);
		double num3 = Class3089.smethod_2(base.Transform2D.Extents.Cy / 2.0, 0.0, num2);
		double num4 = Class3089.smethod_2(base.Transform2D.Extents.Cy / 2.0, num2, 0.0);
		double num5 = Class3089.smethod_1(num2, num, base.Transform2D.Extents.Cy / 2.0);
		double right = Class3089.smethod_2(base.Transform2D.Extents.Cx, 0.0, num5);
		Class3279 @class = new Class3279(base.Transform2D);
		@class.method_2(base.Transform2D.Extents.Cx, base.Transform2D.Extents.Cy, Enum492.const_0, extrusionOk: false, stroke: true);
		@class.method_3(0.0, num3);
		...
		@class.method_8();
		@class.TextRectangle = new Class3457(num5, num3, right, num4);
		return @class;
	}
