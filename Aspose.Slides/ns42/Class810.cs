...
internal class Class810 : XmlElement
{
	private static readonly string[] string_0 = new string[9] { "tl", "t", "tr", "l", "ctr", "r", "bl", "b", "br" };

	public new Class822 OwnerDocument => base.OwnerDocument as Class822;

	public Class810(string prefix, string localName, string namespaceURI, XmlDocument doc)
	...
	public Class810 method_0(string localName, string namespaceURI)
	{
		string text = GetPrefixOfNamespace(namespaceURI);
		if (text == null || text == "")
		{
			if (!Class822.dictionary_0.TryGetValue(namespaceURI, out var value))
			{
				value = "xns";
			}
			int num = 0;
		...
		Class810 @class = (Class810)OwnerDocument.CreateElement(text, localName, namespaceURI);
		AppendChild(@class);
		@class.vmethod_3();
		return @class;
	}
	...
	{
		Class810 @class = (Class810)OwnerDocument.CreateElement(GetPrefixOfNamespace(namespaceURI), localName, namespaceURI);
		PrependChild(@class);
		@class.vmethod_3();
		return @class;
	}

	public Class810 method_2(Class810 elem, string localName, string namespaceURI)
	{
		Class810 @class = (Class810)OwnerDocument.CreateElement(OwnerDocument.DocumentElement.GetPrefixOfNamespace(namespaceURI), localName, namespaceURI);
		if (elem != null)
		{
	...
	public Class810 method_3(string oldElemName, string localName, string namespaceURI)
	{
		Class810 elem = method_57(oldElemName, namespaceURI);
		return method_2(elem, localName, namespaceURI);
	}

	public Class810 method_4(string[] oldElemNames, string localName, string namespaceURI)
	{
		Class810 elem = method_59(oldElemNames, namespaceURI);
		return method_2(elem, localName, namespaceURI);
	}
	...
	{
		Class810[] array = method_56(localName, namespaceURI);
	...
	public Class810[] method_56(string localName, string namespaceURI)
	{
		...
		try
		{
			...
			{
				XmlNode xmlNode = (XmlNode)enumerator.Current;
				if (xmlNode is Class810 @class && @class.LocalName == localName && @class.NamespaceURI == namespaceURI)
				{
					list.Add(@class);
				}
			}
	...
	public Class810 method_57(string localName, string namespaceURI)
	{
		IEnumerator enumerator = GetEnumerator();
		try
		{
	...
	public Class810[] method_58(string[] localNames, string namespaceURI)
	{
		List<Class810> list = new List<Class810>();
		IEnumerator enumerator = GetEnumerator();
		try
	...
	public Class810 method_59(string[] localNames, string namespaceURI)
	{
		IEnumerator enumerator = GetEnumerator();
		try
		{
	...
	public Class810 method_60(string localName, string namespaceURI)
	{
		Class810 @class = method_57(localName, namespaceURI);
		if (@class == null)
		{
