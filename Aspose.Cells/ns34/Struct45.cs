...
internal struct Struct45
{
	internal static ArrayList smethod_0(Interface42 interface42_0, Class821 class821_0, Class844 class844_0, Rectangle rectangle_0, float float_0, double double_0, int int_0)
	{
		...
		{
			return smethod_4(interface42_0, class821_0, class844_0, rectangle_0, float_0, double_0);
		}
		...
		float num4 = (float)class844_0.Overlap / 100f;
		float num5 = (float)class844_0.GapWidth / 100f;
		...
		for (int i = 0; i < class4.Count; i++)
		{
			...
			float num14 = (float)(double_0 - yValue) / (float)(class3.MaxValue - class3.MinValue) * (float)rectangle_0.Width;
			bool flag = false;
			if (num14 == 0f)
			{
				flag = true;
			...
			if (rectangleF.Height + 1f >= (num10 - 1f) / 3f)
			{
				if (!flag)
				{
					smethod_1(interface42_0, class5, rectangleF, float_0, class3);
				}
	...
	private static void smethod_1(Interface42 interface42_0, Class831 class831_0, RectangleF rectangleF_0, float float_0, Class823 class823_0)
	{
	...
	internal static void smethod_2(Interface42 interface42_0, Class821 class821_0, Rectangle rectangle_0, ArrayList arrayList_0)
	{
		if (!Struct63.smethod_18(rectangle_0))
		{
			...
			for (int i = 0; i < arrayList_0.Count; i++)
			{
				...
				Class844 class2 = @class.method_9(int_);
				Enum53 @enum = class2.method_20();
				Class823 class823_ = ((@enum != Enum53.const_0) ? class821_0.method_2() : class821_0.method_1());
				smethod_3(interface42_0, class823_, @class, int_, int_2, rectangleF_, bool_, rectangle_0.Width);
			}
		}
	}

	private static void smethod_3(Interface42 interface42_0, Class823 class823_0, Class842 class842_0, int int_0, int int_1, RectangleF rectangleF_0, bool bool_0, int int_2)
	{
		class842_0.method_9(int_0);
		Class832 @class = class842_0.method_9(int_0).method_9().method_1(int_1)
			.method_6();
		SizeF sizeF = Struct51.smethod_0(interface42_0, class823_0, class842_0, int_0, int_1, int_2);
		float num = 0f;
		float num2 = rectangleF_0.Y + (rectangleF_0.Height - sizeF.Height) / 2f;
		Enum74 @enum = @class.vmethod_0();
		if (@enum == Enum74.const_9)
		{
			@enum = Struct51.smethod_11(class842_0.method_9(int_0).Type);
		}
		switch (@enum)
		{
		default:
		...
		if (bool_0)
		{
			if (num - (float)Struct51.int_0 < rectangleF_0.X)
			{
				num += rectangleF_0.X - (num - (float)Struct51.int_0);
			}
		}
		else if (num + (float)Struct51.int_0 + sizeF.Width > rectangleF_0.Right)
		{
			num -= num + (float)Struct51.int_0 + sizeF.Width - rectangleF_0.Right;
		}
		@class.method_0().rectangle_1 = new Rectangle(Struct63.smethod_5(num), Struct63.smethod_5(num2), Struct63.smethod_3(sizeF.Width), Struct63.smethod_3(sizeF.Height));
		@class.method_0().method_18(bool_0);
		@class.method_0().method_9();
		Struct51.smethod_1(interface42_0, class823_0, class842_0, int_0, int_1, @class.method_0().rectangle_0);
	}

	private static ArrayList smethod_4(Interface42 interface42_0, Class821 class821_0, Class844 class844_0, Rectangle rectangle_0, float float_0, double double_0)
	{
		Enum53 @enum = class844_0.method_20();
		ChartType_Chart chartType_Chart = ChartType_Chart.Bar;
		_ = class821_0.method_7().Count;
		Class842 @class = class821_0.method_7();
		Class823 class2;
		Class823 class3;
		int num;
		...
		if (@enum == Enum53.const_0)
		{
			...
			class3 = class821_0.method_9();
			num = @class.method_14(Enum53.const_0, ChartType_Chart.Bar);
			arrayList = Struct47.smethod_75(class821_0.method_7().method_0(), class821_0.vmethod_0());
		}
		else
		{
			class2 = class821_0.method_2();
			class3 = class821_0.method_10();
			num = @class.method_14(Enum53.const_1, ChartType_Chart.Bar);
			arrayList = Struct47.smethod_75(class821_0.method_7().method_2(), class821_0.vmethod_0());
		}
		double num2 = (class3.IsLogarithmic ? class3.method_6(class3.MaxValue) : class3.MaxValue);
		double num3 = (class3.IsLogarithmic ? class3.method_6(class3.MinValue) : class3.MinValue);
		double_0 = (class3.IsLogarithmic ? class3.method_6(double_0) : double_0);
		...
		if (!class2.AxisBetweenCategories && !class821_0.IsDataTableShown)
		{
			num6 = Struct44.smethod_29(baseUnitScale, int_2, int_, class821_0.vmethod_0());
			if (num6 == 0)
			{
				num6 = 1;
			}
		...
		{
			num6 = Struct44.smethod_29(baseUnitScale, int_2, int_, class821_0.vmethod_0()) + 1;
		}
		double num7 = (double)rectangle_0.Height / (double)num6;
		int num8 = 0;
		while (true)
		{
			if (num8 < count)
			{
				Class831 class4 = class844_0.method_9().method_1(num8);
				float num9 = (float)(num7 / (double)((float)num - num4 * (float)(num - 1) + num5));
				...
				int num12 = Struct44.smethod_29(baseUnitScale, int_3, int_, class821_0.vmethod_0());
				...
				float num14 = 0f;
				num14 = ((!class2.IsPlotOrderReversed) ? ((float)(rectangle_0.Y + rectangle_0.Height) - num9 - num13 - num11 / 2f) : ((float)rectangle_0.Y + num13 + num11 / 2f));
				int num15 = @class.method_19(class844_0, @enum, new ChartType_Chart[1] { chartType_Chart });
				if (num15 == -1)
				{
					break;
				}
				int index = class844_0.Index;
				num14 = ((!class2.IsPlotOrderReversed) ? (num14 - (float)num15 * (num9 - num10)) : (num14 + (float)num15 * (num9 - num10)));
				if (class4 != null && !class4.imethod_0())
				{
					double yValue = class4.YValue;
					float num16 = (float)(double_0 - yValue) / (float)(num2 - num3) * (float)rectangle_0.Width;
					bool flag = false;
					if (num16 == 0f)
					{
						flag = true;
					...
					PointF pointF_ = new PointF(float_0, num14 + num9 / 2f);
					double num18 = 0.0;
					double num19 = 0.0;
					float float_ = 0f;
					float float_2 = 0f;
					if (class5 != null)
					{
						...
						case Enum69.const_0:
						{
							double num20 = ((class5.MinusValue.Count > num8) ? class5.method_2(class5.MinusValue[num8]) : 0.0);
							num18 = num20;
							num20 = ((class5.PlusValue.Count > num8) ? class5.method_2(class5.PlusValue[num8]) : 0.0);
							num19 = num20;
							break;
						}
						case Enum69.const_1:
							...
							break;
						case Enum69.const_2:
							num18 = class5.Amount * Math.Abs(yValue) / 100.0;
							num19 = num18;
							break;
						}
						float_ = (float)num18 / (float)(num2 - num3) * (float)rectangle_0.Width;
						float_2 = (float)num19 / (float)(num2 - num3) * (float)rectangle_0.Width;
						if (!class3.IsPlotOrderReversed)
						{
							pointF_.X -= num16;
						}
					...
					RectangleF rectangleF = new RectangleF(num17, num14, num16 + 1f, num9);
					if (rectangleF.Y < (float)rectangle_0.Y)
					{
						rectangleF.Height -= (float)rectangle_0.Y - rectangleF.Y;
						rectangleF.Y = rectangle_0.Y;
					...
					if (rectangleF.Right >= (float)rectangle_0.X && rectangleF.Left <= (float)rectangle_0.Right)
					{
						...
						if (rectangleF.Height + 1f >= (num9 - 1f) / 3f)
						{
							if (!flag)
							{
								smethod_1(interface42_0, class4, rectangleF, float_0, class3);
							}
							object[] array = new object[4];
							bool flag2 = !(rectangleF.X < float_0) && (yValue != 0.0 || ((!class3.IsPlotOrderReversed) ? true : false));
							array[0] = index;
	...
	internal static ArrayList smethod_5(Interface42 interface42_0, Class821 class821_0, Class844 class844_0, Rectangle rectangle_0, int int_0)
	{
		Enum53 @enum = class844_0.method_20();
		...
		if (class2.CategoryType == Enum64.const_2)
		{
			return smethod_7(interface42_0, class821_0, class844_0, rectangle_0, num2);
		}
		_ = class3.MinValue;
		_ = class3.MaxValue;
		...
		int num8 = @class.method_19(class844_0, @enum, new ChartType_Chart[1] { chartType_Chart });
		if (num8 == -1)
		{
			return new ArrayList();
		}
		...
		for (int i = 0; i < class4.Count; i++)
		{
			...
			if (class5 != null)
			{
				...
				if (rectangleF.Bottom >= (float)rectangle_0.Y && rectangleF.Y <= (float)rectangle_0.Bottom)
				{
					...
					if (rectangleF.Height + 1f >= (num9 - 1f) / 3f)
					{
						if (!flag)
						{
							smethod_1(interface42_0, class5, rectangleF, num2, class3);
						}
						object[] array = new object[4];
			...
			smethod_6(interface42_0, class844_0, ref arrayList_, arrayList2);
		}
		return arrayList;
	}

	private static void smethod_6(Interface42 interface42_0, Class844 class844_0, ref ArrayList arrayList_0, ArrayList arrayList_1)
	{
	...
	private static ArrayList smethod_7(Interface42 interface42_0, Class821 class821_0, Class844 class844_0, Rectangle rectangle_0, float float_0)
	{
		Enum53 @enum = class844_0.method_20();
		ChartType_Chart chartType_Chart = ChartType_Chart.BarStacked;
		Class842 @class = class821_0.method_7();
		...
		_ = class3.MinValue;
		_ = class3.MaxValue;
		float num2 = (float)class844_0.Overlap / 100f;
		float num3 = (float)class844_0.GapWidth / 100f;
		ArrayList arrayList2 = new ArrayList();
		int count = arrayList.Count;
		Enum87 baseUnitScale = class2.BaseUnitScale;
		int int_ = (int)class2.MinValue;
		...
		while (true)
		{
			if (num6 < count)
			{
				Class831 class4 = class844_0.method_9().method_1(num6);
				...
				int_3 = Struct44.smethod_32(baseUnitScale, int_3, class821_0.vmethod_0());
				int num10 = Struct44.smethod_29(baseUnitScale, int_3, int_, class821_0.vmethod_0());
				...
				IList list = @class.method_17(@enum, new ChartType_Chart[1] { chartType_Chart });
				int num13 = @class.method_19(class844_0, @enum, new ChartType_Chart[1] { chartType_Chart });
				if (num13 == -1)
				{
					break;
				}
				...
				if (class4 != null)
				{
					...
					if (yValue >= 0.0)
					{
						...
						{
							Class831 class5 = ((Class844)list[i]).method_9().method_1(num6);
							if (class5 != null)
							{
					...
					else
					{
						...
						{
							Class831 class6 = ((Class844)list[j]).method_9().method_1(num6);
							if (class6 != null)
							{
				...
				smethod_6(interface42_0, class844_0, ref arrayList_, arrayList3);
				num6++;
				continue;
			}
			return arrayList2;
	...
	internal static ArrayList smethod_8(Interface42 interface42_0, Class821 class821_0, Class844 class844_0, Rectangle rectangle_0, int int_0)
	{
		Enum53 @enum = class844_0.method_20();
		...
		if (class2.CategoryType == Enum64.const_2)
		{
			return smethod_9(interface42_0, class821_0, class844_0, rectangle_0, num2);
		}
		_ = class3.MinValue;
		_ = class3.MaxValue;
		float num3 = (float)class844_0.Overlap / 100f;
		...
		for (int i = 0; i < class4.Count; i++)
		{
			...
			if (class5 != null)
			{
				...
				float num15 = (float)Math.Abs(yValue) * 100f / (float)num14 / (float)(class3.MaxValue - class3.MinValue) * (float)rectangle_0.Width;
				float num16 = (float)Math.Abs(num13) * 100f / (float)num14 / (float)(class3.MaxValue - class3.MinValue) * (float)rectangle_0.Width;
				bool flag = false;
				if (num15 == 0f)
				{
					flag = true;
	...
	private static ArrayList smethod_9(Interface42 interface42_0, Class821 class821_0, Class844 class844_0, Rectangle rectangle_0, float float_0)
	{
		Enum53 @enum = class844_0.method_20();
		ChartType_Chart chartType_Chart = ChartType_Chart.Bar100PercentStacked;
		Class842 @class = class821_0.method_7();
		...
		while (true)
		{
			if (num6 < count)
			{
				...
				if (class4 != null)
				{
					...
					{
						Class831 class7 = ((Class844)list[k]).method_9().method_1(num6);
						if (class7 != null)
						{
					...
					float num16 = (float)Math.Abs(yValue) * 100f / (float)num15 / (float)(class3.MaxValue - class3.MinValue) * (float)rectangle_0.Width;
					float num17 = (float)Math.Abs(num14) * 100f / (float)num15 / (float)(class3.MaxValue - class3.MinValue) * (float)rectangle_0.Width;
					bool flag = false;
					if (num16 == 0f)
					{
						flag = true;
	...
	internal static void smethod_10(Interface42 interface42_0, Class821 class821_0, float float_0, double double_0, int int_0)
	{
		Class842 @class = class821_0.method_7();
		...
		{
			smethod_11(interface42_0, class821_0, float_0, double_0);
			return;
		}
		ArrayList arrayList = new ArrayList();
		float num = class821_0.method_13().Height / (float)int_0;
		float num2 = class821_0.method_13().method_3(bool_1: true, int_0, count);
		...
		for (int i = 0; i < int_0; i++)
		{
			...
			for (int j = 0; j < arrayList2.Count; j++)
			{
				...
				Class831 class6 = class5.method_1(num6);
				if (class6 != null && !class6.imethod_0())
				{
					double num7 = class2.method_18(class6.YValue);
					float num8 = (float)(num7 - double_0) / (float)(class2.MaxValue - class2.MinValue) * class821_0.method_13().Width;
					if (class2.IsPlotOrderReversed)
					{
						num8 = 0f - num8;
					}
					smethod_20(interface42_0, class6, class821_0, num5, num2, float_, float_0, num8, double.NaN);
					PointF pointF = smethod_17(class821_0, num5, num2, float_, float_0, num8);
					arrayList.Add(new object[3] { index, num6, pointF });
				}
			}
		}
		smethod_19(interface42_0, class821_0, arrayList);
	}

	private static void smethod_11(Interface42 interface42_0, Class821 class821_0, float float_0, double double_0)
	{
		Class842 @class = class821_0.method_7();
		Class851 class2 = class821_0.method_13();
		int count = @class.Count;
		Class823 class3 = class821_0.method_9();
		Class823 class4 = class821_0.method_1();
		ArrayList arrayList = new ArrayList();
		...
		float num3 = class821_0.method_13().method_3(bool_1: true, num, count);
		float float_ = class821_0.method_13().method_4();
		...
		for (int i = 0; i < count2; i++)
		{
			...
			int_3 = Struct44.smethod_32(baseUnitScale, int_3, class821_0.vmethod_0());
			int num5 = Struct44.smethod_29(baseUnitScale, int_3, (int)class4.MinValue, class821_0.vmethod_0());
			float num6 = num2 * (float)num5;
			float num7 = num6 + num4 / 2f;
			num7 = class821_0.method_13().Y - num7 + num3;
			IList list = @class.method_16();
			for (int j = 0; j < list.Count; j++)
			{
				Class844 class5 = (Class844)list[j];
				...
				Class831 class7 = class6.method_1(num9);
				if (class7 != null && !class7.imethod_0())
				{
					double num10 = class3.method_18(class7.YValue);
					float num11 = (float)(num10 - double_0) / (float)(class3.MaxValue - class3.MinValue) * class821_0.method_13().Width;
					if (class3.IsPlotOrderReversed)
					{
						num11 = 0f - num11;
					}
					smethod_20(interface42_0, class7, class821_0, num7, num3, float_, float_0, num11, double.NaN);
					PointF pointF = smethod_17(class821_0, num7, num3, float_, float_0, num11);
	...
	internal static void smethod_12(Interface42 interface42_0, Class821 class821_0, double double_0, int int_0)
	{
		Class842 @class = class821_0.method_7();
		Class823 class2 = class821_0.method_9();
		Class823 class3 = class821_0.method_1();
		float num = 0f;
		num = ((!class821_0.method_9().IsPlotOrderReversed) ? (class821_0.method_13().X + (float)Math.Abs(class2.MinValue / (double)(float)(class2.MaxValue - class2.MinValue)) * class821_0.method_13().Width) : (class821_0.method_13().X + (float)Math.Abs(class2.MaxValue / (double)(float)(class2.MaxValue - class2.MinValue)) * class821_0.method_13().Width));
		if (class3.CategoryType == Enum64.const_2)
		{
			smethod_13(interface42_0, class821_0, num, double_0);
			return;
		}
		ArrayList arrayList = new ArrayList();
		float num2 = class821_0.method_13().Height / (float)int_0;
		float num3 = class821_0.method_13().method_3(bool_1: true, int_0, 1);
		float float_ = class821_0.method_13().method_4();
		float num4 = num3 * (float)class821_0.GapWidth / 100f;
		for (int i = 0; i < int_0; i++)
		{
			...
			for (int j = 0; j < list.Count; j++)
			{
				...
				if (Struct63.smethod_14(ref pointVal, out var valTotal, list, displayOrder, num6, class2.MaxValue, class2.MinValue))
				{
					float num7 = (float)pointVal / (float)(class2.MaxValue - class2.MinValue) * class821_0.method_13().Width;
					float num8 = (float)valTotal / (float)(class2.MaxValue - class2.MinValue) * class821_0.method_13().Width;
					float num9;
					if (class2.IsPlotOrderReversed)
					{
						num9 = num - (num8 - num7);
					...
					if (num9 < class821_0.method_13().X)
					{
						num9 = class821_0.method_13().X;
					}
					if (num9 > class821_0.method_13().X + class821_0.method_13().Width)
					{
						num9 = class821_0.method_13().X + class821_0.method_13().Width;
					}
					if (num10 < class821_0.method_13().X)
					{
						num10 = class821_0.method_13().X;
					}
					if (num10 > class821_0.method_13().X + class821_0.method_13().Width)
					{
						num10 = class821_0.method_13().X + class821_0.method_13().Width;
					}
					num7 = num10 - num9;
					smethod_16(object_0: new object[5] { class6, num5, num9, num7, valTotal }, double_0: pointVal, arrayList_0: arrayList2, class823_0: class2);
					PointF pointF = smethod_18(class821_0, num5, num3, float_, num9, num7);
					arrayList.Add(new object[3] { index, num6, pointF });
				}
			}
			for (int k = 0; k < arrayList2.Count; k++)
			{
				...
				smethod_20(interface42_0, class831_, class821_0, (float)array[1], num3, float_, (float)array[2], (float)array[3], (double)array[4]);
			}
			arrayList2.Clear();
		}
		smethod_19(interface42_0, class821_0, arrayList);
	...
	private static void smethod_13(Interface42 interface42_0, Class821 class821_0, float float_0, double double_0)
	{
		Class842 @class = class821_0.method_7();
		Class823 class2 = class821_0.method_9();
		Class823 class3 = class821_0.method_1();
		...
		int num = Struct44.smethod_29(baseUnitScale, int_, int_2, class821_0.vmethod_0()) + 1;
		float num2 = class821_0.method_13().Height / (float)num;
		float num3 = class821_0.method_13().method_3(bool_1: true, num, 1);
		float float_ = class821_0.method_13().method_4();
		float num4 = num3 * (float)class821_0.GapWidth / 100f;
		ArrayList arrayList2 = Struct47.smethod_75(class821_0.method_7().method_0(), class821_0.vmethod_0());
		...
		for (int i = 0; i < count; i++)
		{
			...
			int int_3 = int.Parse(arrayList2[i].ToString());
			int_3 = Struct44.smethod_32(baseUnitScale, int_3, class821_0.vmethod_0());
			int num5 = Struct44.smethod_29(baseUnitScale, int_3, (int)class3.MinValue, class821_0.vmethod_0());
			float num6 = num2 * (float)num5;
			float num7 = num6 + num4 / 2f;
			num7 = class821_0.method_13().Y - num7;
			IList list = @class.method_16();
			for (int j = 0; j < list.Count; j++)
			{
				Class844 class4 = (Class844)list[j];
				...
				double pointVal = class6.YValue;
				if (Struct63.smethod_14(ref pointVal, out var valTotal, list, displayOrder, num8, class2.MaxValue, class2.MinValue))
				{
					float num9 = (float)pointVal / (float)(class2.MaxValue - class2.MinValue) * class821_0.method_13().Width;
					float num10 = (float)valTotal / (float)(class2.MaxValue - class2.MinValue) * class821_0.method_13().Width;
					float num11;
					if (class2.IsPlotOrderReversed)
					{
					...
					if (num11 < class821_0.method_13().X)
					{
						num11 = class821_0.method_13().X;
					}
					if (num11 > class821_0.method_13().X + class821_0.method_13().Width)
					{
						num11 = class821_0.method_13().X + class821_0.method_13().Width;
					}
					if (num12 < class821_0.method_13().X)
					{
						num12 = class821_0.method_13().Y;
					}
					if (num12 > class821_0.method_13().X + class821_0.method_13().Width)
					{
						num12 = class821_0.method_13().X + class821_0.method_13().Width;
					}
					num9 = num12 - num11;
					smethod_16(object_0: new object[5] { class6, num7, num11, num9, valTotal }, double_0: pointVal, arrayList_0: arrayList3, class823_0: class2);
					PointF pointF = smethod_18(class821_0, num7, num3, float_, num11, num9);
	...
	internal static void smethod_14(Interface42 interface42_0, Class821 class821_0, double double_0, int int_0)
	{
		Class842 @class = class821_0.method_7();
		Class823 class2 = class821_0.method_9();
		Class823 class3 = class821_0.method_1();
		float num = 0f;
		num = ((!class821_0.method_9().IsPlotOrderReversed) ? (class821_0.method_13().X + class821_0.method_13().Width - (float)Math.Abs(class2.MaxValue / (double)(float)(class2.MaxValue - class2.MinValue)) * class821_0.method_13().Width) : (class821_0.method_13().X + (float)Math.Abs(class2.MaxValue / (double)(float)(class2.MaxValue - class2.MinValue)) * class821_0.method_13().Width));
		if (class3.CategoryType == Enum64.const_2)
		{
			smethod_15(interface42_0, class821_0, num, double_0);
			return;
		}
		ArrayList arrayList = new ArrayList();
		float num2 = class821_0.method_13().Height / (float)int_0;
		...
		for (int i = 0; i < int_0; i++)
		{
			...
			for (int j = 0; j < list.Count; j++)
			{
				...
				double num7 = Struct63.smethod_15(list, num6);
				if (num7 == 0.0)
				{
					continue;
				}
				...
				if (Struct63.smethod_16(ref pointVal, out valTotal, list, displayOrder, num6, class2, num7))
				{
					float num8 = (float)pointVal * 100f / (float)num7 / (float)(class2.MaxValue - class2.MinValue) * class821_0.method_13().Width;
					float num9 = (float)valTotal * 100f / (float)num7 / (float)(class2.MaxValue - class2.MinValue) * class821_0.method_13().Width;
					float num10;
					if (class2.IsPlotOrderReversed)
					{
						num10 = num - (num9 - num8);
					...
					num8 = num11 - num10;
					smethod_16(object_0: new object[5] { class6, num5, num10, num8, valTotal }, double_0: pointVal, arrayList_0: arrayList2, class823_0: class2);
					PointF pointF = smethod_18(class821_0, num5, num3, float_, num10, num8);
					arrayList.Add(new object[3] { index, num6, pointF });
				}
			}
			for (int k = 0; k < arrayList2.Count; k++)
	...
	private static void smethod_15(Interface42 interface42_0, Class821 class821_0, float float_0, double double_0)
	{
		Class842 @class = class821_0.method_7();
		Class823 class2 = class821_0.method_9();
		Class823 class3 = class821_0.method_1();
		...
		for (int i = 0; i < count; i++)
		{
			...
			for (int j = 0; j < list.Count; j++)
			{
				...
				double num9 = Struct63.smethod_15(list, num8);
				if (num9 == 0.0)
				{
					continue;
				}
				double pointVal = class6.YValue;
				double valTotal = pointVal;
				if (Struct63.smethod_16(ref pointVal, out valTotal, list, displayOrder, num8, class2, num9))
				{
					float num10 = (float)pointVal * 100f / (float)num9 / (float)(class2.MaxValue - class2.MinValue) * class821_0.method_13().Width;
					float num11 = (float)valTotal * 100f / (float)num9 / (float)(class2.MaxValue - class2.MinValue) * class821_0.method_13().Width;
					float num12;
					if (class2.IsPlotOrderReversed)
					{
					...
					if (num12 < class821_0.method_13().X)
					{
						num12 = class821_0.method_13().X;
					}
					if (num12 > class821_0.method_13().X + class821_0.method_13().Width)
					{
						num12 = class821_0.method_13().X + class821_0.method_13().Width;
					}
					if (num13 < class821_0.method_13().X)
					{
						num13 = class821_0.method_13().Y;
					}
					if (num13 > class821_0.method_13().X + class821_0.method_13().Width)
					{
						num13 = class821_0.method_13().X + class821_0.method_13().Width;
					}
					num10 = num13 - num12;
					smethod_16(object_0: new object[5] { class6, num7, num12, num10, valTotal }, double_0: pointVal, arrayList_0: arrayList3, class823_0: class2);
					PointF pointF = smethod_18(class821_0, num7, num3, float_, num12, num10);
					arrayList.Add(new object[3] { index, num8, pointF });
				}
			}
			for (int k = 0; k < arrayList3.Count; k++)
	...
	private static void smethod_16(double double_0, object[] object_0, ArrayList arrayList_0, Class823 class823_0)
	{
		_ = class823_0.Chart;
	...
	private static PointF smethod_17(Class821 class821_0, float float_0, float float_1, float float_2, float float_3, float float_4)
	{
		...
		if (num <= num2)
		{
			...
			pointF = Struct50.smethod_47(class821_0, float_0, float_5, float_2, int_);
		}
		else
		{
		...
		PointF pointF2 = Struct50.smethod_47(class821_0, float_0, 1f, float_2, 0);
		float num3 = float_2 * (float)Math.Sin((double)class821_0.Elevation * Math.PI / 180.0);
		return new PointF(pointF.X, pointF2.Y - (float_1 + num3) / 2f);
	}

	private static PointF smethod_18(Class821 class821_0, float float_0, float float_1, float float_2, float float_3, float float_4)
	{
		float_3 += float_4 / 2f;
		...
		if (float_3 <= num)
		{
			...
			return Struct50.smethod_47(class821_0, float_0 - float_1 / 2f, float_5, float_2, 0);
		}
		float_5 = 2f * (float_3 - num);
		return Struct50.smethod_47(class821_0, float_0 - float_1 / 2f, float_5, float_2, 1);
	}

	private static void smethod_19(Interface42 interface42_0, Class821 class821_0, ArrayList arrayList_0)
	{
		Class842 @class = class821_0.method_7();
		for (int i = 0; i < arrayList_0.Count; i++)
		{
			...
			@class.method_9(num).method_2();
			SizeF sizeF = Struct51.smethod_0(interface42_0, class821_0.method_1(), @class, num, int_, (int)class821_0.method_13().Width);
			Struct51.smethod_2(rectangleF_0: new RectangleF(pointF.X - sizeF.Width / 2f, pointF.Y - sizeF.Height / 2f, sizeF.Width, sizeF.Height), interface42_0: interface42_0, class823_0: class821_0.method_1(), class842_0: @class, int_1: num, int_2: int_);
		}
	}

	private static void smethod_20(Interface42 interface42_0, Class831 class831_0, Class821 class821_0, float float_0, float float_1, float float_2, float float_3, float float_4, double double_0)
	{
		...
		{
		case Enum62.const_0:
			smethod_21(interface42_0, class831_0, class821_0, float_0, float_1, float_2, float_3, float_4, (float)num, (float)num2);
			break;
		case Enum62.const_1:
			...
			{
				Struct50.smethod_58(@class.NSeries, class831_0.Index, out var totalPositiveYValue4, out var totalMinusYValue4);
		...
		case Enum62.const_2:
			if (@class.method_29())
			{
				Struct50.smethod_59(@class.NSeries, class831_0.Index, out var totalPositiveYValue5, out var totalMinusYValue5);
				if (class831_0.YValue > 0.0)
				{
			...
			{
				Struct50.smethod_58(@class.NSeries, class831_0.Index, out var totalPositiveYValue6, out var totalMinusYValue6);
				if (class831_0.YValue > 0.0)
				{
					num = ((totalPositiveYValue6 == 0.0) ? 1.0 : ((totalPositiveYValue6 - double_0) / totalPositiveYValue6));
					num2 = ((totalPositiveYValue6 == 0.0) ? 1.0 : ((totalPositiveYValue6 - (double_0 - class831_0.YValue)) / totalPositiveYValue6));
				}
				else
				{
					num = ((totalMinusYValue6 == 0.0) ? 1.0 : ((totalMinusYValue6 - double_0) / totalMinusYValue6));
					num2 = ((totalMinusYValue6 == 0.0) ? 1.0 : ((totalMinusYValue6 - (double_0 - class831_0.YValue)) / totalMinusYValue6));
				}
			}
			else
			{
				num = (float)Struct50.smethod_57(class831_0);
				num2 = 1.0;
			}
			smethod_21(interface42_0, class831_0, class821_0, float_0, float_1, float_2, float_3, float_4, (float)num, (float)num2);
			break;
		case Enum62.const_3:
			smethod_22(interface42_0, class831_0, class821_0, float_0, float_1, float_2, float_3, float_4, (float)num, (float)num2);
			break;
		case Enum62.const_4:
			if (!@class.method_29() && !@class.method_31())
			{
			...
			{
				Struct50.smethod_58(@class.NSeries, class831_0.Index, out var totalPositiveYValue3, out var totalMinusYValue3);
				if (class831_0.YValue > 0.0)
				{
		...
		case Enum62.const_5:
			if (@class.method_29())
			{
				Struct50.smethod_59(@class.NSeries, class831_0.Index, out var totalPositiveYValue, out var totalMinusYValue);
				if (class831_0.YValue > 0.0)
				{
			...
			{
				Struct50.smethod_58(@class.NSeries, class831_0.Index, out var totalPositiveYValue2, out var totalMinusYValue2);
				if (class831_0.YValue > 0.0)
				{
	...
	private static void smethod_21(Interface42 interface42_0, Class831 class831_0, Class821 class821_0, float float_0, float float_1, float float_2, float float_3, float float_4, float float_5, float float_6)
	{
		...
		for (int i = 0; i < 2; i++)
		{
			if (num2 <= num)
			{
				...
				reference = Struct50.smethod_47(class821_0, float_8, float_9, float_7, 0);
				array[i + 4].X = array[i].X;
				array[i + 4].Y = array[i].Y - num4;
				ref PointF reference2 = ref array[i + num3];
				reference2 = Struct50.smethod_47(class821_0, float_8, float_9, float_7, 3);
			...
			else
			{
				...
				reference3 = Struct50.smethod_47(class821_0, float_8, float_9, float_7, 1);
				array[i + 4].X = array[i].X;
				array[i + 4].Y = array[i].Y - num4;
				ref PointF reference4 = ref array[i + num3];
				reference4 = Struct50.smethod_47(class821_0, float_8, float_9, float_7, 2);
				array[i + num3 + 4].X = array[i + num3].X;
				array[i + num3 + 4].Y = array[i + num3].Y - num4;
			}
			num3 = 1;
		...
		if (float_4 != 0f)
		{
			...
			class2.method_11(graphicsPath);
			class2.method_11(graphicsPath2);
		}
		if (float_4 > 0f)
		{
			...
			@class.method_10(graphicsPath3, 0.5f);
			class2.method_11(graphicsPath3);
		}
		else if (float_4 < 0f)
		{
			...
			@class.method_10(graphicsPath4, 0f);
			class2.method_11(graphicsPath4);
		}
		else
		{
			...
			@class.method_10(graphicsPath5, 0.5f);
			class2.method_11(graphicsPath5);
		}
	}

	private static void smethod_22(Interface42 interface42_0, Class831 class831_0, Class821 class821_0, float float_0, float float_1, float float_2, float float_3, float float_4, float float_5, float float_6)
	{
		Class822 @class = class831_0.method_3();
		float num = class821_0.method_13().method_2();
		...
		for (int i = 0; i <= 90; i++)
		{
			...
			if (float_3 <= num)
			{
				...
				{
					hashtable.Add(180 - i, Struct50.smethod_47(class821_0, float_8, float_10, float_7, 0));
				}
				if (!hashtable.ContainsKey(180 + i))
				{
					hashtable.Add(180 + i, Struct50.smethod_47(class821_0, float_9, float_10, float_7, 0));
				}
				if (!hashtable.ContainsKey(i))
				{
					hashtable.Add(i, Struct50.smethod_47(class821_0, float_8, float_10, float_7, 3));
				}
				if (!hashtable.ContainsKey(360 - i))
				{
					hashtable.Add(360 - i, Struct50.smethod_47(class821_0, float_9, float_10, float_7, 3));
				}
			}
			else
			{
				...
				if (!hashtable.ContainsKey(180 - i))
				{
					hashtable.Add(180 - i, Struct50.smethod_47(class821_0, float_8, float_10, float_7, 1));
				}
				if (!hashtable.ContainsKey(180 + i))
				{
					hashtable.Add(180 + i, Struct50.smethod_47(class821_0, float_9, float_10, float_7, 1));
				}
				if (!hashtable.ContainsKey(i))
				{
					hashtable.Add(i, Struct50.smethod_47(class821_0, float_8, float_10, float_7, 2));
				}
				if (!hashtable.ContainsKey(360 - i))
				{
					hashtable.Add(360 - i, Struct50.smethod_47(class821_0, float_9, float_10, float_7, 2));
				}
			}
			...
			if (num4 <= num)
			{
				...
				{
					hashtable2.Add(180 - i, Struct50.smethod_47(class821_0, float_8, float_10, float_11, 0));
				}
				if (!hashtable2.ContainsKey(180 + i))
				{
					hashtable2.Add(180 + i, Struct50.smethod_47(class821_0, float_9, float_10, float_11, 0));
				}
				if (!hashtable2.ContainsKey(i))
				{
					hashtable2.Add(i, Struct50.smethod_47(class821_0, float_8, float_10, float_11, 3));
				}
				if (!hashtable2.ContainsKey(360 - i))
				{
					hashtable2.Add(360 - i, Struct50.smethod_47(class821_0, float_9, float_10, float_11, 3));
				}
			}
			else
			{
				...
				if (!hashtable2.ContainsKey(180 - i))
				{
					hashtable2.Add(180 - i, Struct50.smethod_47(class821_0, float_8, float_10, float_11, 1));
				}
				if (!hashtable2.ContainsKey(180 + i))
				{
					hashtable2.Add(180 + i, Struct50.smethod_47(class821_0, float_9, float_10, float_11, 1));
				}
				if (!hashtable2.ContainsKey(i))
				{
					hashtable2.Add(i, Struct50.smethod_47(class821_0, float_8, float_10, float_11, 2));
				}
				if (!hashtable2.ContainsKey(360 - i))
				{
					hashtable2.Add(360 - i, Struct50.smethod_47(class821_0, float_9, float_10, float_11, 2));
				}
			}
		}
		...
		if (float_4 != 0f)
		{
			...
			int num6 = 270;
			float num7 = 0.5f;
			int elevation = class821_0.Elevation;
			float num8 = 7.5f;
			float num9;
			for (num9 = 90 - elevation; num9 <= (float)(num6 - elevation); num9 += num8)
			{
				...
				@class.method_10(graphicsPath, num7);
				num9 += num11 - num8;
			}
		}
		Class840 class2 = class831_0.method_4();
		...
		if (class821_0.Rotation != 0)
		{
			if (float_4 > 0f)
			{
				...
				class2.method_11(graphicsPath3);
				Struct50.smethod_65(interface42_0, class831_0, maxAngle, minAngle, hashtable);
			}
			else if (float_4 < 0f)
			{
				@class.method_10(graphicsPath2, 0f);
				class2.method_11(graphicsPath2);
				Struct50.smethod_65(interface42_0, class831_0, maxAngle, minAngle, hashtable2);
			}
			else
			{
		...
		{
			class2.method_7(min.X, min.Y, max.X, max.Y);
			class2.method_7(min2.X, min2.Y, max2.X, max2.Y);
		}
		if (float_4 != 0f)
		{
			class2.method_7(min.X, min.Y, min2.X, min2.Y);
			class2.method_7(max.X, max.Y, max2.X, max2.Y);
		}
	}
