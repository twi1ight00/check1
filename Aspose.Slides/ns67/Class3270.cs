...
internal class Class3270 : Class3091
{
	...
	public override Enum493 Kind => Enum493.const_57;

	public Class3270(Class3448 xfrm)
		: base(xfrm)
	{
	}
	...
	public override Class3279 vmethod_1()
	{
		...
		double y3 = Class3089.smethod_1(Math.Min(base.Transform2D.Extents.Cy, base.Transform2D.Extents.Cx), num2, 100000.0);
		double z6 = Class3089.smethod_1(base.Transform2D.Extents.Cy, y2, 100000.0);
		double num5 = Class3089.smethod_2(base.Transform2D.Extents.Cy, 0.0, z6);
		Class3089.smethod_3(num5, base.Transform2D.Extents.Cy, 2.0);
		...
		@class.method_8();
		@class.TextRectangle = new Class3457(0.0, num5, base.Transform2D.Extents.Cx, base.Transform2D.Extents.Cy);
		return @class;
	}
