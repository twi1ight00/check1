...
internal class Class3220 : Class3091
{
	private const string string_0 = "adj1";

	public override Enum493 Kind => Enum493.const_175;

	public Class3220(Class3448 xfrm)
		: base(xfrm)
	{
	}
	...
	{
		double y = Class3089.smethod_0(0.0, base.AdjustValues["adj1"], 73490.0);
		double num = Class3089.smethod_1(base.Transform2D.Extents.Cx, 73490.0, 200000.0);
		double num2 = Class3089.smethod_1(base.Transform2D.Extents.Cy, 73490.0, 200000.0);
		double num3 = Class3089.smethod_1(Math.Min(base.Transform2D.Extents.Cy, base.Transform2D.Extents.Cx), y, 200000.0);
		...
		double num5 = Class3089.smethod_2(base.Transform2D.Extents.Cx / 2.0, num, 0.0);
		...
		@class.method_3(num4, num6);
		@class.method_4(x, num6);
		@class.method_4(x, y2);
