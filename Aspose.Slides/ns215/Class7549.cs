...
internal class Class7549 : Class7457
{
	internal static readonly Type type_0 = typeof(Class5866);
	...
	{
		Class5866 @class = (Class5866)instance.Value;
		switch (function)
		{
		case "get_{default}":
			return method_5((double)@class.Value);
		case "set_{default}":
			@class.Value = (decimal)parameters[0].vmethod_3();
			break;
		case "get_use":
		...
		case "set_value":
			@class.Value = decimal.Parse(parameters[0].ToString(), NumberStyles.Any, CultureInfo.InvariantCulture);
			break;
		default:
