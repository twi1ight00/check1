...
internal class Class3313 : Class3290
{
	private const string string_0 = "adj";

	public override Enum496 ShapeType => Enum496.const_17;

	public override Class3280 vmethod_1()
	{
		Class3313 @class = new Class3313();
	...
	internal override Class3340 vmethod_3()
	{
		...
		@class.method_4();
		@class.method_7(0.0, y5);
		@class.method_3(new Struct159(x2, y7), new Struct159(x3, y6), new Struct159(base.Transform2D.Extents.Cx, 0.0));
		@class.method_4();
