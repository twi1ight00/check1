...
internal class Class3146 : Class3091
{
	...
	public override Enum493 Kind => Enum493.const_67;

	public Class3146(Class3448 xfrm)
		: base(xfrm)
	{
	}
	...
	public override Class3279 vmethod_1()
	{
		...
		double x5 = Class3089.smethod_2(num4, y3, 0.0);
		double num9 = Class3089.smethod_2(num8, y3, 0.0);
		double x6 = Class3089.smethod_2(num3, 0.0, num2);
		double num10 = Class3089.smethod_1(x6, 1.0, 2.0);
		double y4 = Class3089.smethod_2(x5, 0.0, num10);
		double y5 = Class3089.smethod_2(num9, num10, 0.0);
		double z6 = Class3089.smethod_1(num3, 1.0, 2.0);
		double y6 = Class3089.smethod_2(base.Transform2D.Extents.Cy, 0.0, z6);
		double x7 = Class3089.smethod_2(base.Transform2D.Extents.Cx, 0.0, num7);
		double num11 = Class3089.smethod_5(num7, y3);
		double startAngle = Class3089.smethod_2(10800000.0, 0.0, num11);
		double swingAngle = Class3089.smethod_2(0.0, 0.0, num11);
		Class3089.smethod_2(base.Transform2D.Extents.Cx, 0.0, num6);
		Class3089.smethod_3(num4, num8, 2.0);
		double y7 = Class3089.smethod_1(num2, 1.0, 2.0);
		double num12 = Class3089.smethod_5(num6, y7);
		double swingAngle2 = Class3089.smethod_2(num12, 0.0, 5400000.0);
		double swingAngle3 = Class3089.smethod_2(5400000.0, num12, 0.0);
		double startAngle2 = Class3089.smethod_2(10800000.0, 0.0, num12);
		...
		@class.method_5(num4, base.Transform2D.Extents.Cx, 10800000.0, swingAngle);
		@class.method_4(x7, y4);
		@class.method_4(base.Transform2D.Extents.Cx, y6);
		@class.method_4(x7, y5);
		@class.method_4(x7, num9);
		@class.method_5(num4, base.Transform2D.Extents.Cx, startAngle, num11);
		@class.method_8();
		...
		@class.method_5(num4, base.Transform2D.Extents.Cx, 16200000.0, swingAngle2);
		@class.method_5(num4, base.Transform2D.Extents.Cx, startAngle2, swingAngle3);
		@class.method_8();
		...
		@class.method_4(x7, num9);
		@class.method_5(num4, base.Transform2D.Extents.Cx, startAngle, num11);
		@class.method_4(0.0, num4);
		@class.method_5(num4, base.Transform2D.Extents.Cx, 10800000.0, 5400000.0);
