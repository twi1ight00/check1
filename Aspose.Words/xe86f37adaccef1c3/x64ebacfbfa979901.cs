...
internal class x64ebacfbfa979901 : x77c422f73b569bd1, xa11a4c48b53f49a6
{
	private readonly DataRow xad196882e39a570c;

	string xa11a4c48b53f49a6.x1d7098e1d9b923c4 => xad196882e39a570c.Table.TableName;

	int xa11a4c48b53f49a6.x7114f795b22529ae => x75b182f2ca311c3a();

	internal x64ebacfbfa979901(MailMerge mailMerge, DataRow row)
		: base(mailMerge)
	{
		xad196882e39a570c = row;
	}
