...
internal class Class23 : Class18
{
	...
	private int[] int_0 = new int[3] { 13000, 19400, 14400 };
	...
	internal Class23(Interface42 interface42_1, float float_5, float float_6, Class898 class898_1)
	...
	internal override void vmethod_3()
	{
		...
		if (arrayList_.Count > 0)
		{
			...
			case 1:
				...
				else
				{
					num5 = 13000;
					num6 = 19400;
					num7 = Convert.ToInt32(((Class882)arrayList_[0]).Value);
				}
				break;
			case 2:
				...
				else if (((Class882)arrayList_[0]).method_0() == 327 && ((Class882)arrayList_[1]).method_0() == 329)
				{
					num5 = Convert.ToInt32(((Class882)arrayList_[0]).Value);
					num6 = 19400;
					num7 = Convert.ToInt32(((Class882)arrayList_[1]).Value);
				}
			...
			case 3:
				num5 = Convert.ToInt32(((Class882)arrayList_[0]).Value);
				num6 = Convert.ToInt32(((Class882)arrayList_[1]).Value);
				num7 = Convert.ToInt32(((Class882)arrayList_[2]).Value);
				break;
			}
		...
		Class14 @class = new Class14(Enum6.const_46, num, num2, num3, num4, class898_0.Line.ForeColor, class898_0.Line.Weight, class898_0.Fill.method_2(), class15_);
