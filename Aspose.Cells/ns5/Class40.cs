...
{
	private static readonly Point[] point_0 = new Point[8]
	{
		new Point(0, 0),
		new Point(21600, 0),
	...
	private static readonly ushort[] ushort_0 = new ushort[6] { 4, 24576, 32768, 2, 43520, 32768 };
	...
	private int[] int_0 = new int[6] { -10080, 24300, -3600, 4050, -1800, 4050 };
	...
	internal Class40(Interface42 interface42_1, float float_5, float float_6, Class898 class898_1)
	...
	internal override void vmethod_3()
	{
		...
		if (class898_0.class885_0.arrayList_0.Count > 0)
		{
			...
			int_0 = new int[6] { num5, num6, num7, num8, num9, num10 };
		}
		...
		Class14 class2 = new Class14(Enum6.const_109, num, num2, num3, num4, class898_0.Line.ForeColor, class898_0.Line.Weight, class898_0.Fill.method_2(), class15_);
