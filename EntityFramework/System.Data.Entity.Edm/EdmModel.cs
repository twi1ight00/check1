...
internal class EdmModel : EdmNamedMetadataItem
{
	...
	public virtual IList<EdmEntityContainer> Containers
	{
		get
		{
			return containersList.EnsureValue();
		}
		set
		{
			containersList.SetValue(value);
		}
	}

	internal bool HasContainers => containersList.HasValue;
	...
	public virtual IList<EdmNamespace> Namespaces
	{
		get
		{
			return namespacesList.EnsureValue();
		}
		set
		{
			namespacesList.SetValue(value);
		}
	}

	internal bool HasNamespaces => namespacesList.HasValue;
	...
	{
		return ((IEnumerable<EdmMetadataItem>)namespacesList).Concat((IEnumerable<EdmMetadataItem>)containersList);
	}
}
