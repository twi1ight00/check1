...
internal class Class1920 : Class1351
{
	public delegate Class1920 Delegate1627();

	public delegate void Delegate1629(Class1920 elementData);

	public delegate void Delegate1628(Class1920 elementData);
	...
	public Class1920(XmlReader reader)
		: base(reader)
	{
	}
	...
	public override void vmethod_4(string prefix, XmlWriter writer, string elementName)
	{
		...
		if (bool_21)
		{
			writer.WriteAttributeString("noTextEdit", bool_21 ? "1" : "0");
		}
		if (class1886_0 != null)
		{
