...
internal class Class1926 : Class1351
{
	public delegate Class1926 Delegate1645();

	public delegate void Delegate1646(Class1926 elementData);

	public delegate void Delegate1647(Class1926 elementData);
	...
	private void method_2(XmlReader reader)
	{
		while (reader.MoveToNextAttribute())
		{
			...
			{
				uint_0 = uint.Parse(reader.Value, NumberStyles.HexNumber);
			}
		}
		reader.MoveToElement();
	}

	public Class1926(XmlReader reader)
		: base(reader)
	{
	}
	...
	public override void vmethod_4(string prefix, XmlWriter writer, string elementName)
	{
		...
		writer.WriteAttributeString("val", (uint_0 & 0xFFFFFFu).ToString("X6"));
		if (list_0 != null)
		{
