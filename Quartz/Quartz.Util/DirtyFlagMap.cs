...
[Serializable]
public class DirtyFlagMap<TKey, TValue> : IDictionary<TKey, TValue>, ICollection<KeyValuePair<TKey, TValue>>, IEnumerable<KeyValuePair<TKey, TValue>>, IDictionary, ICollection, IEnumerable, ICloneable, ISerializable
{
	private bool dirty;
	...
	public virtual object Clone()
	{
		try
		{
			DirtyFlagMap<TKey, TValue> copy = (DirtyFlagMap<TKey, TValue>)MemberwiseClone();
	...
	public virtual void CopyTo(Array array, int index)
	{
		...
		{
			if (!object.Equals(keys[i], default(TKey)) || !object.Equals(values[i], default(TValue)))
			{
