...
internal class Class3244 : Class3091
{
	private const string string_0 = "adj1";

	private const string string_1 = "adj2";

	public override Enum493 Kind => Enum493.const_28;

	public Class3244(Class3448 xfrm)
		: base(xfrm)
	{
	}
	...
	public override Class3279 vmethod_1()
	{
		...
		Class3089.smethod_2(base.Transform2D.Extents.Cy, 0.0, num2);
		double num3 = Class3089.smethod_1(num, 29289.0, 100000.0);
		double z = Class3089.smethod_1(num2, 29289.0, 100000.0);
		double x2 = Class3089.smethod_2(num3, 0.0, z);
		double num4 = Class3089.smethod_4(x2, num3, z);
		double right = Class3089.smethod_2(base.Transform2D.Extents.Cx, 0.0, num4);
		double bottom = Class3089.smethod_2(base.Transform2D.Extents.Cy, 0.0, num4);
