...
[Serializable]
public class PT_PARTY_DUES : DTOExt, IDTO
{
	private Guid? _pt_party_dues_id;
	...
	[Primary]
	[Col]
	public virtual Guid? PT_PARTY_DUES_ID
	{
		get
		{
			return _pt_party_dues_id;
		}
		set
		{
			_pt_party_dues_id = value;
		}
	}
	...
	public PT_PARTY_DUES()
	{
		_addsql = "insert into PT_PARTY_DUES (\r\nPT_PARTY_DUES_ID ,\r\nTITLE ,\r\nACTIVE_PERSONNEL ,\r\nACTIVITY_TIME ,\r\nACTIVITY_BACKGROUND ,\r\nACTIVITY_PLACE ,\r\nACTIVITY_BUDGET ,\r\nTOTAL ,\r\nSPEND ,\r\nACTIVE_PERSONNELS ,\r\nISDEL ,\r\nCREATOR ,\r\nCREATETIME ,\r\nMODIFIER ,\r\nMODIFYTIME ,\r\nUSER_ID ,\r\nUSER_NAME ,\r\nORG_ID ,\r\nORG_NAME ,\r\nINSTANCE_ID ) values (\r\n:PT_PARTY_DUES_ID ,\r\n:TITLE ,\r\n:ACTIVE_PERSONNEL ,\r\n:ACTIVITY_TIME ,\r\n:ACTIVITY_BACKGROUND ,\r\n:ACTIVITY_PLACE ,\r\n:ACTIVITY_BUDGET ,\r\n:TOTAL ,\r\n:SPEND ,\r\n:ACTIVE_PERSONNELS ,\r\n:ISDEL ,\r\n:CREATOR ,\r\n:CREATETIME ,\r\n:MODIFIER ,\r\n:MODIFYTIME ,\r\n:USER_ID ,\r\n:USER_NAME ,\r\n:ORG_ID ,\r\n:ORG_NAME ,\r\n:INSTANCE_ID )";
		_findbyinstance = "SELECT * FROM PT_PARTY_DUES WHERE INSTANCE_ID=:INSTANCE_ID";
		_findpage = "SELECT T1.*,T2.TEMPLATE_ID,T2.INSTANCE_NAME FROM PT_PARTY_DUES T1 LEFT JOIN WF_INSTANCE T2 ON T1.INSTANCE_ID=T2.INSTANCE_ID ";
		_updatesql = "update PT_PARTY_DUES set TITLE=:TITLE \r\n,ACTIVE_PERSONNEL=:ACTIVE_PERSONNEL \r\n,ACTIVITY_TIME=:ACTIVITY_TIME \r\n,ACTIVITY_BACKGROUND=:ACTIVITY_BACKGROUND \r\n,ACTIVITY_PLACE=:ACTIVITY_PLACE \r\n,ACTIVITY_BUDGET=:ACTIVITY_BUDGET \r\n,TOTAL=:TOTAL \r\n,SPEND=:SPEND \r\n,ACTIVE_PERSONNELS=:ACTIVE_PERSONNELS \r\n,ISDEL=:ISDEL \r\n,CREATOR=:CREATOR \r\n,CREATETIME=:CREATETIME \r\n,MODIFIER=:MODIFIER \r\n,MODIFYTIME=:MODIFYTIME \r\n,USER_ID=:USER_ID \r\n,USER_NAME=:USER_NAME \r\n,ORG_ID=:ORG_ID \r\n,ORG_NAME=:ORG_NAME \r\n WHERE INSTANCE_ID=:INSTANCE_ID";
	}

	public override string FindList(string parm)
	{
		PT_PARTY_DUES dto = parm.JsonDeserialize<PT_PARTY_DUES>(new JsonConverter[0]);
		return FindList<PT_PARTY_DUES>(dto);
	}
