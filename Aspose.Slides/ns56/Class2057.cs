...
internal class Class2057 : Class2053
{
	public delegate void Delegate2145(Class2057 elementData);
	...
	public override Class2060 CrossBetween => class2060_0;

	public override Class2047 MajorUnit => class2047_0;

	public override Class2047 MinorUnit => class2047_1;

	public override Class2065 DispUnits => class2065_0;
		...
		while (((flag && !reader.EOF) || reader.Read()) && (reader.NodeType != XmlNodeType.EndElement || !(reader.LocalName == localName)))
		{
			...
			if (reader.NodeType == XmlNodeType.Element)
			{
				...
				case "crossesAt":
					...
					break;
				case "crossBetween":
					class2060_0 = new Class2060(reader);
					break;
				case "majorUnit":
				...
				case "minorUnit":
					...
					break;
				case "dispUnits":
					class2065_0 = new Class2065(reader);
					break;
				case "extLst":
	...
	public Class2057(XmlReader reader)
		: base(reader)
	{
	}
	...
	protected override void vmethod_2()
	{
		...
		delegate2773_0 = method_33;
		delegate1892_0 = method_23;
		delegate1894_0 = method_24;
		delegate1859_0 = method_25;
		delegate1861_0 = method_26;
		delegate1859_1 = method_27;
		delegate1861_1 = method_28;
		delegate1908_0 = method_29;
		delegate1910_0 = method_30;
	...
	public override void vmethod_4(string prefix, XmlWriter writer, string elementName)
	{
		...
		if (class2060_0 != null)
		{
			class2060_0.vmethod_4("c", writer, "crossBetween");
		}
		if (class2047_0 != null)
		{
		...
		if (class2065_0 != null)
		{
			class2065_0.vmethod_4("c", writer, "dispUnits");
		}
		if (class1887_0 != null)
		{
	...
	private Class2060 method_23()
	{
		if (class2060_0 != null)
		{
			throw new Exception("Only one <crossBetween> element can be added.");
		}
		class2060_0 = new Class2060();
		return class2060_0;
	}

	private void method_24(Class2060 _crossBetween)
	{
		class2060_0 = _crossBetween;
	}

	private Class2047 method_25()
	{
		if (class2047_0 != null)
		{
	...
	private void method_26(Class2047 _majorUnit)
	{
		class2047_0 = _majorUnit;
	}

	private Class2047 method_27()
	{
		if (class2047_1 != null)
		{
	...
	private void method_28(Class2047 _minorUnit)
	{
		class2047_1 = _minorUnit;
	}

	private Class2065 method_29()
	{
		if (class2065_0 != null)
		{
			throw new Exception("Only one <dispUnits> element can be added.");
		}
		class2065_0 = new Class2065();
		return class2065_0;
	}

	private void method_30(Class2065 _dispUnits)
	{
		class2065_0 = _dispUnits;
	}
	...
	private Class2605 method_33(string elementName)
	{
		if (class2605_0 != null)
		{
