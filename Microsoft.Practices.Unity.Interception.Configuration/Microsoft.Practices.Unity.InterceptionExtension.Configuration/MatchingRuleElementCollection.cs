...
{
	private static readonly UnknownElementHandlerMap<MatchingRuleElementCollection> unknownElementHandlerMap = new UnknownElementHandlerMap<MatchingRuleElementCollection> { 
	{
		"matchingRule",
		delegate(MatchingRuleElementCollection mrec, XmlReader xr)
		{
			mrec.ReadUnwrappedElement(xr, mrec);
		}
	} };
	...
	public new MatchingRuleElement this[string name] => (MatchingRuleElement)BaseGet(name);
