...
internal class Class1862 : Class1351
{
	public delegate Class1862 Delegate1465();

	public delegate void Delegate1467(Class1862 elementData);

	public delegate void Delegate1466(Class1862 elementData);
	...
	public Class1903.Delegate1576 delegate1576_1;

	public Class1903.Delegate1578 delegate1578_1;

	public Class1906.Delegate1585 delegate1585_1;

	public Class1906.Delegate1587 delegate1587_1;
	...
	private Class1903 class1903_1;

	private Class1906 class1906_1;
	...
	public Class1903 ChOff => class1903_1;

	public Class1906 ChExt => class1906_1;
	...
	protected override void vmethod_0(XmlReader reader)
	{
		...
		while (((flag && !reader.EOF) || reader.Read()) && (reader.NodeType != XmlNodeType.EndElement || !(reader.LocalName == localName)))
		{
			...
			if (reader.NodeType == XmlNodeType.Element)
			{
				...
				{
				case "chExt":
					class1906_1 = new Class1906(reader);
					break;
				case "chOff":
					class1903_1 = new Class1903(reader);
					break;
				case "ext":
	...
	public Class1862(XmlReader reader)
		: base(reader)
	{
	}
	...
	protected override void vmethod_2()
	{
		...
		delegate1576_1 = method_7;
		delegate1578_1 = method_8;
		delegate1585_1 = method_9;
		delegate1587_1 = method_10;
	}
	...
	public override void vmethod_4(string prefix, XmlWriter writer, string elementName)
	{
		...
		if (class1903_1 != null)
		{
			class1903_1.vmethod_4("a", writer, "chOff");
		}
		if (class1906_1 != null)
		{
			class1906_1.vmethod_4("a", writer, "chExt");
		}
	...
	private Class1903 method_7()
	{
		if (class1903_1 != null)
		{
			throw new Exception("Only one <chOff> element can be added.");
		}
		class1903_1 = new Class1903();
		return class1903_1;
	}

	private void method_8(Class1903 _chOff)
	{
		class1903_1 = _chOff;
	}

	private Class1906 method_9()
	{
		if (class1906_1 != null)
		{
			throw new Exception("Only one <chExt> element can be added.");
		}
		class1906_1 = new Class1906();
		return class1906_1;
	}

	private void method_10(Class1906 _chExt)
	{
		class1906_1 = _chExt;
	}
}
