...
internal class Class7328 : Interface388, Interface391
{
	...
	public Class7328(string input)
	{
		char_0 = input.ToCharArray();
		int_0 = input.Length;
	}

	public Class7328(char[] data, int numberOfActualCharsInArray)
	{
		char_0 = data;
	...
	{
		Class7333 @class = (Class7333)ilist_0[m];
		Seek(@class.int_0);
		int_2 = @class.int_1;
		int_3 = @class.int_2;
		imethod_6(m);
