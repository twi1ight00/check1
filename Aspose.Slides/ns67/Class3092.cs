...
internal class Class3092 : Class3091
{
	private const string string_0 = "adj1";

	private const string string_1 = "adj2";

	public override Enum493 Kind => Enum493.const_45;

	public Class3092(Class3448 xfrm)
		: base(xfrm)
	{
	}
	...
	public override Class3279 vmethod_1()
	{
		...
		double num = Class3089.smethod_2(0.0, y3, 0.0);
		double num2 = Class3089.smethod_1(base.Transform2D.Extents.Cx, y, 200000.0);
		...
		double z2 = Class3089.smethod_1(num3, y3, base.Transform2D.Extents.Cx / 2.0);
		double top = Class3089.smethod_2(num, 0.0, z2);
		...
		@class.method_8();
		@class.TextRectangle = new Class3457(num3, top, num4, base.Transform2D.Extents.Cy);
		return @class;
	}
