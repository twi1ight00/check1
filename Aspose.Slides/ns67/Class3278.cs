...
internal class Class3278 : Class3091
{
	...
	public override Enum493 Kind => Enum493.const_117;

	public Class3278(Class3448 xfrm)
		: base(xfrm)
	{
	}
	...
	public override Class3279 vmethod_1()
	{
		...
		double num7 = Class3089.smethod_1(Math.Min(base.Transform2D.Extents.Cy, base.Transform2D.Extents.Cx), base.AdjustValues["adj3"], 100000.0);
		double x8 = Class3089.smethod_2(base.Transform2D.Extents.Cx, 0.0, num7);
		double y14 = Class3089.smethod_2(base.Transform2D.Extents.Cy, 0.0, num7);
		double num8 = Class3089.smethod_1(num7, 29289.0, 100000.0);
		double right = Class3089.smethod_2(base.Transform2D.Extents.Cx, 0.0, num8);
		double bottom = Class3089.smethod_2(base.Transform2D.Extents.Cy, 0.0, num8);
		Class3279 @class = new Class3279(base.Transform2D);
		@class.method_2(base.Transform2D.Extents.Cx, base.Transform2D.Extents.Cy, Enum492.const_0, extrusionOk: false, stroke: true);
		@class.method_3(0.0, num7);
		@class.method_5(num7, num7, 10800000.0, 5400000.0);
		@class.method_4(num5, 0.0);
		@class.method_4(x5, y10);
		@class.method_4(x3, 0.0);
		@class.method_4(x8, 0.0);
		@class.method_5(num7, num7, 16200000.0, 5400000.0);
		@class.method_4(base.Transform2D.Extents.Cx, num6);
		@class.method_4(x6, y11);
		@class.method_4(base.Transform2D.Extents.Cx, y5);
		@class.method_4(base.Transform2D.Extents.Cx, y14);
		@class.method_5(num7, num7, 0.0, 5400000.0);
		@class.method_4(x3, base.Transform2D.Extents.Cy);
		@class.method_4(x7, y13);
		@class.method_4(num5, base.Transform2D.Extents.Cy);
		@class.method_5(num7, num7, 5400000.0, 5400000.0);
		@class.method_4(0.0, y5);
		@class.method_4(x4, y8);
		@class.method_4(0.0, num6);
		@class.method_8();
		@class.TextRectangle = new Class3457(num8, num8, right, bottom);
		return @class;
	}
