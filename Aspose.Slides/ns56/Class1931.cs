...
internal class Class1931 : Class1351
{
	public delegate Class1931 Delegate1660();

	public delegate void Delegate1661(Class1931 elementData);

	public delegate void Delegate1662(Class1931 elementData);

	public const uint uint_0 = uint.MaxValue;

	public Class2605.Delegate2773 delegate2773_0;

	private SystemColor systemColor_0;

	private uint uint_1;

	private List<Class2605> list_0;

	public SystemColor Val
	{
		get
		{
			return systemColor_0;
		}
		set
		{
			systemColor_0 = value;
		...
		while (reader.MoveToNextAttribute())
		{
			if (!(reader.Prefix == "xmlns"))
			{
				...
				case "lastClr":
					...
					break;
				case "val":
					systemColor_0 = Class2563.smethod_0(reader.Value);
					break;
				}
			}
		}
	...
	public Class1931(XmlReader reader)
		: base(reader)
	{
	}
	...
	{
		systemColor_0 = SystemColor.ScrollBar;
	...
	public override void vmethod_4(string prefix, XmlWriter writer, string elementName)
	{
		...
		writer.WriteAttributeString("val", Class2563.smethod_1(systemColor_0));
		if (uint_1 != uint.MaxValue)
		{
			writer.WriteAttributeString("lastClr", (uint_1 & 0xFFFFFFu).ToString("X6"));
		}
		if (list_0 != null)
		{
