...
internal class Class235 : Class160
{
	internal Class235(Interface42 interface42_1, float float_5, float float_6, Class913 class913_1)
	...
	internal override GraphicsPath vmethod_0(RectangleF rectangleF_0)
	{
		...
		graphicsPath.AddLine(x + num + num11, y + num2 + num13, x + num5 + num11, y + num6 + num13);
		graphicsPath.StartFigure();
		graphicsPath.AddLine(x + num5 + num11, y + num6 + num13, x + num3 + num11, y + num4 + num13);
		graphicsPath.StartFigure();
		graphicsPath.AddLine(x + num3 + num11, y + x + num13, x + num3 + num11, y + height + num13);
		return graphicsPath;
	}
