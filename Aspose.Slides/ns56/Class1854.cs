...
internal class Class1854 : Class1351
{
	public delegate Class1854 Delegate1441();

	public delegate void Delegate1442(Class1854 elementData);

	public delegate void Delegate1443(Class1854 elementData);
	...
	private void method_2(XmlReader reader)
	{
		...
		{
			string text;
			if (!(reader.Prefix == "xmlns") && (text = method_0(reader)) != null && text == "pos")
			{
	...
	public Class1854(XmlReader reader)
		: base(reader)
	{
	}
	...
	public override void vmethod_4(string prefix, XmlWriter writer, string elementName)
	{
		...
		writer.WriteAttributeString("pos", XmlConvert.ToString((int)Math.Round(float_0 * 1000f)));
		if (class2605_0 != null)
		{
