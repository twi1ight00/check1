...
internal class Class290 : Class160
{
	internal Class290(Interface42 interface42_1, float float_5, float float_6, Class913 class913_1)
	...
	internal override GraphicsPath vmethod_0(RectangleF rectangleF_0)
	{
		...
		if (class913_0.class901_0 != null)
		{
			...
			if (num != 0f && num2 == 0f)
			{
				...
				case 1:
				{
					...
					reference20 = new PointF(rectangleF_0.Right - num, rectangleF_0.Y);
					ref PointF reference21 = ref array[2];
					reference21 = new PointF(rectangleF_0.Right, num + rectangleF_0.Y);
				...
				case 2:
				{
					...
					reference15 = new PointF(rectangleF_0.Right, rectangleF_0.Bottom - num);
					ref PointF reference16 = ref array[3];
					reference16 = new PointF(rectangleF_0.Right - num, rectangleF_0.Bottom);
				...
				case 3:
				{
					...
					reference11 = new PointF(num + rectangleF_0.X, rectangleF_0.Bottom);
					ref PointF reference12 = ref array[5];
					reference12 = new PointF(rectangleF_0.X, rectangleF_0.Bottom - num);
					break;
				}
				case 4:
				{
					...
					reference6 = new PointF(rectangleF_0.X, num + rectangleF_0.Y);
					break;
				}
				}
			...
			else if (num == 0f && num2 != 0f)
			{
				...
				case 1:
				{
					...
					reference44 = new PointF(rectangleF_0.Right, rectangleF_0.Y);
					ref PointF reference45 = ref array[2];
					reference45 = new PointF(rectangleF_0.Right, rectangleF_0.Bottom - num2);
					ref PointF reference46 = ref array[3];
					reference46 = new PointF(rectangleF_0.Right - num2, rectangleF_0.Bottom);
				...
				case 2:
				{
					...
					reference38 = new PointF(rectangleF_0.Right - num2, rectangleF_0.Y);
					ref PointF reference39 = ref array[2];
					reference39 = new PointF(rectangleF_0.Right, num2 + rectangleF_0.Y);
					ref PointF reference40 = ref array[3];
					reference40 = new PointF(rectangleF_0.Right, rectangleF_0.Bottom);
				...
				case 3:
				{
					...
					reference31 = new PointF(num2 + rectangleF_0.X, rectangleF_0.Y);
					...
					reference35 = new PointF(rectangleF_0.X, rectangleF_0.Bottom);
					ref PointF reference36 = ref array[5];
					reference36 = new PointF(rectangleF_0.X, num2 + rectangleF_0.Y);
					break;
				}
				case 4:
				{
					...
					reference29 = new PointF(num2 + rectangleF_0.X, rectangleF_0.Bottom);
					ref PointF reference30 = ref array[5];
					reference30 = new PointF(rectangleF_0.X, rectangleF_0.Bottom - num2);
					break;
				}
				}
				graphicsPath.AddLine(array[0], array[1]);
			...
			else if (num != 0f && num2 != 0f)
			{
				...
				case 1:
				{
					...
					reference74 = new PointF(rectangleF_0.Right - num, rectangleF_0.Y);
					ref PointF reference75 = ref array2[2];
					reference75 = new PointF(rectangleF_0.Right, num + rectangleF_0.Y);
					ref PointF reference76 = ref array2[3];
					reference76 = new PointF(rectangleF_0.Right, rectangleF_0.Bottom - num2);
					ref PointF reference77 = ref array2[4];
					reference77 = new PointF(rectangleF_0.Right - num2, rectangleF_0.Bottom);
				...
				case 2:
				{
					...
					reference66 = new PointF(rectangleF_0.Right - num2, rectangleF_0.Y);
					ref PointF reference67 = ref array2[2];
					reference67 = new PointF(rectangleF_0.Right, num2 + rectangleF_0.Y);
					ref PointF reference68 = ref array2[3];
					reference68 = new PointF(rectangleF_0.Right, rectangleF_0.Bottom - num);
					ref PointF reference69 = ref array2[4];
					reference69 = new PointF(rectangleF_0.Right - num, rectangleF_0.Bottom);
				...
				case 3:
				{
					...
					reference62 = new PointF(num + rectangleF_0.X, rectangleF_0.Bottom);
					ref PointF reference63 = ref array2[6];
					reference63 = new PointF(rectangleF_0.X, rectangleF_0.Bottom - num);
					ref PointF reference64 = ref array2[7];
					reference64 = new PointF(rectangleF_0.X, num2 + rectangleF_0.Y);
					break;
				}
				case 4:
				{
					ref PointF reference49 = ref array2[0];
					reference49 = new PointF(num + rectangleF_0.X, rectangleF_0.Y);
					...
					reference54 = new PointF(num2 + rectangleF_0.X, rectangleF_0.Bottom);
					ref PointF reference55 = ref array2[6];
					reference55 = new PointF(rectangleF_0.X, rectangleF_0.Bottom - num2);
					ref PointF reference56 = ref array2[7];
					reference56 = new PointF(rectangleF_0.X, num + rectangleF_0.Y);
					break;
				}
				}
		...
		else
		{
			...
			case 1:
			{
				...
				reference99 = new PointF(num + rectangleF_0.X, rectangleF_0.Y);
				ref PointF reference100 = ref array[1];
				reference100 = new PointF(rectangleF_0.Right - num, rectangleF_0.Y);
				ref PointF reference101 = ref array[2];
				reference101 = new PointF(rectangleF_0.Right, num + rectangleF_0.Y);
				...
				reference103 = new PointF(rectangleF_0.X, rectangleF_0.Bottom);
				ref PointF reference104 = ref array[5];
				reference104 = new PointF(rectangleF_0.X, num + rectangleF_0.Y);
				break;
			}
			case 2:
			{
				ref PointF reference93 = ref array[0];
				reference93 = new PointF(rectangleF_0.X, rectangleF_0.Y);
				...
				reference95 = new PointF(rectangleF_0.Right, rectangleF_0.Bottom - num);
				ref PointF reference96 = ref array[3];
				reference96 = new PointF(rectangleF_0.Right - num, rectangleF_0.Bottom);
				ref PointF reference97 = ref array[4];
				reference97 = new PointF(num + rectangleF_0.X, rectangleF_0.Bottom);
				ref PointF reference98 = ref array[5];
				reference98 = new PointF(rectangleF_0.X, rectangleF_0.Bottom - num);
				break;
			}
			case 3:
			{
				...
				reference88 = new PointF(rectangleF_0.Right, rectangleF_0.Y);
				ref PointF reference89 = ref array[2];
				reference89 = new PointF(rectangleF_0.Right, rectangleF_0.Bottom - num);
				ref PointF reference90 = ref array[3];
				reference90 = new PointF(rectangleF_0.Right - num, rectangleF_0.Height);
				ref PointF reference91 = ref array[4];
				reference91 = new PointF(num + rectangleF_0.X, rectangleF_0.Bottom);
				ref PointF reference92 = ref array[5];
				reference92 = new PointF(rectangleF_0.X, rectangleF_0.Bottom - num);
				break;
			}
			case 4:
			{
				ref PointF reference81 = ref array[0];
				reference81 = new PointF(num + rectangleF_0.X, rectangleF_0.Y);
				ref PointF reference82 = ref array[1];
				reference82 = new PointF(rectangleF_0.Right - num, rectangleF_0.Y);
				ref PointF reference83 = ref array[2];
				reference83 = new PointF(rectangleF_0.Right, num + rectangleF_0.Y);
				ref PointF reference84 = ref array[3];
				reference84 = new PointF(rectangleF_0.Right, rectangleF_0.Bottom);
				...
				reference86 = new PointF(rectangleF_0.X, num + rectangleF_0.Y);
				break;
			}
			}
			graphicsPath.AddLine(array[0], array[1]);
