...
[Serializable]
public class AC_LM_DINING_APPLY : DTOExt, IDTO
{
	...
	public AC_LM_DINING_APPLY()
	{
		WhereAdvance = " (@APPLICANT_ID IS NULL OR APPLICANT_ID=@APPLICANT_ID) AND (@APPLY_ORG_ID IS NULL OR APPLY_ORG_ID=@APPLY_ORG_ID) AND (@APPLY_TIME_FROM IS NULL OR T1.CREATETIME >= TO_DATE(@APPLY_TIME_FROM,'YYYY-MM-DD'))  AND (@APPLY_TIME_TO IS NULL OR T1.CREATETIME <= TO_DATE(@APPLY_TIME_TO,'YYYY-MM-DD'))";
		WhereSimple = " ((@APPLICANT_NAME IS NULL OR T1.APPLICANT_NAME LIKE ('%'||(@APPLICANT_NAME)||'%')) OR (@APPLY_ORG_NAME IS NULL OR T1.APPLY_ORG_NAME LIKE ('%'||(@APPLY_ORG_NAME)||'%')))";
		_addsql = "insert into AC_LM_DINING_APPLY (\r\nDINING_APPLY_ID ,\r\nTITLE ,\r\nAPPLY_DESC ,\r\nAPPLICANT_ID ,\r\nAPPLICANT_NAME ,\r\nAPPLY_ORG_ID ,\r\nAPPLY_ORG_NAME ,\r\nAPPLY_TIME ,\r\nREMARK ,\r\nRECEIVER ,\r\nRECEIVER_NAME ,\r\nRECEIVER_ORGID ,\r\nRECEIVER_ORGNAME ,\r\nBREAKFAST_NUM ,\r\nLUNCH_NUM ,\r\nSUPPER_NUM ,\r\nISDEL ,\r\nCREATOR ,\r\nCREATETIME ,\r\nMODIFIER ,\r\nMODIFYTIME ,\r\nUSER_ID ,\r\nUSER_NAME ,\r\nORG_ID ,\r\nORG_NAME ,\r\nINSTANCE_ID ) values (\r\n:DINING_APPLY_ID ,\r\n:TITLE ,\r\n:APPLY_DESC ,\r\n:APPLICANT_ID ,\r\n:APPLICANT_NAME ,\r\n:APPLY_ORG_ID ,\r\n:APPLY_ORG_NAME ,\r\n:APPLY_TIME ,\r\n:REMARK ,\r\n:RECEIVER ,\r\n:RECEIVER_NAME ,\r\n:RECEIVER_ORGID ,\r\n:RECEIVER_ORGNAME ,\r\n:BREAKFAST_NUM ,\r\n:LUNCH_NUM ,\r\n:SUPPER_NUM ,\r\n:ISDEL ,\r\n:CREATOR ,\r\n:CREATETIME ,\r\n:MODIFIER ,\r\n:MODIFYTIME ,\r\n:USER_ID ,\r\n:USER_NAME ,\r\n:ORG_ID ,\r\n:ORG_NAME ,\r\n:INSTANCE_ID )";
		_findbyinstance = "SELECT * FROM AC_LM_DINING_APPLY WHERE INSTANCE_ID=:INSTANCE_ID";
		_findpage = "SELECT T1.*,T2.TEMPLATE_ID,T2.INSTANCE_NAME FROM AC_LM_DINING_APPLY T1 LEFT JOIN WF_INSTANCE T2 ON T1.INSTANCE_ID=T2.INSTANCE_ID ";
		_updatesql = "update AC_LM_DINING_APPLY set DINING_APPLY_ID=:DINING_APPLY_ID \r\n,TITLE=:TITLE \r\n,APPLY_DESC=:APPLY_DESC \r\n,APPLICANT_ID=:APPLICANT_ID \r\n,APPLICANT_NAME=:APPLICANT_NAME \r\n,APPLY_ORG_ID=:APPLY_ORG_ID \r\n,APPLY_ORG_NAME=:APPLY_ORG_NAME \r\n,APPLY_TIME=:APPLY_TIME \r\n,REMARK=:REMARK \r\n,RECEIVER=:RECEIVER \r\n,RECEIVER_NAME=:RECEIVER_NAME \r\n,RECEIVER_ORGID=:RECEIVER_ORGID \r\n,RECEIVER_ORGNAME=:RECEIVER_ORGNAME \r\n,BREAKFAST_NUM=:BREAKFAST_NUM \r\n,LUNCH_NUM=:LUNCH_NUM \r\n,SUPPER_NUM=:SUPPER_NUM \r\n,ISDEL=:ISDEL \r\n,CREATOR=:CREATOR \r\n,CREATETIME=:CREATETIME \r\n,MODIFIER=:MODIFIER \r\n,MODIFYTIME=:MODIFYTIME \r\n,USER_ID=:USER_ID \r\n,USER_NAME=:USER_NAME \r\n,ORG_ID=:ORG_ID \r\n,ORG_NAME=:ORG_NAME \r\n WHERE INSTANCE_ID=:INSTANCE_ID";
	}

	public override string FindList(string parm)
	{
		AC_LM_DINING_APPLY dto = parm.JsonDeserialize<AC_LM_DINING_APPLY>(new JsonConverter[0]);
		return FindList<AC_LM_DINING_APPLY>(dto);
	}
