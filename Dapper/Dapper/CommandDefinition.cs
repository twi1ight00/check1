...
public struct CommandDefinition
{
	...
	private static Action<IDbCommand> GetInit(Type commandType)
	{
		...
		if (SqlMapper.Link<Type, Action<IDbCommand>>.TryGet(commandInitCache, commandType, out var value))
		{
			return value;
		}
		...
		{
			DynamicMethod dynamicMethod = new DynamicMethod(commandType.Name + "_init", null, new Type[1] { typeof(IDbCommand) });
