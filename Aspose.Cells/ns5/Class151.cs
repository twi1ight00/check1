...
internal class Class151 : Class18
{
	internal Class151(Interface42 interface42_1, float float_5, float float_6, Class898 class898_1)
	...
	private GraphicsPath method_3(float float_5, float float_6, float float_7, float float_8, int int_0)
	{
		...
		float num = 0f;
		num = ((class898_0.class885_0.arrayList_0.Count <= 0) ? (2761f * ((class898_0.Width > class898_0.Height) ? class898_0.Height : class898_0.Width) / 21600f) : (Convert.ToSingle(((Class882)class898_0.class885_0.arrayList_0[0]).Value) * ((class898_0.Width > class898_0.Height) ? class898_0.Height : class898_0.Width) / 21600f));
		float num2 = num;
