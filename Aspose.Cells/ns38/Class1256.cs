...
internal class Class1256
{
	...
	internal void method_0()
	{
		...
		for (int i = 0; i < worksheetCollection_0.method_39().Count; i++)
		{
			...
			else if (@class.Type == Enum194.const_0 && (@class.method_25() == null || @class.method_25().Trim() == ""))
			{
				num++;
			}
			else
	...
	internal Class1256(WorksheetCollection worksheetCollection_1)
	{
	...
	private void method_2(StringBuilder stringBuilder_1, byte[] byte_0, int int_3)
	{
		...
		string text;
		if ((text = name.Text) != null && text == "_xlfn.IFERROR_1")
		{
			stringBuilder_0.Append("IFERROR");
		}
		else
		{
	...
	internal string method_3(Cell cell_1)
	{
		...
		if (array[2] == 1 && array[0] == 5)
		{
			ushort row = BitConverter.ToUInt16(array, num + 1);
			byte column = array[num + 3];
		...
		if (array[num] == 2 && array[0] == 5)
		{
			ushort num2 = BitConverter.ToUInt16(array, num + 1);
			byte b = array[num + 3];
			Cell cell2 = cell_1.method_4().GetCell(num2, b, bool_2: false);
		...
		return method_4(-1, array, cell_1.Row, cell_1.Column, bool_0: false);
	}

	internal string method_4(int int_3, byte[] byte_0, int int_4, int int_5, bool bool_0)
	{
		return method_5(int_3, -1, byte_0, int_4, int_5, bool_0);
	}
	...
	internal string method_5(int int_3, int int_4, byte[] byte_0, int int_5, int int_6, bool bool_0)
	{
		...
		while (int_3 < byte_0.Length && (int_2 == 0 || int_3 < num))
		{
			switch (byte_0[int_3])
			{
			case 3:
			...
			case 23:
				try
				{
					...
					{
						@string = Encoding.Unicode.GetString(byte_0, int_3 + 2, 2 * b);
						int_3 += 2 * b + 2;
					}
					arrayList.Add(stringBuilder_0.Length);
					stringBuilder_0.Append("\"");
			...
			case 24:
			{
				string value = method_7(byte_0, ref int_3, int_5, int_6);
				arrayList.Add(stringBuilder_0.Length);
			...
			case 25:
				int_3++;
				int_3 = method_9(byte_0, int_3, arrayList);
				break;
			case 28:
				arrayList.Add(stringBuilder_0.Length);
				int_3++;
			...
			case 30:
			{
				ushort num3 = BitConverter.ToUInt16(byte_0, int_3 + 1);
				arrayList.Add(stringBuilder_0.Length);
				stringBuilder_0.Append(num3.ToString(CultureInfo.InvariantCulture));
				int_3 += 3;
				break;
			}
			case 31:
			{
				double num4 = BitConverter.ToDouble(byte_0, int_3 + 1);
				arrayList.Add(stringBuilder_0.Length);
				if (!(num4 >= 1E+21) && Math.Abs(num4) > 1E-21)
				{
					stringBuilder_0.Append(Class1025.smethod_3(num4));
				}
				else
				{
					stringBuilder_0.Append(num4.ToString());
				}
				int_3 += 9;
				break;
			}
			...
			case 101:
				arrayList.Add(stringBuilder_0.Length);
				int_3++;
				stringBuilder_0.Append(GetCellArea(byte_0, int_3, int_5, int_6, bool_0));
				int_3 += 8;
				break;
			case 38:
			case 70:
			...
			case 109:
				arrayList.Add(stringBuilder_0.Length);
				int_3++;
				stringBuilder_0.Append(GetCellArea(byte_0, int_3, int_5, int_6, bool_0: true));
				int_3 += 8;
				break;
			case 57:
			case 89:
			case 121:
			{
				...
				if (@class == null)
				{
					...
					{
						string text2 = worksheetCollection_0[name.SheetIndex - 1].Name;
						if (text2.IndexOf(" ") != -1 || text2.IndexOf("-") != -1 || text2.IndexOf("&") != -1 || Class1677.smethod_19(text2) || Class1259.smethod_1(text2))
						{
							text2 = "'" + text2 + "'";
						}
						stringBuilder_0.Append(text2 + "!" + name.Text);
					}
				}
				...
				else if (@class.Type == Enum194.const_0)
				{
					...
					if (@class.method_4() != null)
					{
						...
						{
							text3 = @class.method_4()[num7];
						}
					}
					if (int_0 == 1)
					{
						bool flag;
						if (flag = text3 != null && Class1677.smethod_21(text3))
						{
							stringBuilder_0.Append('\'');
						}
						stringBuilder_0.Append('[');
				...
				else
				{
					...
					stringBuilder_0.Append('\'');
					stringBuilder_0.Append(class4.Name.ToUpper());
					stringBuilder_0.Append('\'');
				}
				int_3 += 4;
				break;
			...
			case 122:
			{
				...
				int_3++;
				int num2 = BitConverter.ToUInt16(byte_0, int_3);
				string text = Class932.smethod_0(num2, worksheetCollection_0, int_0, hashtable_0);
	...
	internal void method_6(StringBuilder stringBuilder_1, Class1661 class1661_0, int int_3, int int_4, bool bool_0)
	{
		int int_5 = 0;
		...
		case 16:
		case 17:
			method_6(stringBuilder_1, (Class1661)class1661_0.method_7()[0], int_3, int_4, bool_0);
			stringBuilder_1.Append(class1661_0.method_3());
			method_6(stringBuilder_1, (Class1661)class1661_0.method_7()[1], int_3, int_4, bool_0);
			break;
		case 18:
		case 19:
			stringBuilder_1.Append(class1661_0.method_3());
		...
		case 23:
			try
			{
				...
				if (array[int_5 + 1] == 0)
				{
					byte[] array3 = new byte[2 * b];
					for (int m = 0; m < 2 * b; m++)
					{
						if (m % 2 == 0)
						{
							byte b2 = array[m / 2 + int_5 + 2];
							if (b2 != 0)
							{
								array3[m] = b2;
							}
					...
					text5 = Encoding.Unicode.GetString(array3, 0, array3.Length);
					int_5 += b + 2;
				}
				else
				{
					text5 = Encoding.Unicode.GetString(array, int_5 + 2, 2 * b);
					int_5 += 2 * b + 2;
				}
				stringBuilder_1.Append("\"");
				if (text5 != null && text5 != "")
		...
		case 24:
		{
			string value = method_7(array, ref int_5, int_3, int_4);
		...
		case 25:
			if (class1661_0.method_3() != null && class1661_0.method_7().Count > 0)
			{
				...
				{
					method_6(stringBuilder_1, (Class1661)class1661_0.method_7()[l], int_3, int_4, bool_0);
				}
				stringBuilder_1.Append(")");
			}
			break;
		...
		case 98:
		{
			...
			{
				method_6(stringBuilder_1, (Class1661)class1661_0.method_7()[i], int_3, int_4, bool_0);
			}
			stringBuilder_1.Append(")");
			break;
		}
		...
		case 69:
		case 101:
			stringBuilder_1.Append(GetCellArea(array, 1, int_3, int_4, bool_0));
			break;
		case 42:
		case 74:
		case 106:
		...
		case 77:
		case 109:
			stringBuilder_1.Append(GetCellArea(array, 1, int_3, int_4, bool_0: true));
			break;
		case 22:
		case 26:
		case 27:
		...
		case 121:
		{
			...
			if (@class == null)
			{
				...
				else
				{
					...
					if (text3.IndexOf(" ") != -1 || text3.IndexOf("-") != -1 || text3.IndexOf("&") != -1 || Class1677.smethod_19(text3) || Class1259.smethod_1(text3))
					{
						text3 = "'" + text3 + "'";
					}
		...
		case 122:
		{
			int_5++;
			int num = BitConverter.ToUInt16(array, int_5);
			string text2 = Class932.smethod_0(num, worksheetCollection_0, int_0, hashtable_0);
		...
		case 123:
		{
			int_5++;
			int num = BitConverter.ToUInt16(array, int_5);
			string text = Class932.smethod_0(num, worksheetCollection_0, int_0, hashtable_0);
			stringBuilder_1.Append(text);
			stringBuilder_1.Append('!');
			if (text[0] != '#')
			{
				int_5 += 2;
				stringBuilder_1.Append(GetCellArea(array, int_5, int_3, int_4, bool_0));
				int_5 += 8;
			}
			else
			{
	...
	private string method_7(byte[] byte_0, ref int int_3, int int_4, int int_5)
	{
		...
		case 7:
		{
			...
			Cell cell = cell_0.Worksheet.Cells.CheckCell(BitConverter.ToUInt16(byte_0, int_3 - 4), byte_0[int_3 - 2] & 0xFF);
			if (cell == null)
			{
				return "#REF!";
			}
	...
	private void method_8(byte[] byte_0, ArrayList arrayList_0)
	{
		arrayList_0.Add(stringBuilder_0.Length);
		stringBuilder_0.Append('{');
		int num = byte_0[int_2] + 1;
		int_2++;
		int num2 = BitConverter.ToUInt16(byte_0, int_2) + 1;
		int_2 += 2;
			...
			for (int j = 0; j < num; j++)
			{
				...
				case 2:
				{
					...
					if (num3 != 0)
					{
						...
						if (byte_0[int_2 + 2] == 0)
						{
							text = Encoding.ASCII.GetString(byte_0, int_2 + 3, num3);
							int_2 += 3 + num3;
						}
						else
						{
							text = Encoding.Unicode.GetString(byte_0, int_2 + 3, num3 * 2);
							int_2 += 3 + num3 * 2;
						}
						if (text != null && text != "")
						{
	...
	private int method_9(byte[] byte_0, int int_3, ArrayList arrayList_0)
	{
		switch (byte_0[int_3])
		{
		case 16:
	...
	private string GetCellArea(byte[] byte_0, int int_3, int int_4, int int_5, bool bool_0)
	{
		ushort num = BitConverter.ToUInt16(byte_0, int_3);
		byte b = byte_0[int_3 + 4];
		int num2 = ((num + int_4 <= 65535) ? (num + int_4) : (num + int_4 - 65535 - 1));
		int num3 = ((b + int_5 <= 255) ? (b + int_5) : (b + int_5 - 255 - 1));
		StringBuilder stringBuilder = new StringBuilder();
		bool flag = true;
		bool flag2 = true;
		if ((byte_0[int_3 + 5] & 0x80u) != 0)
		{
			flag = false;
			if (bool_0)
			{
		...
		ushort num4 = BitConverter.ToUInt16(byte_0, int_3 + 2);
		byte b2 = byte_0[int_3 + 6];
		num2 = ((num4 + int_4 <= 65535) ? (num4 + int_4) : (num4 + int_4 - 65535 - 1));
		num3 = ((b2 + int_5 <= 255) ? (b2 + int_5) : (b2 + int_5 - 255 - 1));
		bool flag3 = true;
		bool flag4 = true;
		if ((byte_0[int_3 + 7] & 0x80u) != 0)
		{
			flag3 = false;
			if (bool_0)
			{
		...
		if (num == 0 && num4 == ushort.MaxValue)
		{
			if (flag2)
			{
				stringBuilder.Append("$");
			}
			stringBuilder.Append(CellsHelper.ColumnIndexToName(b));
			stringBuilder.Append(':');
			if (flag4)
			{
				stringBuilder.Append("$");
			}
			stringBuilder.Append(CellsHelper.ColumnIndexToName(b2));
			return stringBuilder.ToString();
		}
	...
	{
		ushort num = BitConverter.ToUInt16(byte_0, int_3);
		byte b = byte_0[int_3 + 2];
		int row = ((num + int_4 <= 65535) ? (num + int_4) : (num + int_4 - 65535 - 1));
		int column = ((b + int_5 <= 255) ? (b + int_5) : (b + int_5 - 255 - 1));
		byte b2 = byte_0[int_3 + 3];
		StringBuilder stringBuilder = new StringBuilder();
		if ((b2 & 0x40) == 0)
		{
			stringBuilder.Append('$');
		...
		{
			stringBuilder.Append('$');
			stringBuilder.Append(CellsHelper.RowIndexToName(num));
		}
		else
		{
	...
	private string GetCell(byte[] byte_0, int int_3)
	{
		...
		return Class1677.CellIndexToName(num, b, bool_, bool_2);
	}
