...
public class HR_EMPLOYEEDTO : DTOBase
{
	...
	public string ENG_LEVEL_DESC { get; set; }

	public string BKNAME { get; set; }

	public Guid? AFFILIATED_UNIT { get; set; }

	public string AFFILIATED_UNIT_DESC { get; set; }
	...
	public string IN_CATEGORY_DESC { get; set; }
	...
	public string POLITICS_STATUS_DESC { get; set; }
	...
	public string TECHNICAL_POSITION_NAME { get; set; }
	...
	public string LY_VACATION_DAYS { get; set; }

	public decimal? FINAL_VACATION_DAYS { get; set; }
}
