...
internal class DatePatternConverter : PatternConverter, IOptionHandler
{
	...
	public void ActivateOptions()
	{
		...
		if (string.Compare(text, "ABSOLUTE", ignoreCase: true, CultureInfo.InvariantCulture) == 0)
		{
			m_dateFormatter = new AbsoluteTimeDateFormatter();
			return;
		}
		if (string.Compare(text, "DATE", ignoreCase: true, CultureInfo.InvariantCulture) == 0)
		{
