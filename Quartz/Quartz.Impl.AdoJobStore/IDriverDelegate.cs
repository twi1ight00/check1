...
public interface IDriverDelegate
{
	...
	Quartz.Collection.ISet<JobKey> SelectJobsInGroup(ConnectionAndTransactionHolder conn, GroupMatcher<JobKey> matcher);
	...
	Quartz.Collection.ISet<TriggerKey> SelectTriggersInGroup(ConnectionAndTransactionHolder conn, GroupMatcher<TriggerKey> matcher);
	...
	/// <param name="conn">The DB Connection.</param>
	/// <returns></returns>
	Quartz.Collection.ISet<string> SelectPausedTriggerGroups(ConnectionAndTransactionHolder conn);
	...
	/// <param name="conn">The conn.</param>
	/// <returns></returns>
	Quartz.Collection.ISet<string> SelectFiredTriggerInstanceNames(ConnectionAndTransactionHolder conn);
