...
internal class Class374 : Class369
{
	...
	internal static readonly string string_0 = "circle";
	...
	public double Radius
	{
		get
		{
			return method_7("r", string_1, -1.0);
		}
		set
		{
			method_8("r", string_1, value);
		}
	}

	public Class374(string prefix, string localName, string namespaceURI, XmlDocument doc)
