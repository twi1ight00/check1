...
internal class Class220 : Class160
{
	internal Class220(Interface42 interface42_1, float float_5, float float_6, Class913 class913_1)
	...
	internal override GraphicsPath vmethod_0(RectangleF rectangleF_0)
	{
		...
		if (class913_0.class901_0 != null)
		{
			if (class913_0.class901_0.arrayList_0.Count > 0)
			{
				...
				float num3 = ((!(rectangleF_0.Width > rectangleF_0.Height)) ? 1f : (rectangleF_0.Width / rectangleF_0.Height));
				num2 = rectangleF_0.Width * (1f - Convert.ToSingle(class913_0.class901_0.arrayList_0[1]) / (100000f * num3));
			}
			else
			{
				num = rectangleF_0.Height * 0.5f;
				float num4 = rectangleF_0.Width / rectangleF_0.Height;
				num2 = rectangleF_0.Width * (1f - 50000f / (100000f * num4));
			}
		}
		else
		{
			num = rectangleF_0.Height * 0.5f;
			float num5 = rectangleF_0.Width / rectangleF_0.Height;
			num2 = rectangleF_0.Width * (1f - 50000f / (100000f * num5));
		}
