...
internal class Class447 : Class369
{
	internal static readonly string string_0 = "last-row";
	...
	public Class447(string prefix, string localName, string namespaceURI, XmlDocument doc)
