...
internal class Class1841 : Class1351
{
	public delegate Class1841 Delegate1402();

	public delegate void Delegate1404(Class1841 elementData);

	public delegate void Delegate1403(Class1841 elementData);
	...
	public Class1841(XmlReader reader)
		: base(reader)
	{
	}
