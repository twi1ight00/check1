...
[Serializable]
public class AC_IT_DEVICE_REPAIR : DTOExt, IDTO
{
	...
	public AC_IT_DEVICE_REPAIR()
	{
		_addsql = "insert into AC_IT_DEVICE_REPAIR (\r\nIT_DEVICE_REPAIR_ID ,\r\nDEVICE_NAME ,\r\nREPAIR_REASON ,\r\nREMARK ,\r\nISDEL ,\r\nCREATOR ,\r\nCREATETIME ,\r\nMODIFIER ,\r\nMODIFYTIME ,\r\nUSER_ID ,\r\nUSER_NAME ,\r\nORG_ID ,\r\nORG_NAME ,\r\nINSTANCE_ID ) values (\r\n:IT_DEVICE_REPAIR_ID ,\r\n:DEVICE_NAME ,\r\n:REPAIR_REASON ,\r\n:REMARK ,\r\n:ISDEL ,\r\n:CREATOR ,\r\n:CREATETIME ,\r\n:MODIFIER ,\r\n:MODIFYTIME ,\r\n:USER_ID ,\r\n:USER_NAME ,\r\n:ORG_ID ,\r\n:ORG_NAME ,\r\n:INSTANCE_ID )";
		_findbyinstance = "SELECT * FROM AC_IT_DEVICE_REPAIR WHERE INSTANCE_ID=:INSTANCE_ID";
		_findpage = "SELECT T1.*,T2.TEMPLATE_ID,T2.INSTANCE_NAME FROM AC_IT_DEVICE_REPAIR T1 LEFT JOIN WF_INSTANCE T2 ON T1.INSTANCE_ID=T2.INSTANCE_ID ";
		_updatesql = "update AC_IT_DEVICE_REPAIR set IT_DEVICE_REPAIR_ID=:IT_DEVICE_REPAIR_ID \r\n,DEVICE_NAME=:DEVICE_NAME \r\n,REPAIR_REASON=:REPAIR_REASON \r\n,REMARK=:REMARK \r\n,ISDEL=:ISDEL \r\n,CREATOR=:CREATOR \r\n,CREATETIME=:CREATETIME \r\n,MODIFIER=:MODIFIER \r\n,MODIFYTIME=:MODIFYTIME \r\n,USER_ID=:USER_ID \r\n,USER_NAME=:USER_NAME \r\n,ORG_ID=:ORG_ID \r\n,ORG_NAME=:ORG_NAME \r\n WHERE INSTANCE_ID=:INSTANCE_ID";
	}

	public override string FindList(string parm)
	{
		AC_IT_DEVICE_REPAIR dto = parm.JsonDeserialize<AC_IT_DEVICE_REPAIR>(new JsonConverter[0]);
		return FindList<AC_IT_DEVICE_REPAIR>(dto);
	}
