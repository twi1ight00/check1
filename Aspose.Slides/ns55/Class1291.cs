...
internal class Class1291 : Class1266
{
	public const string string_2 = "application/vnd.openxmlformats-officedocument.spreadsheetml.comments+xml";
	...
	public static readonly string[] string_3 = new string[1] { "sml-comments.xsd" };

	public static readonly XmlSchemaCollection xmlSchemaCollection_0 = Class1224.smethod_1(string_3);

	public override string ContentType => "application/vnd.openxmlformats-officedocument.spreadsheetml.comments+xml";
