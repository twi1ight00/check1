...
internal class Class5334 : Class5332
{
	public Class5334(Class5254 position, Class5032 condLength, Class5695 side, bool isFirst, bool isLast, Interface172 context)
	...
	public override void vmethod_6(Class5746 effectiveLength)
	{
		...
		{
			((Interface184)@interface).imethod_40(method_6(), effectiveLength);
		}
	}
