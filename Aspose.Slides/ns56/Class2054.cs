...
internal class Class2054 : Class2053
{
	public delegate void Delegate1885(Class2054 elementData);
	...
	public override Class2083 LblAlgn => class2083_0;
	...
	public override Class2339 NoMultiLvlLbl => class2339_2;
		...
		while (((flag && !reader.EOF) || reader.Read()) && (reader.NodeType != XmlNodeType.EndElement || !(reader.LocalName == localName)))
		{
			...
			if (reader.NodeType == XmlNodeType.Element)
			{
				...
				case "auto":
					...
					break;
				case "lblAlgn":
					class2083_0 = new Class2083(reader);
					break;
				case "lblOffset":
	...
	public Class2054(XmlReader reader)
		: base(reader)
	{
	}
	...
	protected override void vmethod_2()
	{
		...
		delegate2773_0 = method_37;
		delegate2763_1 = method_23;
		delegate2764_1 = method_24;
		delegate1964_0 = method_25;
		delegate1966_0 = method_26;
		delegate1967_0 = method_27;
		delegate1969_0 = method_28;
		delegate2078_0 = method_29;
		delegate2080_0 = method_30;
		delegate2078_1 = method_31;
		delegate2080_1 = method_32;
		delegate2763_2 = method_33;
		delegate2764_2 = method_34;
		delegate1534_0 = method_35;
		delegate1535_0 = method_36;
	}
	...
	public override void vmethod_4(string prefix, XmlWriter writer, string elementName)
	{
		...
		if (class2083_0 != null)
		{
			class2083_0.vmethod_4("c", writer, "lblAlgn");
		}
		if (class2084_0 != null)
		{
		...
		if (class2339_2 != null)
		{
			class2339_2.vmethod_4("c", writer, "noMultiLvlLbl");
		}
		if (class1887_0 != null)
		{
	...
	private Class2083 method_25()
	{
		if (class2083_0 != null)
		{
			throw new Exception("Only one <lblAlgn> element can be added.");
		}
		class2083_0 = new Class2083();
		return class2083_0;
	}

	private void method_26(Class2083 _lblAlgn)
	{
		class2083_0 = _lblAlgn;
	}

	private Class2084 method_27()
	{
		if (class2084_0 != null)
		{
	...
	private void method_28(Class2084 _lblOffset)
	{
		class2084_0 = _lblOffset;
	}

	private Class2117 method_29()
	{
		if (class2117_0 != null)
		{
	...
	private void method_30(Class2117 _tickLblSkip)
	{
		class2117_0 = _tickLblSkip;
	}

	private Class2117 method_31()
	{
		if (class2117_1 != null)
		{
	...
	private void method_32(Class2117 _tickMarkSkip)
	{
		class2117_1 = _tickMarkSkip;
	}

	private Class2339 method_33()
	{
		if (class2339_2 != null)
		{
			throw new Exception("Only one <noMultiLvlLbl> element can be added.");
		}
		class2339_2 = new Class2339();
		return class2339_2;
	}

	private void method_34(Class2339 _noMultiLvlLbl)
	{
		class2339_2 = _noMultiLvlLbl;
	}

	private Class1885 method_35()
	{
		if (class1887_0 != null)
		{
	...
	private void method_36(Class1885 _extLst)
	{
		class1887_0 = (Class1887)_extLst;
	}

	private Class2605 method_37(string elementName)
	{
		if (class2605_0 != null)
		{
