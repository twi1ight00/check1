...
public class Spinner : Shape
{
	...
	public int CurrentValue
	{
		...
		set
		{
			...
			if (isArea)
			{
				if (value >= 0)
				{
					method_26().Cells.GetCell(cellArea.StartRow, cellArea.StartColumn, bool_2: false).PutValue(ushort_1 + 1);
				}
				else
				{
	...
	internal Spinner(ShapeCollection shapeCollection_1)
		: base(shapeCollection_1, MsoDrawingType.Spinner, shapeCollection_1)
	{
		ushort_1 = 0;
		ushort_2 = 0;
		ushort_3 = 30000;
	...
	internal void Copy(Spinner spinner_0, CopyOptions copyOptions_0)
	{
		ushort_2 = spinner_0.ushort_2;
		ushort_3 = spinner_0.ushort_3;
		ushort_5 = spinner_0.ushort_5;
		ushort_4 = spinner_0.ushort_4;
		ushort_1 = spinner_0.ushort_1;
		bool_3 = spinner_0.bool_3;
		Copy((Shape)spinner_0, copyOptions_0);
	}
}
