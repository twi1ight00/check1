...
internal class Class1787 : Class1351
{
	public delegate Class1787 Delegate1240();

	public delegate void Delegate1241(Class1787 elementData);

	public delegate void Delegate1242(Class1787 elementData);
	...
	public Class1787(XmlReader reader)
		: base(reader)
	{
	}
