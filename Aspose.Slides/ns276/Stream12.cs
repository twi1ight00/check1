...
internal class Stream12 : Stream, IDisposable
{
	...
	public Stream12(Stream stream, Enum916 mode)
		: this(stream, mode, Enum914.const_8, leaveOpen: false)
	{
	}

	public Stream12(Stream stream, Enum916 mode, Enum914 level)
		: this(stream, mode, level, leaveOpen: false)
	{
	}

	public Stream12(Stream stream, Enum916 mode, bool leaveOpen)
		: this(stream, mode, Enum914.const_8, leaveOpen)
	{
	}

	public Stream12(Stream stream, Enum916 mode, Enum914 level, bool leaveOpen)
	{
		stream13_0 = new Stream13(stream, mode, level, Enum917.const_0, leaveOpen);
	}
	...
	{
		return Stream13.smethod_0(s, typeof(Stream12));
	}

	public static byte[] smethod_1(byte[] b)
	{
		return Stream13.smethod_2(b, typeof(Stream12));
	}

	public static string smethod_2(byte[] compressed)
	{
		return Stream13.smethod_1(compressed, typeof(Stream12));
	}

	public static byte[] smethod_3(byte[] compressed)
	{
		return Stream13.smethod_3(compressed, typeof(Stream12));
	}
