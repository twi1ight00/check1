...
public class EventLogAppender : AppenderSkeleton
{
	...
	protected override void Append(LoggingEvent loggingEvent)
	{
		...
		if (obj2 != null)
		{
			...
			else
			{
				...
				{
					if (SystemInfo.TryParse(text2, out short val2))
					{
						category = val2;
					}
					else
	...
	{
		if (m_levelMapping.Lookup(level) is Level2EventLogEntryType level2EventLogEntryType)
		{
