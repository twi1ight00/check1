...
[Serializable]
public class HR_PERSONAL_EXIT : DTOExt, IDTO
{
	...
	public HR_PERSONAL_EXIT()
	{
		_addsql = "insert into HR_PERSONAL_EXIT (\r\nHR_PERSONAL_EXIT_ID ,\r\nTITLE ,\r\nSEX ,\r\nBIRTHDAY ,\r\nNATION ,\r\nNATIVE_PLACE ,\r\nBIRTHPLACE ,\r\nPOLITICAL_STATUS ,\r\nMARITAL_STATUS ,\r\nEDUCATION ,\r\nADDRESS ,\r\nWORK_UNIT ,\r\nPOSITION ,\r\nCOUNTRY ,\r\nREASON ,\r\nORG_SUGGESTION ,\r\nAPPROVAL_OPINION ,\r\nISDEL ,\r\nCREATOR ,\r\nCREATETIME ,\r\nMODIFIER ,\r\nMODIFYTIME ,\r\nUSER_ID ,\r\nUSER_NAME ,\r\nORG_ID ,\r\nORG_NAME ,\r\nAPPLICANT_ID ,\r\nAPPLICANT_NAME ,\r\nAPPLICANT_NAMES ,\r\nINSTANCE_ID ) values (\r\n:HR_PERSONAL_EXIT_ID ,\r\n:TITLE ,\r\n:SEX ,\r\n:BIRTHDAY ,\r\n:NATION ,\r\n:NATIVE_PLACE ,\r\n:BIRTHPLACE ,\r\n:POLITICAL_STATUS ,\r\n:MARITAL_STATUS ,\r\n:EDUCATION ,\r\n:ADDRESS ,\r\n:WORK_UNIT ,\r\n:POSITION ,\r\n:COUNTRY ,\r\n:REASON ,\r\n:ORG_SUGGESTION ,\r\n:APPROVAL_OPINION ,\r\n:ISDEL ,\r\n:CREATOR ,\r\n:CREATETIME ,\r\n:MODIFIER ,\r\n:MODIFYTIME ,\r\n:USER_ID ,\r\n:USER_NAME ,\r\n:ORG_ID ,\r\n:ORG_NAME ,\r\n:APPLICANT_ID ,\r\n:APPLICANT_NAME ,\r\n:APPLICANT_NAMES ,\r\n:INSTANCE_ID )";
		_findbyinstance = "SELECT * FROM HR_PERSONAL_EXIT WHERE INSTANCE_ID=:INSTANCE_ID";
		_findpage = "SELECT T1.*,T2.TEMPLATE_ID,T2.INSTANCE_NAME FROM HR_PERSONAL_EXIT T1 LEFT JOIN WF_INSTANCE T2 ON T1.INSTANCE_ID=T2.INSTANCE_ID ";
		_updatesql = "update HR_PERSONAL_EXIT set TITLE=:TITLE \r\n,SEX=:SEX \r\n,BIRTHDAY=:BIRTHDAY \r\n,NATION=:NATION \r\n,NATIVE_PLACE=:NATIVE_PLACE \r\n,BIRTHPLACE=:BIRTHPLACE \r\n,POLITICAL_STATUS=:POLITICAL_STATUS \r\n,MARITAL_STATUS=:MARITAL_STATUS \r\n,EDUCATION=:EDUCATION \r\n,ADDRESS=:ADDRESS \r\n,WORK_UNIT=:WORK_UNIT \r\n,POSITION=:POSITION \r\n,COUNTRY=:COUNTRY \r\n,REASON=:REASON \r\n,ORG_SUGGESTION=:ORG_SUGGESTION \r\n,APPROVAL_OPINION=:APPROVAL_OPINION \r\n,ISDEL=:ISDEL \r\n,CREATOR=:CREATOR \r\n,CREATETIME=:CREATETIME \r\n,MODIFIER=:MODIFIER \r\n,MODIFYTIME=:MODIFYTIME \r\n,USER_ID=:USER_ID \r\n,USER_NAME=:USER_NAME \r\n,ORG_ID=:ORG_ID \r\n,ORG_NAME=:ORG_NAME \r\n,APPLICANT_ID=:APPLICANT_ID \r\n,APPLICANT_NAME=:APPLICANT_NAME \r\n,APPLICANT_NAMES=:APPLICANT_NAMES \r\n WHERE INSTANCE_ID=:INSTANCE_ID";
	}

	public override string FindList(string parm)
	{
		HR_PERSONAL_EXIT dto = parm.JsonDeserialize<HR_PERSONAL_EXIT>(new JsonConverter[0]);
		return FindList<HR_PERSONAL_EXIT>(dto);
	}
