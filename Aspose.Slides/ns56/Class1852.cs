...
internal class Class1852 : Class1351
{
	public delegate Class1852 Delegate1435();

	public delegate void Delegate1437(Class1852 elementData);

	public delegate void Delegate1436(Class1852 elementData);
	...
	public Class1852(XmlReader reader)
		: base(reader)
	{
	}
