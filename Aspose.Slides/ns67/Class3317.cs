...
internal class Class3317 : Class3290
{
	private const string string_0 = "adj";

	public override Enum496 ShapeType => Enum496.const_37;

	public override Class3280 vmethod_1()
	{
		Class3317 @class = new Class3317();
	...
	{
		double x = Class3089.smethod_0(0.0, base.AdjustValues["adj"], 71431.0);
