...
internal class Class1917 : Class1351
{
	public delegate Class1917 Delegate1618();

	public delegate void Delegate1619(Class1917 elementData);

	public delegate void Delegate1620(Class1917 elementData);

	public Class2605.Delegate2773 delegate2773_0;

	private SchemeColor schemeColor_0;

	private List<Class2605> list_0;

	public SchemeColor Val
	{
		get
		{
			return schemeColor_0;
		}
		set
		{
			schemeColor_0 = value;
	...
	private void method_2(XmlReader reader)
	{
		while (reader.MoveToNextAttribute())
		{
			...
			{
				schemeColor_0 = Class2553.smethod_0(reader.Value);
			}
		}
		reader.MoveToElement();
	}

	public Class1917(XmlReader reader)
		: base(reader)
	{
	}
	...
	{
		schemeColor_0 = SchemeColor.Background1;
	...
	public override void vmethod_4(string prefix, XmlWriter writer, string elementName)
	{
		...
		writer.WriteAttributeString("val", Class2553.smethod_1(schemeColor_0));
		if (list_0 != null)
		{
