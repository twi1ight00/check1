...
internal class Class3211 : Class3091
{
	...
	public override Enum493 Kind => Enum493.const_52;

	public Class3211(Class3448 xfrm)
		: base(xfrm)
	{
	}
	...
	public override Class3279 vmethod_1()
	{
		...
		double x = Class3089.smethod_2(base.Transform2D.Extents.Cx, 0.0, z3);
		double y3 = Class3089.smethod_2(base.Transform2D.Extents.Cy, 0.0, z3);
		double z4 = Class3089.smethod_1(Math.Min(base.Transform2D.Extents.Cy, base.Transform2D.Extents.Cx), num, 100000.0);
		double num3 = Class3089.smethod_2(base.Transform2D.Extents.Cx, 0.0, z4);
		double num4 = Class3089.smethod_2(base.Transform2D.Extents.Cy, 0.0, z4);
		double num5 = Class3089.smethod_1(Math.Min(base.Transform2D.Extents.Cy, base.Transform2D.Extents.Cx), y, 200000.0);
		double x2 = Class3089.smethod_2(num3, 0.0, num5);
		double num6 = Class3089.smethod_2(num3, num5, 0.0);
		double num7 = Class3089.smethod_2(num4, 0.0, num5);
		double num8 = Class3089.smethod_2(num4, num5, 0.0);
		double left = Class3089.smethod_1(num5, num2, z4);
		Class3089.smethod_3(num2, num6, 2.0);
		Class3089.smethod_3(num2, num8, 2.0);
