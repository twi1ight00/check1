...
internal class Class1814 : Class1351
{
	public delegate Class1814 Delegate1321();

	public delegate void Delegate1322(Class1814 elementData);

	public delegate void Delegate1323(Class1814 elementData);
	...
	public Class1814(XmlReader reader)
		: base(reader)
	{
	}
