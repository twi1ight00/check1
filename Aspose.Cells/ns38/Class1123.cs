...
internal class Class1123
{
	internal static object smethod_0(Class1264 class1264_0, Class1661 class1661_0, Cell cell_0)
	{
		if (class1661_0.method_7() != null && (class1661_0.method_7().Count == 4 || class1661_0.method_7().Count == 3))
		{
			...
			int num = -1;
			object obj3 = Class1660.smethod_26(class1264_0.method_4((Class1661)class1661_0.method_7()[2], cell_0), class1264_0.workbook_0.Settings.Date1904);
			if (obj3 is double)
			{
				...
				obj2 = class1264_0.method_4((Class1661)class1661_0.method_7()[1], cell_0);
				if (obj2 == null)
				{
					return obj2;
				}
				...
				if (obj2 is Struct87)
				{
					...
					obj2 = class1264_0.method_35(class1661_0, class1264_0.workbook_0.Worksheets[@struct.int_1], cell_0, @struct.cellArea_0.StartRow, @struct.cellArea_0.StartRow, @struct.cellArea_0.StartColumn, @struct.cellArea_0.EndColumn);
					flag = true;
				...
				{
					object obj4 = class1264_0.method_4((Class1661)class1661_0.method_7()[3], cell_0);
					...
					{
						double doubleFromDateTime = CellsHelper.GetDoubleFromDateTime((DateTime)obj4, class1264_0.workbook_0.Settings.Date1904);
				...
				int num2 = 0;
				object obj5 = smethod_1(class1264_0, obj, obj2, bool_);
				if (obj5 is double)
				{
					num2 = (int)Class1179.ToDouble(obj5);
					if (flag)
					{
						Cell cell = class1264_0.workbook_0.Worksheets[@struct.int_1].Cells.CheckCell(@struct.cellArea_0.StartRow + num, @struct.cellArea_0.StartColumn + num2);
						if (cell == null)
						{
							return null;
						}
	...
	private static object smethod_1(Class1264 class1264_0, object object_0, object object_1, bool bool_0)
	{
		...
		{
		case TypeCode.Double:
			return smethod_2(class1264_0, (double)object_0, (Array)object_1, bool_0);
		case TypeCode.DateTime:
		{
			double doubleFromDateTime = CellsHelper.GetDoubleFromDateTime((DateTime)object_0, class1264_0.workbook_0.Settings.Date1904);
			return smethod_2(class1264_0, doubleFromDateTime, (Array)object_1, bool_0);
		}
		default:
			return ErrorType.Value;
		case TypeCode.String:
	...
	private static object smethod_2(Class1264 class1264_0, double double_0, Array array_0, bool bool_0)
	{
		if (bool_0)
		{
			int num = -1;
			...
			for (int i = 0; i < length; i++)
			{
				...
				if (value == null || !(Class1660.smethod_26(value, class1264_0.workbook_0.Settings.Date1904) is double num2))
				{
					continue;
				}
				...
				while (true)
				{
					...
					if (i != length)
					{
						...
						{
							value2 = Class1660.smethod_26(value2, class1264_0.workbook_0.Settings.Date1904);
							if (!(value2 is double))
							{
								break;
							}
		...
		else
		{
			...
			for (int j = 0; j < array2.Length; j++)
			{
				...
				if (value3 != null)
				{
					value3 = Class1660.smethod_26(value3, class1264_0.workbook_0.Settings.Date1904);
