...
internal class Class96 : Class18
{
	internal Class96(Interface42 interface42_1, float float_5, float float_6, Class898 class898_1)
	...
	internal override GraphicsPath vmethod_0(RectangleF rectangleF_0)
	{
		...
		{
		default:
			num11 = width * 14294f / 21600f;
			num12 = height * 5233f / 21600f;
			num13 = width * 18106f / 21600f;
			num14 = height * 7905f / 21600f;
			break;
		case 1:
			if (((Class882)class898_0.class885_0.arrayList_0[0]).method_0() == 327)
			{
				num11 = width * (Convert.ToSingle(((Class882)class898_0.class885_0.arrayList_0[0]).Value) / 21600f);
				num12 = height * 5233f / 21600f;
				num13 = width * 18106f / 21600f;
				num14 = height * 7905f / 21600f;
			}
			...
			{
				num11 = width * 14294f / 21600f;
				num12 = height * Convert.ToSingle(((Class882)class898_0.class885_0.arrayList_0[0]).Value) / 21600f;
				num13 = width * 18106f / 21600f;
				num14 = height * 7905f / 21600f;
			}
			else if (((Class882)class898_0.class885_0.arrayList_0[0]).method_0() == 329)
			{
				num11 = width * 14294f / 21600f;
				num12 = height * 5233f / 21600f;
				num13 = width * Convert.ToSingle(((Class882)class898_0.class885_0.arrayList_0[0]).Value) / 21600f;
				num14 = height * 7905f / 21600f;
			}
			else if (((Class882)class898_0.class885_0.arrayList_0[0]).method_0() == 330)
			{
				...
				num12 = height * 5233f / 21600f;
				num13 = width * 18106f / 21600f;
				num14 = height * Convert.ToSingle(((Class882)class898_0.class885_0.arrayList_0[0]).Value) / 21600f;
			}
			break;
		case 2:
			...
			{
				num11 = width * (Convert.ToSingle(((Class882)class898_0.class885_0.arrayList_0[0]).Value) / 21600f);
				num12 = height * Convert.ToSingle(((Class882)class898_0.class885_0.arrayList_0[1]).Value) / 21600f;
				num13 = width * 18106f / 21600f;
				num14 = height * 7905f / 21600f;
			}
			else if (((Class882)class898_0.class885_0.arrayList_0[0]).method_0() == 327 && ((Class882)class898_0.class885_0.arrayList_0[1]).method_0() == 329)
			{
				num11 = width * (Convert.ToSingle(((Class882)class898_0.class885_0.arrayList_0[0]).Value) / 21600f);
				num12 = height * 5233f / 21600f;
				num13 = width * Convert.ToSingle(((Class882)class898_0.class885_0.arrayList_0[1]).Value) / 21600f;
				num14 = height * 7905f / 21600f;
			}
			else if (((Class882)class898_0.class885_0.arrayList_0[0]).method_0() == 327 && ((Class882)class898_0.class885_0.arrayList_0[1]).method_0() == 330)
			{
				...
				num12 = height * 5233f / 21600f;
				num13 = width * 18106f / 21600f;
				num14 = height * Convert.ToSingle(((Class882)class898_0.class885_0.arrayList_0[1]).Value) / 21600f;
			}
		...
		case 3:
			if (((Class882)class898_0.class885_0.arrayList_0[0]).method_0() == 327 && ((Class882)class898_0.class885_0.arrayList_0[1]).method_0() == 328 && ((Class882)class898_0.class885_0.arrayList_0[2]).method_0() == 329)
			{
				num11 = width * (Convert.ToSingle(((Class882)class898_0.class885_0.arrayList_0[0]).Value) / 21600f);
				num12 = height * Convert.ToSingle(((Class882)class898_0.class885_0.arrayList_0[1]).Value) / 21600f;
				num13 = width * Convert.ToSingle(((Class882)class898_0.class885_0.arrayList_0[2]).Value) / 21600f;
				num14 = height * 7905f / 21600f;
			}
			else if (((Class882)class898_0.class885_0.arrayList_0[0]).method_0() == 327 && ((Class882)class898_0.class885_0.arrayList_0[1]).method_0() == 328 && ((Class882)class898_0.class885_0.arrayList_0[2]).method_0() == 330)
			{
				...
				num12 = height * Convert.ToSingle(((Class882)class898_0.class885_0.arrayList_0[1]).Value) / 21600f;
				num13 = width * 18106f / 21600f;
				num14 = height * Convert.ToSingle(((Class882)class898_0.class885_0.arrayList_0[2]).Value) / 21600f;
			}
		...
		case 4:
			...
			num12 = height * Convert.ToSingle(((Class882)class898_0.class885_0.arrayList_0[1]).Value) / 21600f;
			num13 = width * Convert.ToSingle(((Class882)class898_0.class885_0.arrayList_0[2]).Value) / 21600f;
			num14 = height * Convert.ToSingle(((Class882)class898_0.class885_0.arrayList_0[3]).Value) / 21600f;
			break;
		}
		num3 = height - 2f * num14;
		num4 = height / 2f - num12;
		num5 = width - num13;
		num6 = num11;
		num7 = num6;
		num8 = width - num5;
		...
		case 2:
		{
			...
			reference13 = new PointF(num + num7, num2);
			ref PointF reference14 = ref array[2];
			reference14 = new PointF(num + num7, num2 + num10);
			ref PointF reference15 = ref array[3];
			reference15 = new PointF(num + num8, num2 + num10);
			ref PointF reference16 = ref array[4];
			reference16 = new PointF(num + num8, num2 + num9);
			ref PointF reference17 = ref array[5];
			reference17 = new PointF(num + width, num2 + height / 2f);
			ref PointF reference18 = ref array[6];
			reference18 = new PointF(num + num8, num2 + height - num9);
			ref PointF reference19 = ref array[7];
			reference19 = new PointF(num + num8, num2 + height - num10);
			ref PointF reference20 = ref array[8];
			reference20 = new PointF(num + num7, num2 + height - num10);
			ref PointF reference21 = ref array[9];
			reference21 = new PointF(num + num7, num2 + height);
		...
		case 4:
		{
			...
			reference = new PointF(num + width - num7, num2);
			ref PointF reference2 = ref array[1];
			reference2 = new PointF(num + width, num2);
			ref PointF reference3 = ref array[2];
			reference3 = new PointF(num + width, num2 + height);
			ref PointF reference4 = ref array[3];
			reference4 = new PointF(num + width - num7, num2 + height);
			ref PointF reference5 = ref array[4];
			reference5 = new PointF(num + width - num7, num2 + height - num10);
			ref PointF reference6 = ref array[5];
			reference6 = new PointF(num + num5, num2 + height - num10);
			ref PointF reference7 = ref array[6];
			reference7 = new PointF(num + num5, num2 + height - num9);
			ref PointF reference8 = ref array[7];
			reference8 = new PointF(num, num2 + height / 2f);
			ref PointF reference9 = ref array[8];
			reference9 = new PointF(num + num5, num2 + num9);
			ref PointF reference10 = ref array[9];
			reference10 = new PointF(num + num5, num2 + num10);
			ref PointF reference11 = ref array[10];
			reference11 = new PointF(num + width - num7, num2 + num10);
			graphicsPath.AddPolygon(array);
			break;
		}
		}
