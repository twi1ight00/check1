...
internal class Class1254
{
	...
	internal Class1254(WorksheetCollection worksheetCollection_1)
	{
	...
	internal string method_1(int int_2, int int_3, byte[] byte_0, int int_4, int int_5, bool bool_1)
	{
		...
		while (int_2 < byte_0.Length && (int_1 == 0 || int_2 < num))
		{
			...
			case 31:
			{
				double num5 = BitConverter.ToDouble(byte_0, int_2 + 1);
				arrayList.Add(stringBuilder_0.Length);
				if (!(num5 >= 1E+21) && Math.Abs(num5) > 1E-21)
				{
					stringBuilder_0.Append(num5.ToString("0.##################################", CultureInfo.InvariantCulture));
				}
				else
				{
					stringBuilder_0.Append(num5.ToString());
				}
				int_2 += 9;
				break;
			}
			...
			case 101:
				...
				if (bool_0)
				{
					stringBuilder_0.Append("[." + GetCellArea(byte_0, int_2, int_4, int_5, bool_1) + "]");
				}
				else
				{
					stringBuilder_0.Append(GetCellArea(byte_0, int_2, int_4, int_5, bool_1));
			...
			case 109:
				...
				if (bool_0)
				{
					stringBuilder_0.Append("[." + GetCellArea(byte_0, int_2, int_4, int_5, bool_1: true) + "]");
				}
				else
				{
					stringBuilder_0.Append(GetCellArea(byte_0, int_2, int_4, int_5, bool_1: true));
			...
			case 121:
			{
				...
				int num3 = worksheetCollection_0.method_32().method_12(num2);
				...
				int_2 += 2;
				int num4 = BitConverter.ToUInt16(byte_0, int_2);
				if (@class == null)
				{
			...
			case 122:
			{
				...
				string value2 = method_5(byte_0, int_2, out isError);
				if (isError)
				{
					int_2 += 2;
					stringBuilder_0.Append(".#REF!#REF!");
			...
			case 123:
			{
				...
				string value = method_5(byte_0, int_2, out isError);
				if (isError)
				{
					int_2 += 2;
					stringBuilder_0.Append(".#REF!#REF!");
	...
	private void method_4(byte byte_0, StringBuilder stringBuilder_1)
	{
		byte b = (byte)((int)byte_0 / 26);
		byte b2 = (byte)((int)byte_0 % 26);
		if (b > 0)
		{
			char value = (char)(b + 64);
			char value2 = (char)(b2 + 65);
			stringBuilder_1.Append(value);
			stringBuilder_1.Append(value2);
		}
		else
		{
			stringBuilder_1.Append((char)(b2 + 65));
		}
	}

	private string method_5(byte[] data, int pos, out bool isError)
	{
		isError = false;
		...
		{
			return Class932.smethod_0(num, worksheetCollection_0, 0, null);
		}
		isError = true;
		return "#REF!";
	}

	private string GetCellArea(byte[] byte_0, int int_2, int int_3, int int_4, bool bool_1)
	{
		ushort num = BitConverter.ToUInt16(byte_0, int_2);
		byte b = byte_0[int_2 + 4];
		int num2 = ((num + int_3 <= 65535) ? (num + int_3) : (num + int_3 - 65535 - 1));
		int num3 = ((b + int_4 <= 255) ? (b + int_4) : (b + int_4 - 255 - 1));
		...
		if (num == 0)
		{
			num4 = BitConverter.ToUInt16(byte_0, int_2 + 2);
			if (num4 == ushort.MaxValue)
			{
				...
				byte_ = byte_0[int_2 + 6];
				method_4(byte_, stringBuilder);
		...
		string value = CellsHelper.CellIndexToName(num, b);
		...
		else if (flag)
		{
			...
			{
				if (char.IsDigit(stringBuilder[j]))
				{
		...
		num4 = BitConverter.ToUInt16(byte_0, int_2 + 2);
		byte_ = byte_0[int_2 + 6];
		num2 = ((num4 + int_3 <= 65535) ? (num4 + int_3) : (num4 + int_3 - 65535 - 1));
		num3 = ((byte_ + int_4 <= 255) ? (byte_ + int_4) : (byte_ + int_4 - 255 - 1));
		flag = true;
		flag2 = true;
		if ((byte_0[int_2 + 7] & 0x80u) != 0)
		{
		...
		string value2 = CellsHelper.CellIndexToName(num4, byte_);
		...
		if (flag2)
		{
			...
			if (flag)
			{
				for (int k = length + 1; k < stringBuilder.Length; k++)
				{
					if (char.IsDigit(stringBuilder[k]))
					{
		...
		{
			for (int l = length + 1; l < stringBuilder.Length; l++)
			{
				if (char.IsDigit(stringBuilder[l]))
				{
	...
	private string method_6(byte[] byte_0, int int_2, int int_3, int int_4)
	{
		...
		int row = ((num + int_3 <= 65535) ? (num + int_3) : (num + int_3 - 65535 - 1));
		int num2 = ((b + int_4 <= 255) ? (b + int_4) : (b + int_4 - 255 - 1));
		...
		{
			stringBuilder.Append(CellsHelper.ColumnIndexToName((byte)num2));
		}
		if ((b2 & 0x80) == 0)
		{
			stringBuilder.Append('$');
	...
	{
		ushort row = BitConverter.ToUInt16(byte_0, int_2);
		byte column = byte_0[int_2 + 2];
		bool flag = true;
		bool flag2 = true;
