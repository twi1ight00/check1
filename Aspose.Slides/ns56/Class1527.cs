...
internal class Class1527 : Class1351
{
	public delegate Class1527 Delegate460();

	public delegate void Delegate462(Class1527 elementData);

	public delegate void Delegate461(Class1527 elementData);

	public Class2605.Delegate2773 delegate2773_0;

	private List<Class2605> list_0;

	public Class2605[] FontPropertiesList => list_0.ToArray();
		...
		while (((flag && !reader.EOF) || reader.Read()) && (reader.NodeType != XmlNodeType.EndElement || !(reader.LocalName == localName)))
		{
			...
			if (reader.NodeType == XmlNodeType.Element)
			{
				...
				case "name":
				{
					...
					list_0.Add(new Class2605("name", obj15));
					break;
				}
				case "charset":
				{
	...
	public Class1527(XmlReader reader)
		: base(reader)
	{
	}
	...
	private Class2605 method_3(string elementName)
	{
		...
		{
			"name" => new Class2605("name", new Class1528()), 
