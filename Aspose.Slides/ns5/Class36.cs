...
internal class Class36 : EffectEffectiveDataPVITemp, IGlowEffectiveData
{
	...
	internal Class36(double radius, Class21.Delegate2 colorResolver)
	{
		double_0 = radius;
	...
	{
		return base.vmethod_1() + double_0 + " " + Color;
	}
