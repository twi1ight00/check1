...
internal class Class1708 : Class1351
{
	public delegate Class1708 Delegate1003();

	public delegate void Delegate1004(Class1708 elementData);

	public delegate void Delegate1005(Class1708 elementData);
	...
	public Class1708(XmlReader reader)
		: base(reader)
	{
	}
	...
	public override void vmethod_4(string prefix, XmlWriter writer, string elementName)
	{
		...
		writer.WriteAttributeString("v", string_0);
		...
		if (string_1 != null)
		{
			writer.WriteAttributeString("c", string_1);
		}
