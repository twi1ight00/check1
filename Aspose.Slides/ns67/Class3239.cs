...
internal class Class3239 : Class3091
{
	private const string string_0 = "adj1";

	private const string string_1 = "adj2";

	public override Enum493 Kind => Enum493.const_43;

	public Class3239(Class3448 xfrm)
		: base(xfrm)
	{
	}
	...
	public override Class3279 vmethod_1()
	{
		...
		double y3 = Class3089.smethod_1(num3, num, base.Transform2D.Extents.Cy / 2.0);
		double right = Class3089.smethod_2(x, y3, 0.0);
		...
		@class.method_8();
		@class.TextRectangle = new Class3457(0.0, num3, right, num4);
		return @class;
	}
