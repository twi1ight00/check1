...
internal class Class5975
{
	internal enum Enum744
	{
		const_0 = -1,
		const_1,
		const_2
	...
	internal class Class5976
	{
		private Class5975 class5975_0;

		private Class5975 class5975_1;

		internal Class5976(Class5975 modulus)
		{
			class5975_0 = modulus;
			uint num = class5975_0.uint_1 << 1;
			class5975_1 = new Class5975(Enum744.const_2, num + 1);
			class5975_1.uint_2[num] = 1u;
			class5975_1 = smethod_10(class5975_1, class5975_0);
		}

		internal void method_0(Class5975 x)
		{
			Class5975 @class = class5975_0;
			...
			if (x.uint_1 >= uint_)
			{
				...
				Class5975 class2 = new Class5975(Enum744.const_2, x.uint_1 - num2 + class5975_1.uint_1);
				Class5978.smethod_13(x.uint_2, num2, x.uint_1 - num2, class5975_1.uint_2, 0u, class5975_1.uint_1, class2.uint_2, 0u);
				uint uint_2 = ((x.uint_1 > num) ? num : x.uint_1);
				x.uint_1 = uint_2;
				x.method_8();
				Class5975 class3 = new Class5975(Enum744.const_2, num);
				Class5978.smethod_14(class2.uint_2, (int)num, (int)(class2.uint_1 - num), @class.uint_2, 0, (int)@class.uint_1, class3.uint_2, 0, (int)num);
				class3.method_8();
				if (smethod_26(class3, x))
				{
					Class5978.smethod_2(x, class3);
				}
				else
				{
					Class5975 class4 = new Class5975(Enum744.const_2, num + 1);
					class4.uint_2[num] = 1u;
					Class5978.smethod_2(class4, class3);
					Class5978.smethod_4(x, class4);
				}
				while (smethod_25(x, @class))
				{
					Class5978.smethod_2(x, @class);
				}
			}
		}

		internal Class5975 method_1(Class5975 a, Class5975 b)
		{
			if (!(a == 0u) && !(b == 0u))
			{
				if (a.uint_1 >= class5975_0.uint_1 << 1)
				{
					a = smethod_8(a, class5975_0);
				}
				if (b.uint_1 >= class5975_0.uint_1 << 1)
				{
					b = smethod_8(b, class5975_0);
				}
				if (a.uint_1 >= class5975_0.uint_1)
				{
					method_0(a);
				}
				if (b.uint_1 >= class5975_0.uint_1)
				{
					method_0(b);
				}
				Class5975 @class = new Class5975(smethod_11(a, b));
				method_0(@class);
				return @class;
			}
			return smethod_1(0);
		...
		internal Class5975 method_2(Class5975 a, Class5975 b)
		{
			Enum744 @enum = Class5978.Compare(a, b);
			Class5975 @class;
			switch (@enum)
			{
			default:
				throw new InvalidOperationException();
			case Enum744.const_0:
				@class = smethod_5(b, a);
				break;
			case Enum744.const_1:
				return smethod_1(0);
			case Enum744.const_2:
				@class = smethod_5(a, b);
				break;
			}
			if (smethod_25(@class, class5975_0))
			{
				if (@class.uint_1 >= class5975_0.uint_1 << 1)
				{
					@class = smethod_8(@class, class5975_0);
				}
				else
				{
					method_0(@class);
			...
			if (@enum == Enum744.const_0)
			{
				@class = smethod_5(class5975_0, @class);
			}
			return @class;
		}

		internal Class5975 method_3(Class5975 b, Class5975 exp)
		{
			if ((class5975_0.uint_2[0] & 1) == 1)
			{
		...
		internal Class5975 method_4(Class5975 b, Class5975 exp)
		{
			Class5975 @class = new Class5975(smethod_1(1), class5975_0.uint_1 << 1);
			Class5975 class2 = new Class5975(smethod_8(b, class5975_0), class5975_0.uint_1 << 1);
			uint num = (uint)exp.method_0();
			uint[] wkSpace = new uint[class5975_0.uint_1 << 1];
			uint num2 = 0u;
			while (true)
			{
				if (num2 < num)
				{
					if (exp.method_1(num2))
					{
						...
						Class5978.smethod_13(@class.uint_2, 0u, @class.uint_1, class2.uint_2, 0u, class2.uint_1, wkSpace, 0u);
					...
					Class5978.smethod_15(class2, ref wkSpace);
					method_0(class2);
					if (class2 == 1u)
					{
						break;
		...
		private Class5975 method_5(Class5975 b, Class5975 exp)
		{
			Class5975 @class = new Class5975(Class5977.smethod_1(smethod_1(1), class5975_0), class5975_0.uint_1 << 1);
			Class5975 class2 = new Class5975(Class5977.smethod_1(b, class5975_0), class5975_0.uint_1 << 1);
			uint mPrime = Class5977.smethod_0(class5975_0.uint_2[0]);
			uint num = (uint)exp.method_0();
			uint[] wkSpace = new uint[class5975_0.uint_1 << 1];
			for (uint num2 = 0u; num2 < num; num2++)
			{
				if (exp.method_1(num2))
				{
					...
					wkSpace = @class.uint_2;
					@class.uint_2 = uint_;
					Class5977.smethod_2(@class, class5975_0, mPrime);
				}
				Class5978.smethod_15(class2, ref wkSpace);
				Class5977.smethod_2(class2, class5975_0, mPrime);
			}
			Class5977.smethod_2(@class, class5975_0, mPrime);
			return @class;
		}

		internal Class5975 method_6(uint b, Class5975 exp)
		{
			if ((class5975_0.uint_2[0] & 1) == 1)
			{
		...
		private Class5975 method_7(uint b, Class5975 exp)
		{
			exp.method_8();
			uint[] wkSpace = new uint[class5975_0.uint_1 << 2];
			Class5975 bi = Class5977.smethod_1(smethod_0(b), class5975_0);
			bi = new Class5975(bi, class5975_0.uint_1 << 2);
			uint mPrime = Class5977.smethod_0(class5975_0.uint_2[0]);
			uint bitNum = (uint)(exp.method_0() - 2);
			do
			{
				Class5978.smethod_15(bi, ref wkSpace);
				bi = Class5977.smethod_2(bi, class5975_0, mPrime);
				...
				while (++num < bi.uint_1);
				if (bi.uint_1 < class5975_0.uint_1)
				{
					if (num2 != 0L)
					{
						uint_[num] = (uint)num2;
						bi.uint_1++;
						while (smethod_25(bi, class5975_0))
						{
							Class5978.smethod_2(bi, class5975_0);
						}
					}
				}
				else if (num2 != 0L)
				{
					uint num3 = (uint)num2;
					uint num4 = (uint)((class5975_0.uint_2[class5975_0.uint_1 - 1] >= uint.MaxValue) ? ((((ulong)num3 << 32) | uint_[num - 1]) / class5975_0.uint_2[class5975_0.uint_1 - 1]) : ((((ulong)num3 << 32) | uint_[num - 1]) / (class5975_0.uint_2[class5975_0.uint_1 - 1] + 1)));
					num = 0u;
					num2 = 0uL;
					do
					{
						num2 += (ulong)((long)class5975_0.uint_2[num] * (long)num4);
						uint num5 = uint_[num];
					...
					if (num3 != 0)
					{
						uint num6 = 0u;
						uint num7 = 0u;
						uint[] uint_2 = class5975_0.uint_2;
						do
						{
			...
			while (bitNum-- != 0);
			return Class5977.smethod_2(bi, class5975_0, mPrime);
		}

		private Class5975 method_8(uint b, Class5975 exp)
		{
			exp.method_8();
			uint[] wkSpace = new uint[class5975_0.uint_1 << 2];
			Class5975 @class = new Class5975(smethod_0(b), class5975_0.uint_1 << 2);
			uint bitNum = (uint)(exp.method_0() - 2);
			do
			{
				Class5978.smethod_15(@class, ref wkSpace);
				if (@class.uint_1 >= class5975_0.uint_1)
				{
					method_0(@class);
				}
				if (!exp.method_1(bitNum))
				...
				if (@class.uint_1 < class5975_0.uint_1)
				{
					if (num2 != 0L)
					{
						uint_[num] = (uint)num2;
						@class.uint_1++;
						while (smethod_25(@class, class5975_0))
						{
							Class5978.smethod_2(@class, class5975_0);
						}
					}
				}
				else if (num2 != 0L)
				{
					uint num3 = (uint)num2;
					uint num4 = (uint)((((ulong)num3 << 32) | uint_[num - 1]) / (class5975_0.uint_2[class5975_0.uint_1 - 1] + 1));
					num = 0u;
					num2 = 0uL;
					do
					{
	...
	private class Class5978
	{
		internal static Class5975 smethod_0(Class5975 bi1, Class5975 bi2)
		{
			uint num = 0u;
			uint[] uint_;
			uint uint_2;
			...
			Class5975 @class = new Class5975(Enum744.const_2, uint_2 + 1);
		...
		internal static Class5975 smethod_1(Class5975 big, Class5975 small)
		{
			Class5975 @class = new Class5975(Enum744.const_2, big.uint_1);
			uint[] uint_ = @class.uint_2;
		...
		internal static void smethod_2(Class5975 big, Class5975 small)
		{
		...
		private static void smethod_3(Class5975 big)
		{
		...
		internal static void smethod_4(Class5975 bi1, Class5975 bi2)
		{
			uint num = 0u;
			bool flag = false;
			uint[] uint_;
		...
		internal static Enum744 Compare(Class5975 bi1, Class5975 bi2)
		{
			uint num = bi1.uint_1;
			...
			if (num == 0 && num2 == 0)
			{
				return Enum744.const_1;
			}
			if (num < num2)
			{
				return Enum744.const_0;
			}
			if (num > num2)
			{
				return Enum744.const_2;
			}
			uint num3 = num - 1;
		...
		internal static uint smethod_5(Class5975 n, uint d)
		{
			ulong num = 0uL;
			uint uint_ = n.uint_1;
			while (uint_-- != 0)
		...
		internal static uint smethod_6(Class5975 n, uint d)
		{
			ulong num = 0uL;
			uint uint_ = n.uint_1;
			while (uint_-- != 0)
		...
		internal static Class5975 smethod_7(Class5975 n, uint d)
		{
			Class5975 @class = new Class5975(Enum744.const_2, n.uint_1);
			ulong num = 0uL;
			uint uint_ = n.uint_1;
			while (uint_-- != 0)
			{
		...
		internal static Class5975[] smethod_8(Class5975 n, uint d)
		{
			Class5975 @class = new Class5975(Enum744.const_2, n.uint_1);
			ulong num = 0uL;
			uint uint_ = n.uint_1;
			...
			@class.method_8();
			Class5975 class2 = Class5975.smethod_0((uint)num);
			return new Class5975[2] { @class, class2 };
		}

		internal static Class5975[] smethod_9(Class5975 bi1, Class5975 bi2)
		{
			if (Compare(bi1, bi2) == Enum744.const_0)
			{
				return new Class5975[2]
				{
					Class5975.smethod_1(0),
					new Class5975(bi1)
				};
			}
			bi1.method_8();
			...
			if (bi2.uint_1 == 1)
			{
				return smethod_8(bi1, bi2.uint_2[0]);
			}
			...
			Class5975 @class = new Class5975(Enum744.const_2, bi1.uint_1 - bi2.uint_1 + 1);
			Class5975 class2 = Class5975.smethod_13(bi1, num5);
			uint[] uint_ = class2.uint_2;
			bi2 = Class5975.smethod_13(bi2, num5);
			...
			@class.method_8();
			class2.method_8();
			Class5975[] array = new Class5975[2] { @class, class2 };
			if (num5 != 0)
			{
				Class5975[] array2;
				(array2 = array)[1] = Class5975.smethod_14(array2[1], num5);
			}
			return array;
		}

		internal static Class5975 smethod_10(Class5975 bi, int n)
		{
			if (n == 0)
			{
				return new Class5975(bi, bi.uint_1 + 1);
			}
			int num = n >> 5;
			n &= 0x1F;
			Class5975 @class = new Class5975(Enum744.const_2, bi.uint_1 + 1 + (uint)num);
			uint num2 = 0u;
		...
		internal static Class5975 smethod_11(Class5975 bi, int n)
		{
			if (n == 0)
			{
				return new Class5975(bi);
			}
			int num = n >> 5;
			int num2 = n & 0x1F;
			Class5975 @class = new Class5975(Enum744.const_2, (uint)((int)bi.uint_1 - num + 1));
		...
		internal static Class5975 smethod_12(Class5975 n, uint f)
		{
			Class5975 @class = new Class5975(Enum744.const_2, n.uint_1 + 1);
			uint num = 0u;
			ulong num2 = 0uL;
			do
			{
		...
		internal static void smethod_13(uint[] x, uint xOffset, uint xLen, uint[] y, uint yOffset, uint yLen, uint[] d, uint dOffset)
		{
			uint num = xOffset;
			uint num2 = num + xLen;
		...
		internal static void smethod_14(uint[] x, int xOffset, int xLen, uint[] y, int yOffest, int yLen, uint[] d, int dOffset, int mod)
		{
		...
		internal static void smethod_15(Class5975 bi, ref uint[] wkSpace)
		{
			uint[] array = wkSpace;
			wkSpace = bi.uint_2;
			uint[] uint_ = bi.uint_2;
		...
		internal static Class5975 smethod_16(Class5975 a, Class5975 b)
		{
			Class5975 @class = a;
			Class5975 class2 = b;
			Class5975 class3 = class2;
			while (@class.uint_1 > 1)
			{
				class3 = @class;
				@class = Class5975.smethod_8(class2, @class);
				class2 = class3;
			}
			if (@class == 0u)
			{
			...
			uint num2 = Class5975.smethod_7(class2, num);
			int num3 = 0;
			while (((num2 | num) & 1) == 0)
			{
				num2 >>= 1;
			...
			return Class5975.smethod_0(num << num3);
		}

		internal static uint smethod_17(Class5975 bi, uint modulus)
		{
			uint num = modulus;
			uint num2 = Class5975.smethod_7(bi, modulus);
			uint num3 = 0u;
			uint num4 = 1u;
			while (true)
			{
		...
		internal static Class5975 smethod_18(Class5975 bi, Class5975 modulus)
		{
			if (modulus.uint_1 == 1)
			{
				return Class5975.smethod_0(smethod_17(bi, modulus.uint_2[0]));
			}
			Class5975[] array = new Class5975[2]
			{
				Class5975.smethod_1(0),
				Class5975.smethod_1(1)
			};
			Class5975[] array2 = new Class5975[2];
			Class5975[] array3 = new Class5975[2]
			{
				Class5975.smethod_1(0),
				Class5975.smethod_1(0)
			};
			int num = 0;
			Class5975 bi2 = modulus;
			Class5975 @class = bi;
			Class5976 class2 = new Class5976(modulus);
			while (@class != 0u)
			{
				if (num > 1)
				{
					Class5975 class3 = class2.method_2(array[0], Class5975.smethod_11(array[1], array2[0]));
					array[0] = array[1];
					array[1] = class3;
				}
				Class5975[] array4 = smethod_9(bi2, @class);
				array2[0] = array2[1];
				array2[1] = array4[0];
				array3[0] = array3[1];
				array3[1] = array4[1];
			...
			return class2.method_2(array[0], Class5975.smethod_11(array[1], array2[0]));
		}
	}

	internal class Class5977
	{
		private Class5977()
		{
		}
		...
		internal static Class5975 smethod_1(Class5975 n, Class5975 m)
		{
			n.method_8();
			m.method_8();
		...
		internal static Class5975 smethod_2(Class5975 n, Class5975 m, uint mPrime)
		{
			uint[] uint_ = n.uint_2;
	...
	internal Class5975(Enum744 sign, uint len)
	{
		uint_2 = new uint[len];
		uint_1 = len;
	}

	public Class5975(Class5975 bi)
	{
		uint_2 = (uint[])bi.uint_2.Clone();
		uint_1 = bi.uint_1;
	}

	public Class5975(Class5975 bi, uint len)
	{
		uint_2 = new uint[len];
	...
	public Class5975(uint ui)
	{
		uint_2 = new uint[1] { ui };
	}

	public Class5975(ulong ul)
	{
		uint_2 = new uint[2]
		{
			(uint)ul,
	...
	[SpecialName]
	public static Class5975 smethod_0(uint value)
	{
		return new Class5975(value);
	}

	[SpecialName]
	public static Class5975 smethod_1(int value)
	{
		if (value < 0)
		{
			throw new ArgumentOutOfRangeException("value");
		}
		return new Class5975((uint)value);
	}

	[SpecialName]
	public static Class5975 smethod_2(ulong value)
	{
		return new Class5975(value);
	}

	internal static Class5975 smethod_3(string number)
	{
		if (number == null)
		{
		...
		bool flag = false;
		Class5975 @class = new Class5975(0u);
		if (number[0] == '+')
		{
			num++;
		}
		...
		{
			throw new ArgumentException("Operation would return a negative value");
		}
		while (true)
		{
			if (num < length)
	...
	[SpecialName]
	public static Class5975 smethod_4(Class5975 bi1, Class5975 bi2)
	{
		if (bi1 == 0u)
		{
			return new Class5975(bi2);
		}
		if (bi2 == 0u)
		{
			return new Class5975(bi1);
		}
		return Class5978.smethod_0(bi1, bi2);
	}

	[SpecialName]
	public static Class5975 smethod_5(Class5975 bi1, Class5975 bi2)
	{
		if (bi2 == 0u)
		{
			return new Class5975(bi1);
		...
		return Class5978.Compare(bi1, bi2) switch
		{
			Enum744.const_0 => throw new ArithmeticException("Operation would return a negative value"), 
			Enum744.const_1 => smethod_1(0), 
			Enum744.const_2 => Class5978.smethod_1(bi1, bi2), 
			_ => throw new InvalidOperationException(), 
		};
	}

	[SpecialName]
	public static int smethod_6(Class5975 bi, int i)
	{
		if (i > 0)
		{
			return (int)Class5978.smethod_6(bi, (uint)i);
		}
		return (int)(0 - Class5978.smethod_6(bi, (uint)(-i)));
	}

	[SpecialName]
	public static uint smethod_7(Class5975 bi, uint ui)
	{
		return Class5978.smethod_6(bi, ui);
	}

	[SpecialName]
	public static Class5975 smethod_8(Class5975 bi1, Class5975 bi2)
	{
		return Class5978.smethod_9(bi1, bi2)[1];
	}

	[SpecialName]
	public static Class5975 smethod_9(Class5975 bi, int i)
	{
		if (i <= 0)
		{
			throw new ArithmeticException("Operation would return a negative value");
		}
		return Class5978.smethod_7(bi, (uint)i);
	}

	[SpecialName]
	public static Class5975 smethod_10(Class5975 bi1, Class5975 bi2)
	{
		return Class5978.smethod_9(bi1, bi2)[0];
	}

	[SpecialName]
	public static Class5975 smethod_11(Class5975 bi1, Class5975 bi2)
	{
		if (!(bi1 == 0u) && !(bi2 == 0u))
		{
			...
			Class5975 @class = new Class5975(Enum744.const_2, bi1.uint_1 + bi2.uint_1);
			Class5978.smethod_13(bi1.uint_2, 0u, bi1.uint_1, bi2.uint_2, 0u, bi2.uint_1, @class.uint_2, 0u);
			@class.method_8();
			return @class;
		}
		return smethod_1(0);
	...
	[SpecialName]
	public static Class5975 smethod_12(Class5975 bi, int i)
	{
		if (i < 0)
		{
			throw new ArithmeticException("Operation would return a negative value");
		...
		return i switch
		{
			0 => smethod_1(0), 
			1 => new Class5975(bi), 
			_ => Class5978.smethod_12(bi, (uint)i), 
		};
	}

	[SpecialName]
	public static Class5975 smethod_13(Class5975 bi1, int shiftVal)
	{
		return Class5978.smethod_10(bi1, shiftVal);
	}

	[SpecialName]
	public static Class5975 smethod_14(Class5975 bi1, int shiftVal)
	{
		return Class5978.smethod_11(bi1, shiftVal);
	}

	internal static Class5975 Add(Class5975 bi1, Class5975 bi2)
	{
		return smethod_4(bi1, bi2);
	}

	internal static Class5975 smethod_15(Class5975 bi1, Class5975 bi2)
	{
		return smethod_5(bi1, bi2);
	}

	internal static int smethod_16(Class5975 bi, int i)
	{
		return smethod_6(bi, i);
	}

	internal static uint smethod_17(Class5975 bi, uint ui)
	{
		return smethod_7(bi, ui);
	}

	internal static Class5975 smethod_18(Class5975 bi1, Class5975 bi2)
	{
		return smethod_8(bi1, bi2);
	}

	internal static Class5975 smethod_19(Class5975 bi, int i)
	{
		return smethod_9(bi, i);
	}

	internal static Class5975 smethod_20(Class5975 bi1, Class5975 bi2)
	{
		return smethod_10(bi1, bi2);
	}

	internal static Class5975 smethod_21(Class5975 bi1, Class5975 bi2)
	{
		return smethod_11(bi1, bi2);
	}

	internal static Class5975 smethod_22(Class5975 bi, int i)
	{
	...
	public static bool operator ==(Class5975 bi1, uint ui)
	{
		if (bi1.uint_1 != 1)
		{
			bi1.method_8();
	...
	public static bool operator ==(Class5975 bi1, Class5975 bi2)
	{
		if ((object)bi1 == bi2)
		{
			return true;
		...
		{
			return Class5978.Compare(bi1, bi2) == Enum744.const_1;
		}
		return false;
	}
	...
	[SpecialName]
	public static bool smethod_23(Class5975 bi1, Class5975 bi2)
	{
		return Class5978.Compare(bi1, bi2) > Enum744.const_1;
	}

	[SpecialName]
	public static bool smethod_24(Class5975 bi1, Class5975 bi2)
	{
		return Class5978.Compare(bi1, bi2) < Enum744.const_1;
	}

	[SpecialName]
	public static bool smethod_25(Class5975 bi1, Class5975 bi2)
	{
		return Class5978.Compare(bi1, bi2) >= Enum744.const_1;
	}

	[SpecialName]
	public static bool smethod_26(Class5975 bi1, Class5975 bi2)
	{
		return Class5978.Compare(bi1, bi2) <= Enum744.const_1;
	}

	internal Enum744 Compare(Class5975 bi)
	{
		return Class5978.Compare(this, bi);
	}
	...
	internal string ToString(uint radix, string characterSet)
	{
		...
		Class5975 @class = new Class5975(this);
		while (@class != 0u)
		{
			uint index = Class5978.smethod_5(@class, radix);
	...
	public override bool Equals(object o)
	{
		...
		return Class5978.Compare(this, (Class5975)o) == Enum744.const_1;
	}

	internal Class5975 method_9(Class5975 bi)
	{
		return Class5978.smethod_16(this, bi);
	}

	internal Class5975 method_10(Class5975 modulus)
	{
		return Class5978.smethod_18(this, modulus);
	}

	internal Class5975 method_11(Class5975 exp, Class5975 n)
	{
		Class5976 @class = new Class5976(n);
