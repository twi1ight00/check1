...
internal class Class2286 : Class1351
{
	public delegate Class2286 Delegate2605();

	public delegate void Delegate2606(Class2286 elementData);

	public delegate void Delegate2607(Class2286 elementData);
	...
	public Class2286(XmlReader reader)
		: base(reader)
	{
	}
