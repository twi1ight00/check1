...
internal class Class1065
{
	...
	static Class1065()
	{
		...
		double_0 = Class1395.smethod_5(2.0);
		...
		hashtable_0.Add("psk:NorthAmericaTabloid", new SizeF(792f, 1224f));
		...
		hashtable_0.Add("psk:ISOC6Envelope", new SizeF(323.15f, 459.21f));
		hashtable_0.Add("psk:ISOC6C5Envelope", new SizeF(323.15f, 649.13f));
		hashtable_0.Add("psk:ISOC4Envelope", new SizeF(649.13f, 918.43f));
		hashtable_0.Add("psk:ISOC5Envelope", new SizeF(459.21f, 649.13f));
		hashtable_0.Add("psk:ISOSRA3", new SizeF(907.09f, 1275.59f));
		hashtable_0.Add("psk:ISOC3Envelope", new SizeF(918.43f, 1298.27f));
		...
		hashtable_0.Add("psk:NorthAmericaNote", new SizeF(612f, 792f));
		...
		hashtable_0.Add("psk:PRC10Envelope", new SizeF(918.43f, 1298.27f));
		hashtable_0.Add("psk:PRC16K", new SizeF(413.86f, 609.45f));
		hashtable_0.Add("psk:PRC32KBig", new SizeF(274.96f, 428.03f));
		hashtable_0.Add("psk:PRC9Envelope", new SizeF(649.13f, 918.43f));
		...
		hashtable_0.Add("psk:JapanYou2Envelope", new SizeF(323.15f, 459.21f));
	...
	internal static string smethod_0(SizeF sizeF_0)
	{
		foreach (object key in hashtable_0.Keys)
		{
			SizeF sizeF_ = (SizeF)hashtable_0[key];
			if (Class1015.smethod_17(sizeF_, sizeF_0, double_0))
			{
				return (string)key;
			}
		}
