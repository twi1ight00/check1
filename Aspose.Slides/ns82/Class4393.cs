...
internal class Class4393 : Interface86
{
	...
	public Class4393(int type)
	{
		int_0 = type;
	}

	public Class4393(Interface86 oldToken)
	{
	...
	public Class4393(int type, string text)
	{
		int_0 = type;
		string_0 = text;
	}

	public Class4393(int type, string text, int channel)
	{
		int_0 = type;
		string_0 = text;
		int_3 = channel;
