...
internal struct Struct39
{
	internal static void smethod_0(Class787 class787_0)
	{
		...
		{
			if (item.method_11().Count == 0)
			{
				continue;
			}
			Class789 categoryAxis = ((!item.PlotOnSecondAxis) ? class787_0.method_1() : class787_0.method_2());
			for (int i = 0; i < item.method_11().Count; i++)
			{
				smethod_12(item, categoryAxis, out var y, out var x);
				double R = 0.0;
				Class815 class3 = item.method_11().method_1(i);
				if (class3.method_0().IsVisible && x.Length >= 2 && y.Length >= 2)
				{
					switch (class3.Type)
					{
					case Enum88.const_0:
	...
	internal static void smethod_1(Interface42 interface42_0, Class810 class810_0, Rectangle rectangle_0, float float_0, double double_0)
	{
		if (Struct40.smethod_19(rectangle_0))
		{
			return;
		}
		for (int i = 0; i < class810_0.method_11().Count; i++)
		{
			Class815 @class = class810_0.method_11().method_1(i);
			if (@class.method_0().IsVisible && smethod_14(@class.method_4()))
			{
				switch (@class.Type)
				{
				case Enum88.const_1:
					smethod_2(interface42_0, class810_0, rectangle_0, float_0, double_0, @class);
					break;
				case Enum88.const_3:
					smethod_4(interface42_0, class810_0, rectangle_0, float_0, double_0, @class);
					break;
				case Enum88.const_0:
				case Enum88.const_2:
				case Enum88.const_4:
				case Enum88.const_5:
					smethod_3(interface42_0, class810_0, rectangle_0, float_0, double_0, @class);
					break;
				}
			}
		}
	...
	private static void smethod_2(Interface42 interface42_0, Class810 class810_0, Rectangle rectangle_0, float float_0, double double_0, Class815 class815_0)
	{
		if (class815_0.method_0().IsVisible)
		{
			...
			smethod_13(class810_0, class815_0, out var minValue, out var maxValue);
			...
			double num3 = 0.0;
			double num4 = (@class.IsLogarithmic ? Struct40.smethod_7(@class.MajorUnit) : @class.MajorUnit);
			double num5 = (@class.IsLogarithmic ? Struct40.smethod_7(@class.MaxValue) : @class.MaxValue);
			double num6 = (@class.IsLogarithmic ? Struct40.smethod_7(@class.MinValue) : @class.MinValue);
			if (@class.CategoryType == Enum64.const_2)
			{
				num4 = Struct19.smethod_31(Enum87.const_0, @class.MajorUnitScale, (int)@class.MajorUnit, 0, class810_0.Chart.vmethod_0());
			}
			double num7;
			double num8;
			...
			double num12 = smethod_10(class815_0, minValue);
			...
			double num16 = smethod_10(class815_0, maxValue);
			double num17 = (num16 - double_0) / (num2 - num) * (double)rectangle_0.Height;
			num15 = (class2.IsPlotOrderReversed ? (num15 + num17) : (num15 - num17));
			Struct29.smethod_0(interface42_0, (float)num10, (float)num11, (float)num14, (float)num15, class815_0.method_0());
			class815_0.pointF_0 = new PointF((float)num14, (float)num15);
		}
	}

	private static void smethod_3(Interface42 interface42_0, Class810 class810_0, Rectangle rectangle_0, float float_0, double double_0, Class815 class815_0)
	{
		if (class815_0.method_0().IsVisible)
		{
			Class787 chart = class810_0.Chart;
			...
			for (double num10 = num8; num10 <= num9; num10 += num7)
			{
				...
				double num13 = smethod_10(class815_0, num10);
			...
			smethod_11(interface42_0, list, class815_0, bool_0: true);
			if (list.Count > 0)
			{
				class815_0.pointF_0 = (PointF)list[list.Count - 1];
			}
		}
	}

	private static void smethod_4(Interface42 interface42_0, Class810 class810_0, Rectangle rectangle_0, float float_0, double double_0, Class815 class815_0)
	{
		if (!class815_0.method_0().IsVisible)
		{
			return;
		...
		double num2 = (class2.IsLogarithmic ? Struct40.smethod_7(class2.MaxValue) : class2.MaxValue);
		double_0 = (class2.IsLogarithmic ? Struct40.smethod_7(double_0) : double_0);
		smethod_13(class810_0, class815_0, out var _, out var _);
		double num3 = 0.0;
		double num4 = (@class.IsLogarithmic ? Struct40.smethod_7(@class.MajorUnit) : @class.MajorUnit);
		double num5 = (@class.IsLogarithmic ? Struct40.smethod_7(@class.MaxValue) : @class.MaxValue);
		double num6 = (@class.IsLogarithmic ? Struct40.smethod_7(@class.MinValue) : @class.MinValue);
		...
		for (int i = class815_0.Period - 1; i < arrayList.Count; i++)
		{
			Class796 class4 = (Class796)arrayList[i];
			if (!smethod_9(i, class815_0.Period, arrayList, out var average))
			{
		...
		smethod_11(interface42_0, list, class815_0, bool_0: false);
	}

	internal static void smethod_5(Interface42 interface42_0, Class810 class810_0, Rectangle rectangle_0, float float_0, double double_0)
	{
		if (Struct40.smethod_19(rectangle_0))
		{
			return;
		...
		for (int i = 0; i < class810_0.method_11().Count; i++)
		{
			...
			if (@class.method_0().IsVisible && smethod_14(@class.method_4()))
			{
				...
				{
				case Enum88.const_1:
					smethod_6(interface42_0, class810_0, rectangle_0, float_0, double_0, @class);
					break;
				case Enum88.const_3:
					smethod_8(interface42_0, class810_0, rectangle_0, float_0, double_0, @class);
					break;
				case Enum88.const_0:
				case Enum88.const_2:
				case Enum88.const_4:
				case Enum88.const_5:
					smethod_7(interface42_0, class810_0, rectangle_0, float_0, double_0, @class);
					break;
				}
			}
		}
	...
	private static void smethod_6(Interface42 interface42_0, Class810 class810_0, Rectangle rectangle_0, float float_0, double double_0, Class815 class815_0)
	{
		if (class815_0.method_0().IsVisible)
		{
			Class787 chart = class810_0.Chart;
			...
			num15 = (class2.IsPlotOrderReversed ? (num15 - num17) : (num15 + num17));
			Struct29.smethod_0(interface42_0, (float)num11, (float)num10, (float)num15, (float)num14, class815_0.method_0());
			class815_0.pointF_0 = new PointF((float)num15, (float)num14);
		}
	}

	private static void smethod_7(Interface42 interface42_0, Class810 class810_0, Rectangle rectangle_0, float float_0, double double_0, Class815 class815_0)
	{
		if (class815_0.method_0().IsVisible)
		{
			Class787 chart = class810_0.Chart;
			...
			for (double num8 = minValue; num8 <= maxValue; num8 += num7)
			{
				...
				double num11 = smethod_10(class815_0, num8);
	...
	private static void smethod_8(Interface42 interface42_0, Class810 class810_0, Rectangle rectangle_0, float float_0, double double_0, Class815 class815_0)
	{
		if (!class815_0.method_0().IsVisible)
		{
			return;
	...
	private static bool smethod_9(int pointIndex, int period, ArrayList points, out double average)
	{
		...
		{
			Class796 @class = (Class796)points[i];
	...
	private static double smethod_10(Class815 class815_0, double double_0)
	{
		double[] array = class815_0.method_4();
		switch (class815_0.Type)
		{
		case Enum88.const_0:
	...
	internal static void smethod_11(Interface42 interface42_0, IList ilist_0, Class815 class815_0, bool bool_0)
	{
		...
		using Pen pen_ = Struct29.smethod_5(class815_0.method_0());
		if (bool_0)
		{
			interface42_0.imethod_6(pen_, array);
		}
		else
		{
			interface42_0.imethod_17(pen_, array);
		}
	}

	private static void smethod_12(Class810 aSeries, Class789 categoryAxis, out double[] y, out double[] x)
	{
		double num = 2147483647.0;
		for (int i = 0; i < aSeries.method_10().Count; i++)
		{
			Class796 @class = aSeries.method_10().method_1(i);
			if (@class != null && !@class.imethod_0() && !@class.imethod_2() && @class.XValue < num)
			{
				num = @class.XValue;
			}
		}
		int num2 = aSeries.method_10().Count;
		for (int j = 0; j < aSeries.method_10().Count; j++)
		{
			Class796 class2 = aSeries.method_10().method_1(j);
		...
		x = new double[num2];
		int num3 = 0;
		for (int k = 0; k < aSeries.method_10().Count; k++)
		{
			Class796 class3 = aSeries.method_10().method_1(k);
	...
	private static void smethod_13(Class810 series, Class815 trendLine, out double minValue, out double maxValue)
	{
		minValue = 2147483647.0;
		maxValue = -2147483648.0;
		Class795 @class = series.method_10();
		bool flag = true;
	...
	internal static void smethod_20(Interface42 interface42_0, Class810 class810_0)
	{
		bool flag = false;
		if (class810_0.method_22() == ChartType_Chart.Bar || class810_0.method_22() == ChartType_Chart.BarStacked || class810_0.method_22() == ChartType_Chart.Bar100PercentStacked)
		{
			flag = true;
		}
		for (int i = 0; i < class810_0.method_11().Count; i++)
		{
			...
			if (@class.DataLabels.Text == null)
			{
				...
				if (@class.DisplayEquation)
				{
					...
					string[] array2 = smethod_22(class810_0.Chart, @class.method_4(), @class);
					switch (@class.Type)
					{
					case Enum88.const_0:
						text = "y = ";
				...
				if (@class.DisplayRSquared)
				{
					...
					bool flag2 = true;
					string text2 = "0.0000";
					if (@class.DataLabels.imethod_2() != "")
					{
						text2 = @class.DataLabels.imethod_2();
						flag2 = false;
					...
					text = " = ";
					string text3 = Struct65.smethod_0(class810_0.Chart.vmethod_2(), @class.method_6(), text2);
					if (flag2)
					{
				...
				Class798 class2 = @class.method_3();
				Font font_ = new Font(class2.imethod_0().Font.FontFamily, class2.imethod_0().Font.Size * 0.7f);
				SizeF sizeF = new SizeF(0f, 0f);
				if (arrayList.Count > 0)
				{
					if (arrayList.Count == 1)
					{
						sizeF = Struct37.smethod_6(interface42_0, text4, class2.imethod_0().Font);
					}
					else
					{
						string string_ = (string)arrayList[0];
						SizeF sizeF2 = Struct37.smethod_6(interface42_0, string_, class2.imethod_0().Font);
						sizeF.Width += sizeF2.Width;
						sizeF.Height += sizeF2.Height;
						string string_2 = (string)arrayList[1];
						SizeF sizeF3 = Struct37.smethod_6(interface42_0, string_2, font_);
						sizeF.Width += sizeF3.Width;
						if (arrayList.Count > 2)
						{
							string string_3 = (string)arrayList[2];
							SizeF sizeF4 = Struct37.smethod_6(interface42_0, string_3, class2.imethod_0().Font);
				...
				if (arrayList2.Count > 0)
				{
					...
					SizeF sizeF6 = Struct37.smethod_6(interface42_0, string_4, class2.imethod_0().Font);
					sizeF5.Width += sizeF6.Width;
					sizeF5.Height += sizeF6.Height;
					string string_5 = (string)arrayList2[1];
					SizeF sizeF7 = Struct37.smethod_6(interface42_0, string_5, font_);
					sizeF5.Width += sizeF7.Width;
					string string_6 = (string)arrayList2[2];
					SizeF sizeF8 = Struct37.smethod_6(interface42_0, string_6, class2.imethod_0().Font);
				...
				RectangleF rectangleF_ = Class1181.smethod_5(Class1181.smethod_4(class2.method_0().rectangle_0));
				Struct26.smethod_3(ref rectangleF_, @class.Chart);
				RectangleF rectangleF_2 = Class1181.smethod_3(rectangleF_);
				rectangleF_2.Inflate(2f, 4f);
				Struct18.smethod_0(interface42_0, rectangleF_2, class2.method_0().method_1());
				Struct29.smethod_2(interface42_0, rectangleF_2, class2.method_0().method_2());
				...
				if (arrayList.Count > 0)
				{
					...
					else
					{
						...
						SizeF sizeF9 = Struct37.smethod_6(interface42_0, string_7, class2.method_0().Font);
						...
						if (arrayList.Count > 2)
						{
							SizeF sizeF10 = Struct37.smethod_6(interface42_0, string_8, font_);
				...
				if (arrayList2.Count > 0)
				{
					...
					SizeF sizeF11 = Struct37.smethod_6(interface42_0, string_10, class2.method_0().Font);
					...
					{
						SizeF sizeF12 = Struct37.smethod_6(interface42_0, string_11, font_);
			...
			text = @class.DataLabels.Text;
			if (@class.method_3().method_2())
			{
				Class798 class3 = @class.method_3();
				new SizeF(@class.Chart.Width, @class.Chart.Height);
			...
			{
				Class798 class4 = @class.method_3();
				Size size2 = Struct37.smethod_0(sizeF_0: new SizeF(@class.Chart.Width, @class.Chart.Height), interface42_0: interface42_0, string_0: text, int_0: class4.Rotation, font_0: class4.method_0().Font, enum82_0: class4.TextHorizontalAlignment, enum82_1: class4.TextVerticalAlignment);
				...
				Struct26.smethod_3(ref rectangleF_4, @class.Chart);
				RectangleF rectangleF_5 = rectangleF_4;
				rectangleF_5.Inflate(0f, 4f);
				Struct18.smethod_0(interface42_0, rectangleF_5, class4.method_0().method_1());
				Struct29.smethod_2(interface42_0, rectangleF_5, class4.method_0().method_2());
				Struct26.smethod_13(interface42_0, class4, Rectangle.Round(rectangleF_4), text, class4.Rotation, class4.method_0().Font, class4.method_0().FontColor, class4.TextHorizontalAlignment, class4.TextVerticalAlignment);
			}
		}
	}

	private static void smethod_21(Interface42 interface42_0, RectangleF rectangleF_0, Class798 class798_0)
	{
		Class863 @class = new Class863();
		@class.TextHorizontalAlignment = Struct37.smethod_8(class798_0.TextHorizontalAlignment);
		@class.TextVerticalAlignment = Struct37.smethod_8(class798_0.TextVerticalAlignment);
		Class866 class2 = new Class866(rectangleF_0, @class, class798_0.imethod_4(), class798_0.method_0().Font);
		class2.method_0(interface42_0);
	}

	private static string[] smethod_22(Class787 class787_0, double[] double_0, Class815 class815_0)
	{
		bool flag = true;
		string text = "0.0000";
		if (class815_0.DataLabels.imethod_2() != "")
		{
			text = class815_0.DataLabels.imethod_2();
			flag = false;
		...
		{
			array[i] = Struct65.smethod_0(class787_0.vmethod_2(), Math.Abs(double_0[i]), text);
			if (!flag)
			{
				continue;
			}
