...
internal class Class234 : Class160
{
	internal Class234(Interface42 interface42_1, float float_5, float float_6, Class913 class913_1)
	...
	internal override GraphicsPath vmethod_0(RectangleF rectangleF_0)
	{
		...
		graphicsPath.AddLine(x + num + num9, y + num3 + num11, x + num2 + num9, y + num4 + num11);
		graphicsPath.StartFigure();
		graphicsPath.AddLine(x + num + num9, y + y + num11, x + num + num9, y + height + num11);
		return graphicsPath;
	}
