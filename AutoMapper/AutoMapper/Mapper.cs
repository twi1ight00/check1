...
{
	private static readonly Func<ConfigurationStore> _configurationInit = delegate
	{
		IPlatformSpecificMapperRegistry platformSpecificMapperRegistry = PlatformAdapter.Resolve<IPlatformSpecificMapperRegistry>();
		platformSpecificMapperRegistry.Initialize();
	...
	public static bool AllowNullDestinationValues
	{
		get
		{
			return Configuration.AllowNullDestinationValues;
		}
		set
		{
