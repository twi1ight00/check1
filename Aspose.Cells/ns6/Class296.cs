...
internal class Class296 : Class160
{
	internal Class296(Interface42 interface42_1, float float_5, float float_6, Class913 class913_1)
	...
	internal override GraphicsPath vmethod_0(RectangleF rectangleF_0)
	{
		...
		for (int i = 0; i < 10; i++)
		{
			...
			reference = new PointF((int)((double)(x + width / 2f) + Math.Cos(Struct70.smethod_0(18 + i * 36)) * (double)width / 2.0), (int)((double)(y + height / 2f) + (0.0 - Math.Sin(Struct70.smethod_0(18 + i * 36))) * (double)height / 2.0));
			ref PointF reference2 = ref array[2];
			reference2 = new PointF((int)((double)(x + width / 2f) + Math.Cos(Struct70.smethod_0(18 + (i + 1) * 36)) * (double)width / 2.0), (int)((double)(y + height / 2f) + (0.0 - Math.Sin(Struct70.smethod_0(18 + (i + 1) * 36))) * (double)height / 2.0));
			ref PointF reference3 = ref array[1];
			reference3 = new PointF((int)((double)(x + width / 2f) + Math.Cos(Struct70.smethod_0(36 + i * 36)) * (double)num10 / 2.0), (int)((double)(y + height / 2f) + (0.0 - Math.Sin(Struct70.smethod_0(36 + i * 36))) * (double)num9 / 2.0));
