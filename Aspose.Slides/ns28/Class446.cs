...
internal class Class446 : Class369
{
	internal static readonly string string_0 = "last-column";
	...
	public Class446(string prefix, string localName, string namespaceURI, XmlDocument doc)
