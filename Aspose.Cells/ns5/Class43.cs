...
internal class Class43 : Class18
{
	...
	private static readonly ushort[] ushort_0 = new ushort[2] { 4, 32768 };

	private static readonly Point[] point_1 = new Point[0];

	private static readonly Struct14[] struct14_0 = new Struct14[2]
	{
		new Struct14(8192, 327, 0, 0),
		new Struct14(8192, 328, 0, 0)
	};

	private int[] int_0 = new int[2] { 10800, 10800 };

	internal Class43(Interface42 interface42_1, float float_5, float float_6, Class898 class898_1)
	...
	internal override void vmethod_3()
	{
		...
		Class14 class2 = new Class14(Enum6.const_140, num, num2, num3, num4, class898_0.Line.ForeColor, class898_0.Line.Weight, class898_0.Fill.method_2(), class15_);
