...
internal class Class7546 : Class7457
{
	internal static readonly Type type_0 = typeof(Class5861);
	...
	{
		Class5861 @class = (Class5861)instance.Value;
		switch (function)
		{
		case "get_{default}":
			return method_6(@class.Value);
		case "set_{default}":
			@class.Value = parameters[0].vmethod_2();
			break;
		case "get_use":
