...
internal class Class1255
{
	...
	internal Class1255(WorksheetCollection worksheetCollection_1)
	{
	...
	internal string method_1(Cell cell_0)
	{
		int num = 2;
		...
		if (array[2] == 1)
		{
			...
			byte b = array[num + 3];
			Cell cell = cell_0.method_4().GetCell(num2, b, bool_2: false);
			if (cell.method_50() != null)
			{
				return method_3(-1, -1, cell.method_50().Formula, cell_0.Row, cell_0.Column, !cell.method_50().method_1());
			}
			return null;
		}
		return method_2(-1, array, cell_0.Row, cell_0.Column, bool_0: false);
	}

	internal string method_2(int int_2, byte[] byte_0, int int_3, int int_4, bool bool_0)
	{
		return method_3(int_2, -1, byte_0, int_3, int_4, bool_0);
	}

	internal string method_3(int int_2, int int_3, byte[] byte_0, int int_4, int int_5, bool bool_0)
	{
		if (int_3 != -1)
		{
			int_0 = int_3;
		...
		while (int_2 < byte_0.Length && (int_1 == 0 || int_2 < num))
		{
			switch (byte_0[int_2])
			{
			case 3:
			...
			case 23:
			{
				...
				{
					@string = Encoding.Unicode.GetString(byte_0, int_2 + 2, 2 * b);
					int_2 += 2 * b + 2;
				}
				arrayList.Add(stringBuilder_0.Length);
				stringBuilder_0.Append("\"");
			...
			case 25:
				int_2++;
				method_5(byte_0, ref int_2, arrayList);
				break;
			case 28:
				arrayList.Add(stringBuilder_0.Length);
				int_2++;
			...
			case 30:
			{
				ushort num4 = BitConverter.ToUInt16(byte_0, int_2 + 1);
				arrayList.Add(stringBuilder_0.Length);
			...
			case 31:
			{
				double num3 = BitConverter.ToDouble(byte_0, int_2 + 1);
				arrayList.Add(stringBuilder_0.Length);
				if (!(num3 >= 1E+21) && Math.Abs(num3) > 1E-21)
				{
					stringBuilder_0.Append(num3.ToString("0.##################################", CultureInfo.InvariantCulture));
				}
				else
				{
			...
			case 97:
				int_2++;
				method_10(byte_0, int_2, arrayList);
				int_2 += 2;
				break;
			case 34:
			case 66:
			...
			case 100:
				arrayList.Add(stringBuilder_0.Length);
				int_2++;
				stringBuilder_0.Append(GetCell(byte_0, int_2, int_4, int_5));
				int_2 += 4;
				break;
			case 37:
			case 69:
			case 101:
				arrayList.Add(stringBuilder_0.Length);
				int_2++;
				stringBuilder_0.Append(GetCellArea(byte_0, int_2, int_4, int_5, bool_0));
				int_2 += 8;
				break;
			case 38:
			case 70:
			...
			case 108:
				arrayList.Add(stringBuilder_0.Length);
				int_2++;
				stringBuilder_0.Append(method_6(byte_0, int_2, int_2 + 2, int_4, int_5));
				int_2 += 4;
				break;
			case 45:
			case 77:
			case 109:
				arrayList.Add(stringBuilder_0.Length);
				int_2++;
				stringBuilder_0.Append(method_7(byte_0, int_2, int_4, int_5));
				int_2 += 8;
				break;
			case 57:
			case 89:
			case 121:
			{
				...
				int_2 += 2;
				int num6 = BitConverter.ToUInt16(byte_0, int_2);
				if (@class == null)
				{
			...
			case 122:
			{
				...
				int_2++;
				int num2 = BitConverter.ToUInt16(byte_0, int_2);
				string text = Class932.smethod_0(num2, worksheetCollection_0, 0, null);
	...
	private void method_4(byte[] byte_0, ArrayList arrayList_0)
	{
		...
		for (int i = 0; i < num2; i++)
		{
			for (int j = 0; j < num; j++)
			{
				...
				case 4:
					stringBuilder_0.Append((byte_0[int_1 + 1] == 1) ? "TRUE" : "FALSE");
					if (j != num - 1)
					{
						stringBuilder_0.Append(',');
					}
	...
	private void method_5(byte[] byte_0, ref int int_2, ArrayList arrayList_0)
	{
		switch (byte_0[int_2])
		{
		case 16:
	...
	private string GetCellArea(byte[] byte_0, int int_2, int int_3, int int_4, bool bool_0)
	{
		int num = BitConverter.ToUInt16(byte_0, int_2);
		int num2 = BitConverter.ToUInt16(byte_0, int_2 + 2);
		int num3 = byte_0[int_2 + 4];
		int num4 = byte_0[int_2 + 6];
		StringBuilder stringBuilder = new StringBuilder();
		bool flag = true;
		bool flag2 = true;
		bool flag3 = true;
		bool flag4 = true;
		if ((byte_0[int_2 + 5] & 0x80u) != 0)
		{
			flag = false;
		}
		if ((byte_0[int_2 + 5] & 0x40u) != 0)
		{
			flag2 = false;
		}
		if ((byte_0[int_2 + 7] & 0x80u) != 0)
		{
			flag3 = false;
		}
		if ((byte_0[int_2 + 7] & 0x40u) != 0)
		{
			flag4 = false;
		}
		if (num == 0 && num2 == 65535)
		{
			...
			else if (num3 - int_4 != 0)
			{
				stringBuilder.Append('[');
				stringBuilder.Append(num3 - int_4);
				stringBuilder.Append(']');
			}
			stringBuilder.Append(':');
			stringBuilder.Append('C');
			...
			else if (num4 - int_4 != 0)
			{
				stringBuilder.Append('[');
				stringBuilder.Append(num4 - int_4);
				stringBuilder.Append(']');
			}
		}
		else if (num3 == 0 && num4 == 255)
		{
			...
			{
				stringBuilder.Append('[');
				stringBuilder.Append(num - int_3);
				stringBuilder.Append(']');
			}
			stringBuilder.Append(':');
			stringBuilder.Append('R');
			...
			else if (num2 - int_3 != 0)
			{
				stringBuilder.Append('[');
				stringBuilder.Append(num2 - int_3);
				stringBuilder.Append(']');
			}
		}
		else
	...
	private string method_6(byte[] byte_0, int int_2, int int_3, int int_4, int int_5)
	{
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.Append('R');
		if ((byte_0[int_3 + 1] & 0x80) == 0)
		{
			stringBuilder.Append(BitConverter.ToUInt16(byte_0, int_2) + 1);
		}
		else
		{
			stringBuilder.Append('[');
		...
		stringBuilder.Append('C');
		if ((byte_0[int_3 + 1] & 0x40) == 0)
		{
			stringBuilder.Append(byte_0[int_3] + 1);
		}
		else
		{
			int num2 = byte_0[int_3];
			if (num2 + int_5 > 255)
			{
				num2 = num2 - 255 - 1;
			}
	...
	private string method_7(byte[] byte_0, int int_2, int int_3, int int_4)
	{
		int num = BitConverter.ToUInt16(byte_0, int_2);
		int num2 = BitConverter.ToUInt16(byte_0, int_2 + 2);
		int num3 = byte_0[int_2 + 4];
		...
		if (flag2 && flag4)
		{
			if (num3 == 0 && num4 == 255)
			{
				...
				{
					stringBuilder.Append('[');
					stringBuilder.Append(BitConverter.ToInt16(byte_0, int_2));
					stringBuilder.Append(']');
				}
				stringBuilder.Append(':');
				stringBuilder.Append('R');
				...
				{
					stringBuilder.Append('[');
					stringBuilder.Append(BitConverter.ToInt16(byte_0, int_2 + 2));
					stringBuilder.Append(']');
				}
				return stringBuilder.ToString();
			}
		}
		else if (flag && flag3 && num == 0 && num2 == 65535)
		{
			stringBuilder.Append('C');
			if (flag2)
			{
		...
		stringBuilder.Append(method_6(byte_0, int_2, int_2 + 4, int_3, int_4));
		stringBuilder.Append(':');
		stringBuilder.Append(method_6(byte_0, int_2 + 2, int_2 + 6, int_3, int_4));
		return stringBuilder.ToString();
	}

	private string GetCell(byte[] byte_0, int int_2, int int_3, int int_4)
	{
		ushort num = BitConverter.ToUInt16(byte_0, int_2);
		byte b = byte_0[int_2 + 2];
		bool flag = true;
		bool flag2 = true;
		byte b2 = byte_0[int_2 + 3];
		if ((b2 & 0x40u) != 0)
		{
			flag2 = false;
		}
	...
	private void method_9(byte[] byte_0, int int_2, ArrayList arrayList_0)
	{
		...
		if (num == 255)
		{
			method_8(byte_0, int_2, arrayList_0);
			return;
		}
		int index;
	...
	private void method_10(byte[] byte_0, int int_2, ArrayList arrayList_0)
	{
		ushort num = BitConverter.ToUInt16(byte_0, int_2);
		switch (num)
		{
