...
internal class Class1929 : Class1351
{
	public delegate Class1929 Delegate1654();

	public delegate void Delegate1655(Class1929 elementData);

	public delegate void Delegate1656(Class1929 elementData);
	...
	public Class1929(XmlReader reader)
		: base(reader)
	{
	}
