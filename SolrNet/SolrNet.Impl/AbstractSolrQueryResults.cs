...
public abstract class AbstractSolrQueryResults<T> : List<T>
{
	...
	/// Only present if explicitly requested through <see cref="P:SolrNet.Commands.Parameters.CommonQueryOptions.StartOrCursor" />
	/// </summary>
	...
	{
		Switch(query.ToFunc(), moreLikeThis.ToFunc());
	}
}
