...
internal class Class4093 : Interface86
{
	...
	public virtual Interface110 InputStream
	{
		get
		{
	...
	public virtual string Text
	{
		get
		{
			...
			string_0 = interface110_0.imethod_9(int_5, int_6);
			return string_0;
		}
		set
		{
	...
	public Class4093(int type)
	{
		int_0 = type;
	}

	public Class4093(Interface110 input, int type, int channel, int start, int stop)
	{
	...
	public Class4093(int type, string text)
	{
		int_0 = type;
		int_3 = 0;
		string_0 = text;
	...
	public Class4093(Interface86 oldToken)
	{
		...
		if (oldToken is Class4093 @class)
		{
			int_5 = @class.int_5;
			int_6 = @class.int_6;
		}
