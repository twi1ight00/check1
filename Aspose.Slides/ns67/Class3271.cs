...
internal class Class3271 : Class3091
{
	...
	public override Enum493 Kind => Enum493.const_60;

	public Class3271(Class3448 xfrm)
		: base(xfrm)
	{
	}
	...
	public override Class3279 vmethod_1()
	{
		...
		double z3 = Class3089.smethod_1(50000.0, base.Transform2D.Extents.Cy, Math.Min(base.Transform2D.Extents.Cy, base.Transform2D.Extents.Cx));
		double num2 = Class3089.smethod_0(0.0, base.AdjustValues["adj3"], z3);
		double z4 = Class3089.smethod_1(num2, Math.Min(base.Transform2D.Extents.Cy, base.Transform2D.Extents.Cx), base.Transform2D.Extents.Cy / 2.0);
		...
		double y3 = Class3089.smethod_2(base.Transform2D.Extents.Cy, 0.0, num5);
		double num6 = Class3089.smethod_1(base.Transform2D.Extents.Cy, y2, 200000.0);
		...
		@class.method_4(x2, num8);
		@class.method_4(0.0, num8);
		@class.method_8();
		@class.TextRectangle = new Class3457(0.0, num7, base.Transform2D.Extents.Cx, num8);
		return @class;
	}
