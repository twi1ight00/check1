...
public class Row
{
	...
	internal Row(XmlDocument _0002, XmlNode _0003, int _0005)
	{
		this._0002 = _0002;
		this._0005 = _0005;
		this._0003 = this._0002.CreateElement(_0005_2000._0002(1402789522));
	...
	public void SetHeight(float RowHeight, WdRowHeightRule HeightRule)
	{
		XmlAttribute xmlAttribute = _0002.CreateAttribute(_0005_2000._0002(1402772616));
		xmlAttribute.InnerText = RowHeight.ToString();
		_0003.Attributes.Append(xmlAttribute);
		xmlAttribute = _0002.CreateAttribute(_0005_2000._0002(1402787929));
