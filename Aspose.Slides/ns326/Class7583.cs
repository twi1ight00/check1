...
internal class Class7583 : Class7456
{
	private static readonly Type type_0 = typeof(Interface76);
	...
	public override void Initialize()
	{
		...
		method_11("ownerRule", Enum983.flag_0);
		method_11("cssRules", Enum983.flag_0);
	}

	protected override Class7397 vmethod_1(string function, Class7397 instance, Class7397[] parameters)
	{
		Interface76 @interface = (Interface76)instance.Value;
		switch (function)
		{
		case "get_cssRules":
			return method_2(@interface.CSSRules, typeof(Interface73));
		case "get_ownerRule":
			return method_2(@interface.OwnerRule, typeof(Interface59));
		case "deleteRule":
