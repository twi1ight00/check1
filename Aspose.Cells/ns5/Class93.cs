...
internal class Class93 : Class18
{
	internal Class93(Interface42 interface42_1, float float_5, float float_6, Class898 class898_1)
	...
	internal override GraphicsPath vmethod_0(RectangleF rectangleF_0)
	{
		...
		float num = 0f;
		num = ((class898_0.class885_0.arrayList_0.Count <= 0) ? (width - width * 0.73583335f) : (width - width * (Convert.ToSingle(((Class882)class898_0.class885_0.arrayList_0[0]).Value) / 21600f)));
