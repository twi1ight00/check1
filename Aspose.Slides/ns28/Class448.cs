...
internal class Class448 : Class369
{
	internal static readonly string string_0 = "odd-columns";
	...
	public Class448(string prefix, string localName, string namespaceURI, XmlDocument doc)
