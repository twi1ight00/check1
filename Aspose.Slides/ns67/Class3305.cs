...
internal class Class3305 : Class3290
{
	private const string string_0 = "adj";

	public override Enum496 ShapeType => Enum496.const_29;

	public override Class3280 vmethod_1()
	{
		Class3305 @class = new Class3305();
	...
	internal override Class3340 vmethod_3()
	{
		...
		@class.method_8(new Struct159(base.Transform2D.Extents.Cx / 2.0, 0.0), new Struct159(base.Transform2D.Extents.Cx, y2));
		@class.method_4();
