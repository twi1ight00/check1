...
internal class Class5019 : Class5003
{
	...
	public override Class5024 imethod_2(Class5024[] args, Class5750 pInfo)
	{
		...
		{
			throw new Exception55("Non numeric operands to max function");
		}
		return (Class5024)Class5747.smethod_14(@interface, interface2);
	}
}
