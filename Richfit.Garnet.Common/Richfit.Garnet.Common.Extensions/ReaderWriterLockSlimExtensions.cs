...
/// <summary>
/// <see cref="T:System.Threading.ReaderWriterLockSlim" /> 类扩展方法
/// </summary>
public static class ReaderWriterLockSlimExtensions
{
	...
	public static void ReadLock(this ReaderWriterLockSlim locker, Action action, int timeout = -1)
	{
	...
	/// <exception cref="T:System.ArgumentOutOfRangeException">读取锁定时间 <paramref name="timeout" /> 小于0且不等于-1。</exception>
	public static R ReadLock<R>(this ReaderWriterLockSlim locker, Func<R> func, int timeout = -1)
	{
		locker.GuardNotNull("locker");
	...
	/// <exception cref="T:System.ArgumentNullException">当前锁对象为空；或者调用的方法 <paramref name="action" /> 为空。</exception>
	/// <exception cref="T:System.ArgumentOutOfRangeException">读取锁定时间 <paramref name="timeout" /> 小于0且不等于-1。</exception>
	public static void UpgradableReadLock(this ReaderWriterLockSlim locker, Action action, int timeout = -1)
	{
		locker.GuardNotNull("locker");
		action.GuardNotNull("action");
		timeout.GuardGreaterThanOrEqualTo(-1, "timeout");
	...
	/// <exception cref="T:System.ArgumentNullException">当前锁对象为空；或者调用的函数 <paramref name="func" /> 为空。</exception>
	/// <exception cref="T:System.ArgumentOutOfRangeException">读取锁定时间 <paramref name="timeout" /> 小于0且不等于-1。</exception>
	public static R UpgradableReadLock<R>(this ReaderWriterLockSlim locker, Func<R> func, int timeout = -1)
	{
		locker.GuardNotNull("locker");
		func.GuardNotNull("func");
		timeout.GuardGreaterThanOrEqualTo(-1, "timeout");
	...
	/// <exception cref="T:System.ArgumentNullException">当前锁对象为空；或者调用的方法 <paramref name="action" /> 为空。</exception>
	/// <exception cref="T:System.ArgumentOutOfRangeException">读取锁定时间 <paramref name="timeout" /> 小于0且不等于-1。</exception>
	public static void WriteLock(this ReaderWriterLockSlim locker, Action action, int timeout = -1)
	{
		locker.GuardNotNull("locker");
		action.GuardNotNull("action");
		timeout.GuardGreaterThanOrEqualTo(-1, "timeout");
	...
	/// <exception cref="T:System.ArgumentNullException">当前锁对象为空；或者调用的函数 <paramref name="func" /> 为空。</exception>
	/// <exception cref="T:System.ArgumentOutOfRangeException">读取锁定时间 <paramref name="timeout" /> 小于0且不等于-1。</exception>
	public static R WriteLock<R>(this ReaderWriterLockSlim locker, Func<R> func, int timeout = -1)
	{
		locker.GuardNotNull("locker");
		func.GuardNotNull("func");
		timeout.GuardGreaterThanOrEqualTo(-1, "timeout");
