...
internal class Class1910 : Class1351
{
	public delegate Class1910 Delegate1597();

	public delegate void Delegate1599(Class1910 elementData);

	public delegate void Delegate1598(Class1910 elementData);
		...
		while (reader.MoveToNextAttribute())
		{
			if (!(reader.Prefix == "xmlns"))
			{
				...
				case "dist":
					...
					break;
				case "prst":
					presetShadowType_0 = Class2551.smethod_0(reader.Value);
					break;
				}
			}
		}
	...
	public Class1910(XmlReader reader)
		: base(reader)
	{
	}
	...
	public override void vmethod_4(string prefix, XmlWriter writer, string elementName)
	{
		...
		writer.WriteAttributeString("prst", Class2551.smethod_1(presetShadowType_0));
		if (double_1 != 0.0)
		{
			writer.WriteAttributeString("dist", XmlConvert.ToString((long)Math.Round(double_1 * 12700.0)));
		}
		if (float_1 != 0f)
		{
