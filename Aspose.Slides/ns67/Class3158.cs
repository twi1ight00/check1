...
internal class Class3158 : Class3091
{
	...
	public override Enum493 Kind => Enum493.const_123;

	public Class3158(Class3448 xfrm)
		: base(xfrm)
	{
	}
	...
	public override Class3279 vmethod_1()
	{
		...
		double y4 = Class3089.smethod_1(x5, num7, 1.0);
		...
		double y5 = Class3089.smethod_2(z3, 0.0, num5);
		double z4 = Class3089.smethod_1(num2, num2, base.Transform2D.Extents.Cx);
		double y6 = Class3089.smethod_2(num2, 0.0, z4);
		double x7 = Class3089.smethod_1(x5, y6, 1.0);
		double num8 = Class3089.smethod_2(x7, y5, 0.0);
		double x8 = Class3089.smethod_2(num5, y5, num8);
		double x9 = Class3089.smethod_2(x8, num5, 0.0);
		double num9 = Class3089.smethod_2(x9, y5, 0.0);
		double y7 = Class3089.smethod_2(base.Transform2D.Extents.Cy, 0.0, z3);
		double x10 = Class3089.smethod_1(num5, 14.0, 16.0);
		double y8 = Class3089.smethod_3(x10, y7, 2.0);
		double y9 = Class3089.smethod_2(x7, y7, 0.0);
		double num10 = Class3089.smethod_2(num8, y7, 0.0);
		double num11 = Class3089.smethod_1(num2, 1.0, 2.0);
		double x11 = Class3089.smethod_1(x5, num11, 1.0);
		double y10 = Class3089.smethod_2(x11, y7, 0.0);
		double x12 = Class3089.smethod_2(base.Transform2D.Extents.Cx, 0.0, num11);
		double y11 = Class3089.smethod_2(num9, y7, 0.0);
		double num12 = Class3089.smethod_2(num6, y5, 0.0);
		double y12 = Class3089.smethod_2(z3, z3, num12);
		Class3089.smethod_2(base.Transform2D.Extents.Cy, 0.0, num5);
		...
		@class.method_7(new Struct159(num7, y4), new Struct159(num3, num6));
		@class.method_4(num2, num8);
		@class.method_7(new Struct159(base.Transform2D.Extents.Cx / 2.0, num9), new Struct159(num4, num8));
		@class.method_4(x3, num6);
		@class.method_7(new Struct159(x6, y4), new Struct159(base.Transform2D.Extents.Cx, 0.0));
		@class.method_4(x4, y8);
		@class.method_4(base.Transform2D.Extents.Cx, y7);
		@class.method_7(new Struct159(x12, y10), new Struct159(num4, y9));
		@class.method_4(num4, num10);
		@class.method_7(new Struct159(base.Transform2D.Extents.Cx / 2.0, y11), new Struct159(num2, num10));
		@class.method_4(num2, y9);
		@class.method_7(new Struct159(num11, y10), new Struct159(0.0, y7));
		@class.method_4(base.Transform2D.Extents.Cx / 8.0, y8);
		@class.method_8();
		@class.method_2(base.Transform2D.Extents.Cx, base.Transform2D.Extents.Cy, Enum492.const_2, extrusionOk: false, stroke: false);
		@class.method_3(num3, num12);
		@class.method_4(num3, num6);
		@class.method_4(num2, num8);
		@class.method_7(new Struct159(base.Transform2D.Extents.Cx / 2.0, num9), new Struct159(num4, num8));
		@class.method_4(x3, num6);
		@class.method_4(x3, num12);
		@class.method_7(new Struct159(base.Transform2D.Extents.Cx / 2.0, y12), new Struct159(num3, num12));
		@class.method_8();
		...
		@class.method_4(base.Transform2D.Extents.Cx / 8.0, y8);
		@class.method_8();
		@class.method_3(num2, y9);
		@class.method_4(num2, num8);
		@class.method_3(num4, num8);
		@class.method_4(num4, y9);
		@class.method_3(num3, num6);
		@class.method_4(num3, num12);
		@class.method_3(x3, num12);
		@class.method_4(x3, num6);
		@class.TextRectangle = new Class3457(num2, z3, num4, num10);
		return @class;
	}
