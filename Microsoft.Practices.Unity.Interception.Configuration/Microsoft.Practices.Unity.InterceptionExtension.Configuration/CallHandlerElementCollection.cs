...
{
	private static readonly UnknownElementHandlerMap<CallHandlerElementCollection> unknownElementHandlerMap = new UnknownElementHandlerMap<CallHandlerElementCollection> { 
	{
		"callHandler",
		delegate(CallHandlerElementCollection chec, XmlReader xr)
		{
			chec.ReadUnwrappedElement(xr, chec);
		}
	} };
	...
	public new CallHandlerElement this[string name] => (CallHandlerElement)BaseGet(name);
