...
internal abstract class EdmModelVisitor : DataModelItemVisitor
{
	...
	{
		DataModelItemVisitor.VisitCollection(entityContainers, VisitEdmEntityContainer);
	}
	...
	{
		DataModelItemVisitor.VisitCollection(entitySets, VisitEdmEntitySet);
	}
	...
	{
		DataModelItemVisitor.VisitCollection(associationSets, VisitEdmAssociationSet);
	}
	...
	{
		DataModelItemVisitor.VisitCollection(namespaces, VisitEdmNamespace);
	}
	...
	{
		DataModelItemVisitor.VisitCollection(complexTypes, VisitComplexType);
	}
	...
	protected virtual void VisitDeclaredNavigationProperties(EdmEntityType entityType, IEnumerable<EdmNavigationProperty> navigationProperties)
	{
		DataModelItemVisitor.VisitCollection(navigationProperties, VisitEdmNavigationProperty);
	}

	protected virtual void VisitAssociationTypes(EdmNamespace edmNamespace, IEnumerable<EdmAssociationType> associationTypes)
	{
		DataModelItemVisitor.VisitCollection(associationTypes, VisitEdmAssociationType);
	}
	...
	protected virtual void VisitEdmAssociationConstraint(EdmAssociationConstraint item)
	{
		if (item != null)
		{
			...
			DataModelItemVisitor.VisitCollection(item.DependentProperties, VisitEdmProperty);
		}
	}
