...
internal class Class3147 : Class3091
{
	...
	public override Enum493 Kind => Enum493.const_69;

	public Class3147(Class3448 xfrm)
		: base(xfrm)
	{
	}
	...
	public override Class3279 vmethod_1()
	{
		...
		double y4 = Class3089.smethod_2(0.0, num6, 0.0);
		double num9 = Class3089.smethod_5(num6, y3);
		Class3089.smethod_2(0.0, 0.0, num9);
		double y5 = Class3089.smethod_2(0.0, num5, 0.0);
		...
		double num11 = Class3089.smethod_2(num10, 0.0, num9);
		Class3089.smethod_2(0.0, 0.0, num11);
		double startAngle = Class3089.smethod_2(5400000.0, 0.0, num9);
		double swingAngle = Class3089.smethod_2(num9, num10, 0.0);
		double startAngle2 = Class3089.smethod_2(5400000.0, 0.0, num10);
		...
		@class.method_3(num3, base.Transform2D.Extents.Cy);
		@class.method_5(base.Transform2D.Extents.Cy, num3, 5400000.0, 5400000.0);
		...
		@class.method_5(base.Transform2D.Extents.Cy, num3, startAngle2, num11);
		@class.method_4(x8, y4);
		@class.method_4(x10, 0.0);
		@class.method_4(x9, y4);
		@class.method_4(x6, y4);
		@class.method_5(base.Transform2D.Extents.Cy, num3, startAngle, num9);
