...
internal abstract class Class7339
{
	public delegate int Delegate2786(Class7339 dfa, int s, Interface388 input);
	...
	public Delegate2786 delegate2786_0;

	protected Class7226 class7226_0;
	...
	public int method_2(Interface388 input)
	{
		...
		try
		{
			...
			while (true)
			{
				...
				else
				{
					...
					num = delegate2786_0(this, num2, input);
					if (bool_0)
					{
			...
			if (c == (ushort)Class7346.int_7 && short_1[num] >= 0)
			{
	...
	protected void method_3(int s, Interface388 input)
	{
		if (class7226_0.class7345_0.int_3 <= 0)
		{
			Exception87 exception = new Exception87(Description, int_0, s, input);
			vmethod_0(exception);
			throw exception;
		}
		class7226_0.class7345_0.bool_1 = true;
	}

	public virtual void vmethod_0(Exception87 nvae)
	{
	}

	public virtual int vmethod_1(int s, Interface388 input)
	{
		return -1;
	}
