...
internal class Class24 : Class18
{
	...
	{
		new Struct15(2900, -2147483628, 18700, -2147483627)
	};
	...
	private static readonly Point[] point_1 = new Point[22]
	{
		new Point(-21600, 0),
	...
	internal Class24(Interface42 interface42_1, float float_5, float float_6, Class898 class898_1)
	...
	internal override void vmethod_3()
	{
		...
		Class15 class15_ = new Class15(point_1, ushort_0, struct14_0, int_0, struct15_0, 21600, 21600, int.MinValue, int.MinValue, point_0);
		if (class898_0.Fill.method_5())
		{
			class898_0.Fill.method_3(Color.White);
		}
		Class14 @class = new Class14(Enum6.const_44, num, num2, num3, num4, class898_0.Line.ForeColor, class898_0.Line.Weight, class898_0.Fill.method_2(), class15_);
