...
internal class Class3107 : Class3091
{
	public override Enum493 Kind => Enum493.const_163;

	public Class3107(Class3448 xfrm)
		: base(xfrm)
	{
	}
	...
	public override Class3279 vmethod_1()
	{
		...
		double x2 = Class3089.smethod_1(Math.Min(base.Transform2D.Extents.Cy, base.Transform2D.Extents.Cx), 3.0, 4.0);
		double y = Class3089.smethod_1(x2, 1.0, 32.0);
		double y2 = Class3089.smethod_1(x2, 5.0, 16.0);
		double y3 = Class3089.smethod_1(x2, 3.0, 8.0);
		double y4 = Class3089.smethod_1(x2, 13.0, 32.0);
		double y5 = Class3089.smethod_1(x2, 19.0, 32.0);
		double y6 = Class3089.smethod_1(x2, 11.0, 16.0);
		double y7 = Class3089.smethod_1(x2, 13.0, 16.0);
		double y8 = Class3089.smethod_1(x2, 7.0, 8.0);
		double y9 = Class3089.smethod_2(num2, y, 0.0);
		double y10 = Class3089.smethod_2(num2, y2, 0.0);
		double y11 = Class3089.smethod_2(num2, y3, 0.0);
		double y12 = Class3089.smethod_2(num2, y7, 0.0);
		double y13 = Class3089.smethod_2(num2, y8, 0.0);
		double x3 = Class3089.smethod_2(x, y2, 0.0);
		double x4 = Class3089.smethod_2(x, y4, 0.0);
		double x5 = Class3089.smethod_2(x, y5, 0.0);
		double x6 = Class3089.smethod_2(x, y6, 0.0);
		double num3 = Class3089.smethod_1(x2, 3.0, 32.0);
		...
		@class.method_5(num, num, 16200000.0, 21600000.0);
		@class.method_8();
		...
		@class.method_3(x3, y10);
		@class.method_4(x3, y11);
		@class.method_4(x4, y11);
		@class.method_4(x4, y12);
		@class.method_4(x3, y12);
		@class.method_4(x3, y13);
		@class.method_4(x6, y13);
		@class.method_4(x6, y12);
		@class.method_4(x5, y12);
