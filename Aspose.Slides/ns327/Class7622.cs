...
internal class Class7622 : Class7456
{
	private static readonly Type type_0 = typeof(Class7010);
	...
	public override void Initialize()
	{
		...
		method_11("noResize", Enum983.flag_0 | Enum983.flag_1);
	...
	{
		Class7010 @class = (Class7010)instance.Value;
		switch (function)
		{
		...
		case "set_name":
			...
			goto IL_0254;
		case "get_noResize":
			return method_6(@class.NoResize);
		case "set_noResize":
			@class.NoResize = parameters[0].vmethod_2();
			goto IL_0254;
		case "get_scrolling":
