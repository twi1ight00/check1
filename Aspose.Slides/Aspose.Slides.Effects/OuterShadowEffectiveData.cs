...
public class OuterShadowEffectiveData : EffectEffectiveData, IOuterShadowEffectiveData
{
	...
	internal OuterShadowEffectiveData(RectangleAlignment alignment, double blurRad, float direction, double distance, double skewX, double skewY, bool rotateWithShape, double scaleX, double scaleY, Color color)
	{
	...
	internal void method_0(Class159 canvas, GraphicsPath graphicsPath, Class63 fp, Class66 lp, RectangleF rect)
	{
		...
		if (fp != null)
		{
			...
			fp.ForeColor = color_0;
		}
		if (lp != null)
		{
			lp.ForeColor = color_0;
		}
