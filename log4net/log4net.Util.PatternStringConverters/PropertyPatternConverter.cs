...
internal sealed class PropertyPatternConverter : PatternConverter
{
	...
	protected override void Convert(TextWriter writer, object state)
	{
		...
		PropertiesDictionary propertiesDictionary = LogicalThreadContext.Properties.GetProperties(create: false);
		if (propertiesDictionary != null)
		{
			compositeProperties.Add(propertiesDictionary);
		}
		PropertiesDictionary propertiesDictionary2 = ThreadContext.Properties.GetProperties(create: false);
		if (propertiesDictionary2 != null)
		{
			compositeProperties.Add(propertiesDictionary2);
		}
