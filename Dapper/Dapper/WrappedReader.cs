...
internal class WrappedReader : IDataReader, IDisposable, IDataRecord, IWrappedDataReader
{
	...
	public IDataReader Reader => reader ?? throw new ObjectDisposedException(GetType().Name);

	IDbCommand IWrappedDataReader.Command => cmd ?? throw new ObjectDisposedException(GetType().Name);
