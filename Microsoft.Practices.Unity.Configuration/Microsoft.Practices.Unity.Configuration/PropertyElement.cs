...
public class PropertyElement : InjectionMemberElement, IValueProvidingElement
{
	...
	/// </summary>
	public string DestinationName => string.Format(CultureInfo.CurrentCulture, Resources.DestinationNameFormat, Resources.Property, Name);
	...
	{
		return new InjectionProperty[1]
		{
			new InjectionProperty(Name, Value.GetInjectionParameterValue(container, GetPropertyType(toType)))
		};
	}

	private Type GetPropertyType(Type typeContainingProperty)
	{
		PropertyInfo property = typeContainingProperty.GetProperty(Name);
		if (property == null)
		{
			throw new InvalidOperationException(string.Format(CultureInfo.CurrentCulture, Resources.NoSuchProperty, typeContainingProperty.Name, Name));
		}
