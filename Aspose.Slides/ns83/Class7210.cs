...
internal abstract class Class7210 : Interface386
{
	...
	public virtual Interface386 Parent
	{
		get
		{
			return null;
	...
	public Class7210(Interface386 node)
	{
	}

	public virtual Interface386 imethod_1(int i)
	{
		if (ilist_0 != null && i < ilist_0.Count)
		{
			return (Class7210)ilist_0[i];
		}
		return null;
	}

	public virtual void imethod_2(Interface386 t)
	{
		if (t == null)
		{
			return;
		}
		Class7210 @class = (Class7210)t;
		if (@class.IsNil)
		{
			...
			if (ilist_0 != null)
			{
				...
				{
					Interface386 @interface = (Interface386)@class.Children[i];
	...
	public void method_0(IList kids)
	{
		...
		{
			Interface386 t = (Interface386)kids[i];
			imethod_2(t);
		}
	}

	public virtual void imethod_3(int i, Interface386 t)
	{
		if (t != null)
		{
			if (t.IsNil)
	...
	public virtual object imethod_4(int i)
	{
		...
		Class7210 result = (Class7210)ilist_0[i];
		ilist_0.RemoveAt(i);
		vmethod_1(i);
		return result;
	}
	...
	public virtual void imethod_5(int startChildIndex, int stopChildIndex, object t)
	{
		...
		if (num2 == 0)
		{
			...
			{
				Class7210 class2 = (Class7210)list[num3];
				ilist_0[i] = class2;
				class2.Parent = this;
				class2.ChildIndex = i;
				num3++;
	...
	public virtual void vmethod_1(int offset)
	{
		...
		{
			Interface386 @interface = imethod_1(i);
	...
	public virtual void vmethod_3(Interface386 parent, int i)
	{
		if (parent != Parent)
		{
		...
		{
			Class7211 @class = (Class7211)imethod_1(j);
	...
	public virtual string imethod_7()
	{
		if (ilist_0 != null && ilist_0.Count != 0)
		{
			...
			{
				Class7210 @class = (Class7210)ilist_0[num];
				if (num > 0)
				{
					stringBuilder.Append(' ');
				}
	...
	public abstract Interface386 imethod_6();
}
