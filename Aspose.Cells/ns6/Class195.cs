...
internal class Class195 : Class160
{
	internal Class195(Interface42 interface42_1, float float_5, float float_6, Class913 class913_1)
	...
	internal override GraphicsPath vmethod_0(RectangleF rectangleF_0)
	{
		...
		float num = ((class913_0.class901_0 == null) ? (Math.Min(rectangleF_0.Width, rectangleF_0.Height) * 0.3f) : ((class913_0.class901_0.arrayList_0.Count <= 0) ? (Math.Min(rectangleF_0.Width, rectangleF_0.Height) * 0.3f) : (Math.Min(rectangleF_0.Width, rectangleF_0.Height) * (Convert.ToSingle(class913_0.class901_0.arrayList_0[0]) / 100000f))));
		if (num <= 0f)
		{
