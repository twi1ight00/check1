...
internal class Class3981 : Class3969
{
	public override string PropertyName => "column-rule";

	public override Enum600 PropertyType => Enum600.const_75;
	...
	public override void vmethod_3(Class3726 engine, Interface100 propertyHandler, Interface99 lu, bool important)
	{
		...
		method_8(propertyHandler, "column-rule-color", list, important);
		method_8(propertyHandler, "column-rule-style", list2, important);
		method_8(propertyHandler, "column-rule-width", list3, important);
	}
}
