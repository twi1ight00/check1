...
internal class Class7550 : Class7457
{
	internal static readonly Type type_0 = typeof(Class5871);
	...
	{
		Class5871 @class = (Class5871)instance.Value;
		switch (function)
		{
		case "get_{default}":
			return method_5(@class.Value);
		case "set_{default}":
			@class.Value = (float)parameters[0].vmethod_3();
			break;
		case "get_use":
		...
		case "set_value":
			@class.Value = float.Parse(parameters[0].ToString(), NumberStyles.Any, CultureInfo.InvariantCulture);
			break;
		default:
