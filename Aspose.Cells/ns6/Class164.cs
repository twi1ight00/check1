...
internal class Class164 : Class160
{
	internal Class164(Interface42 interface42_1, float float_5, float float_6, Class913 class913_1)
	...
	internal override void vmethod_3()
	{
		...
		{
			num3 = 0f - class913_0.method_6().X;
			num4 = 0f - class913_0.method_6().Y;
		}
		else
		{
			num3 = float_3;
		...
		RectangleF rect = new RectangleF(num3, num4, width, height);
