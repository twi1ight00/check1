...
internal class Class3298 : Class3290
{
	private const string string_0 = "adj1";

	private const string string_1 = "adj2";

	public override Enum496 ShapeType => Enum496.const_23;

	public override Class3280 vmethod_1()
	{
		Class3298 @class = new Class3298();
	...
	internal override Class3340 vmethod_3()
	{
		...
		@class.method_3(new Struct159(x2, y3), new Struct159(x3, y4), new Struct159(x4, num));
		@class.method_3(new Struct159(x5, y3), new Struct159(x6, y4), new Struct159(num8, num));
		@class.method_4();
		@class.method_7(x7, num3);
		@class.method_3(new Struct159(x8, y5), new Struct159(x9, y6), new Struct159(x10, num3));
		@class.method_3(new Struct159(x11, y5), new Struct159(x12, y6), new Struct159(num9, num3));
		return @class;
	}
