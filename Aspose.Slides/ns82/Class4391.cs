...
internal class Class4391 : ICloneable
{
	...
	public Class4391(ulong[] bits_)
	{
		ulong_0 = bits_;
	}

	public Class4391(IList items)
		: this(64)
	{
	...
	public Class4391(int nbits)
	{
		ulong_0 = new ulong[(nbits - 1 >> 6) + 1];
	}

	public static Class4391 smethod_0(int el)
	{
		Class4391 @class = new Class4391(el + 1);
		@class.Add(el);
		return @class;
	}

	public static Class4391 smethod_1(int a, int b)
	{
		Class4391 @class = new Class4391(Math.Max(a, b) + 1);
		@class.Add(a);
		@class.Add(b);
		return @class;
	}

	public static Class4391 smethod_2(int a, int b, int c)
	{
	...
	public static Class4391 smethod_3(int a, int b, int c, int d)
	{
		Class4391 @class = new Class4391();
		@class.Add(a);
		@class.Add(b);
	...
	public virtual Class4391 vmethod_0(Class4391 a)
	{
		if (a == null)
		{
			return this;
		}
		Class4391 @class = (Class4391)Clone();
		@class.vmethod_2(a);
		return @class;
	}
	...
	public virtual void vmethod_2(Class4391 a)
	{
		if (a != null)
		{
	...
	public virtual object Clone()
	{
		try
		{
			Class4391 @class = (Class4391)MemberwiseClone();
	...
	{
		Class4391 @class = other as Class4391;
