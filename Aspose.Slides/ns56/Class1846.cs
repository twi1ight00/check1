...
internal class Class1846 : Class1351
{
	public delegate Class1846 Delegate1417();

	public delegate void Delegate1418(Class1846 elementData);

	public delegate void Delegate1419(Class1846 elementData);
	...
	public FontCollectionIndex Idx
	{
		get
		{
	...
	private void method_2(XmlReader reader)
	{
		while (reader.MoveToNextAttribute())
		{
			...
			{
				fontCollectionIndex_0 = Class2529.smethod_0(reader.Value);
			}
		}
		reader.MoveToElement();
	}

	public Class1846(XmlReader reader)
		: base(reader)
	{
	}
	...
	public override void vmethod_4(string prefix, XmlWriter writer, string elementName)
	{
		...
		writer.WriteAttributeString("idx", Class2529.smethod_1(fontCollectionIndex_0));
		if (class2605_0 != null)
		{
