...
internal class Class5141 : Class5140
{
	public Class5141(Class5088 parent)
		: base(parent)
	{
	}
	...
	public override RectangleF vmethod_32(Class5728 reldims)
	{
		...
		case Enum679.const_292:
			...
			rectangleF = new RectangleF(reldims.int_0 - method_58().imethod_6(interface2), 0f, reldims.int_1, method_58().imethod_6(interface2));
			break;
		}
		method_59(rectangleF, method_57(), siblingContext);
		return rectangleF;
	}
