...
internal class Class1979 : Class1351
{
	public delegate Class1979 Delegate1804();

	public delegate void Delegate1805(Class1979 elementData);

	public delegate void Delegate1806(Class1979 elementData);
	...
	public Class1979(XmlReader reader)
		: base(reader)
	{
	}
