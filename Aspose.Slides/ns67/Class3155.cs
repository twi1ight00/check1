...
internal class Class3155 : Class3091
{
	private const string string_0 = "adj1";

	private const string string_1 = "adj2";

	public override Enum493 Kind => Enum493.const_46;

	public Class3155(Class3448 xfrm)
		: base(xfrm)
	{
	}
	...
	public override Class3279 vmethod_1()
	{
		...
		double y3 = Class3089.smethod_1(num4, num, base.Transform2D.Extents.Cx / 2.0);
		double bottom = Class3089.smethod_2(num2, y3, 0.0);
		Class3279 @class = new Class3279(base.Transform2D);
		@class.method_2(base.Transform2D.Extents.Cx, base.Transform2D.Extents.Cy, Enum492.const_0, extrusionOk: false, stroke: true);
		@class.method_3(0.0, num2);
		@class.method_4(num4, num2);
		@class.method_4(num4, 0.0);
		...
		@class.method_8();
		@class.TextRectangle = new Class3457(num4, 0.0, num5, bottom);
		return @class;
	}
