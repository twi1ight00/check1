...
internal class Class442 : Class369
{
	internal static readonly string string_0 = "even-columns";
	...
	public Class442(string prefix, string localName, string namespaceURI, XmlDocument doc)
