...
internal class Class236 : Class160
{
	internal Class236(Interface42 interface42_1, float float_5, float float_6, Class913 class913_1)
	...
	internal override GraphicsPath vmethod_0(RectangleF rectangleF_0)
	{
		...
		graphicsPath.StartFigure();
		graphicsPath.AddLine(x + num + num13, y + y + num15, x + num + num13, y + height + num15);
		return graphicsPath;
	}
